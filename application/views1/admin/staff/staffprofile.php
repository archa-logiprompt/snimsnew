...
?></td>
                            ...
                            <div class="tshadow mb25  bozero">    
                              ...
                              <div class="tshadow mb25  bozero">    
                                <h3 class="pagetitleh2"><?php echo "Specialization" ?></h3>
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody> 
                                          ...
                                          <th>To</th>
                                            ...
                                            <tr>
                                                <td class="col-md-4"><?php echo $spec["prev_instit"] ?></td>
                                                <td class="col-md-4"><?php echo $spec["specialization"] ?></td>
                                                <td class="col-md-2"><?php
                                                       if (!empty($spec["datefrom"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($spec["datefrom"]));
                                                       }
?></td>
                                                <td class="col-md-2"><?php
                                                       if (!empty($spec["dateto"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($spec["dateto"]));
                                                       }
?></td>
                                            </tr>
                                            <?php }} ?>
                            ...
                            <div class="tshadow mb25  bozero">    
                                <h3 class="pagetitleh2"><?php echo "Training Programmes" ?></h3>
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody> 
                                          <th>Previous Institution</th>
                                          ...
                                          <th>To</th>
                                            ...
                                            <tr>
                                                <td class="col-md-6"><?php echo $train["name_training"] ?></td>
                                                <td class="col-md-3"><?php
                                                       if (!empty($train["datefrom"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($train["datefrom"]));
                                                       }
?></td>
                                                <td class="col-md-3"><?php
                                                       if (!empty($train["dateto"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($train["dateto"]));
                                                       }
?></td>
                                            </tr>
                                            <?php }} ?>
                            ...
                            <div class="tshadow mb25  bozero">    
                                <h3 class="pagetitleh2"><?php echo "Certification Programmes" ?></h3>
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped tmb0">
                                        <tbody> 
                                          <th>Previous Institution</th>
                                          ...
                                          <th>To</th>
                                            ...
                                            <tr>
                                                <td class="col-md-6"><?php echo $cert["name_certificate"] ?></td>
                                                <td class="col-md-3"><?php
                                                       if (!empty($cert["datefrom"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($cert["datefrom"]));
                                                       }
?></td>
                                                <td class="col-md-3"><?php
                                                       if (!empty($cert["dateto"])) {
                                                           echo date($this->customlib->getSchoolDateFormat(), strtotime($cert["dateto"]));
                                                       }
?></td>
                                            </tr>
                                            <?php }} ?>
