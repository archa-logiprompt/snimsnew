                        ...
                        <form action="<?php echo site_url("admin/itemsupplier/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier'); ?> <?php echo $this->lang->line('name'); ?></label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"> <?php echo $this->lang->line('supplier'); ?> <?php echo $this->lang->line('phone'); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier'); ?> <?php echo $this->lang->line('email'); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('supplier'); ?> <?php echo $this->lang->line('address'); ?></label>
                ...
                <div class="box box-primary" id="exphead">
                    ...
                    <div class="box-body  ">
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('item_supplier_list'); ?></div>
