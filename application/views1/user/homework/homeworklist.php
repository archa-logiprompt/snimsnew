                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <?php echo $this->lang->line('homework_date'); ?>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($homeworklist as $key => $homework) {
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $homework["class"] ?>
                                            </td>
                                            <td>
                                                <?php echo $homework["section"] ?>
                                            </td>
                                            <td>
                                                <?php echo $homework["name"] ?>
                                            </td>
                                            <td>
                                                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($homework['homework_date'])); ?>
                                            </td>
                                            <td>
                                                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($homework['submit_date'])); ?>
                                            </td>

                                            <td>
                                                <?php
                                                if (($homework['report'][$key]["status"])==0||($homework['report'][$key]["status"])==1) {
                                                    if ($homework['report'][$key]["status"] == "1") {
                                            ...
                                            <td class="mailbox-date pull-right">
                                                <a class="btn btn-default btn-xs"
                                                    onclick="evaluation(<?php echo $homework['id']; ?>);" title=""
                                                    data-target="#evaluation" data-toggle="modal"
                                                    data-original-title="Evaluation">
...
<div class="modal fade" id="evaluation" tabindex="-1" role="dialog" aria-labelledby="evaluation"
