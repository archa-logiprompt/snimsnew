            ...
            if ($this->rbac->hasPrivilege('marks_grade', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form id="form1" action="<?php echo site_url('admin/grade/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('grade_list'); ?></div>
