...
class Homework extends Admin_Controller {
    ...
    function updatestatus($student_id,$homework_id) {

       
           $res= $this->homework_model->updatestatus($student_id,$homework_id);
           
            $this->load->view("homework/evaluation_report");
