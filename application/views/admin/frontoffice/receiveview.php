    ...
    <section class="content">
        ...
        <?php if ($value->image !== "") { ?><a href="<?php echo base_url(); ?>admin/dispatch/download/<?php echo $value->image; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('postal_receive', 'can_delete')) { ?>
                                                        ...
                                                        <?php if ($value->image !== "") { ?><a href="<?php echo base_url(); ?>admin/receive/imagedelete/<?php echo $value->id; ?>/<?php echo $value->image; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
