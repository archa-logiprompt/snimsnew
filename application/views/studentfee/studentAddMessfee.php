    ...
    <div class="row">  
        <div class="col-md-12">
            <section class="content-header">
                <h1>
                    <i class="fa fa-money"></i> <?php echo $this->lang->line('mess') .' '. $this->lang->line('fees_collection'); ?><small><?php echo $this->lang->line('student_fee'); ?></small></h1>
            </section>
        </div>
        <div>    
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo base_url() ?>studentmessfee" type="button" class="btn btn-primary btn-xs">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                ...
                                <tbody>
                                    ...
                                    foreach ($student_due_fee as $key => $fee) {
									 ...
									 $messfeesession_id=$fee->mess_fee_session_id;
							...
							$per=($fee_value->percentage/100)*$fee_value->amount;
                                   ...
                                   $feetype_balance = $fee_value->amount - ($fee_paid + $fee_discount);
											...
											$arr=$fee_value->messfeemasters_id;
										    array_push($ar,$arr);
                                            ...
                                            ?>
                                                ...
                                                <tr class="dark-gray">
                                                    ...
                                                    ?>
                                                <td><input class="checkbox" type="checkbox" name="fee_checkbox" data-fee_master_id="<?php echo $fee_value->id ?>" data-mess_fee_session_id="<?php echo $fee_value->mess_fee_session_id ?>" data-messfeemasters_id="<?php echo $fee_value->messfeemasters_id ?>"></td>
                                                <td align="left"><?php
                                            echo $fee_value->type;
                                                    ?></td>
                                                    
                                                  
                                                <td align="left"><?php echo $fee_value->month; ?></td>
                                       ...
                                       echo (number_format($amountfine, 2, '.', ''));
                                          ...
                                          <input type="hidden" name="balance" class="hidbalance" value="<?php echo (number_format($feetype_balance, 2, '.', '')) ?>"  />       
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right"> 
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>"  data-student_messfees_master_id="<?php echo $fee->id; ?>" data-month="<?php echo $fee_value->month; ?>" data-type="<?php echo $fee_value->type; ?>" class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>" title="<?php echo $this->lang->line('add_fees'); ?>" data-toggle="modal" data-target="#myFeesModal" ><i class="fa fa-plus"></i></button>


                                                        <!--<button  class="btn btn-xs btn-default printInv" data-fee_master_id="<?php //echo $fee_value->id ?>" data-mess_fee_session_id="<?php //echo $fee_value->mess_fee_session_id ?>" data-messfeemasters_id="<?php //echo $fee_value->messfeemasters_id ?>"  
...
$fine=$fee_deposits_value->amount_fine;
                                                    ...
                                                    <tr class="white-td">
                                                        <td align="left"></td>
                                                        <td align="left"></td>
                                             <td align="left" style="color: #a9101a;">
                                             
                                              </td>
                                                        <td align="left" style="color: #a9101a;"></td>
                                                        <td align="left"></td>
                ...
                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($fee_deposits_value->date)); ?>
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right"> 
                                                                ...
                                                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs" data-invoiceno="<?php echo $fee_value->student_messfees_deposite_id . "/" . $fee_deposits_value->inv_no; ?>" data-main_invoice="<?php echo $fee_value->student_messfees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>" data-type="<?php echo $fee_value->type ?>" data-toggle="modal" data-target="#confirm-delete" title="<?php echo $this->lang->line('revert'); ?>">
                                                    ...
                                                    <?php } ?>
                                                                <!--<button  class="btn btn-xs btn-default printDoc" data-main_invoice="<?php //echo $fee_value->student_messfees_deposite_id ?>" data-sub_invoice="<?php //echo $fee_deposits_value->inv_no ?>"  title="<?php //echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i> </button>-->
                                                            </div>   
                                                        </td>
                                                    </tr>
                                                    <?php
									...
									$bal_refund_amount=$total_refund - $r_amount->amount; 
												...
												?>
												       ...
												       <!--<tr class="white-td"> 
                                                        ...
                                                        <td align="left">
                                                          <div class="btn-group pull-right"> 
                                                            <button class="btn btn-default btn-xs" data-total_refund_amount="<?php //echo $bal_refund_amount?>" data-fine="<?php //echo $fine ?>" data-refunded_amount= "<?php //echo  $r_amount->amount;  ?>" data-fee_master_id="<?php //echo $fee_value->id ?>" data-mess_fee_session_id="<?php //echo $fee_value->mess_fee_session_id ?>" data-messfeemasters_id="<?php //echo $fee_value->messfeemasters_id ?>" data-toggle="modal" data-target="#confirm-refund" title="<?php //echo $this->lang->line('refund'); ?>">
										...
										if(!empty($fee_value->advance_collected)) { 
											 
											 
											 $collected=json_decode($fee_value->advance_collected);
											 $total_collected=0;
											 $prev_balance=0;
											 foreach($collected as $key=>$c)
											 {
												
												 if(isset($c->advance_bal)){
												 $prev_balance=$c->advance_bal;}
												 
												 $total_collected=$total_collected + $c->amount+$prev_balance;
											  
											 ?>
                                                    <tr class="white-td"> 
                                                       <td align="left"><img src="<?php echo base_url(); ?>backend/images/table-arrow.png" alt="" /></td>
                                                        <td align="left">Mess fee</td>
                                                        <td align="left"><?php echo $c->month ?></td>
                                                        <td align="left"></td>
                                                        ...
                                                        <td align="left" > </td>
                                                          ...
                                                          <td align="left"><?php echo $c->description ?></td>
                                                        ...
                                                        <td align="left">
                                                           ...
                                                           <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs"data-deposit_id="<?php echo $fee_value->student_messfees_deposite_id ?>" data-amount="<?php echo $a=$c->amount+$c->advance_bal ?>" data-arraykey="<?php echo $key ?>"  data-toggle="modal" data-target="#confirmadvancemess-delete" title="<?php echo $this->lang->line('revert'); ?>">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
									...
									?>
									          ...
									          <tr class="white-td"> 
                                                       <td align="left"></td>
                                                        <td align="left" style="color: #a9101a;"><?php if($prev_balance!=0) { ?>Previous Month Balance : <?php echo $prev_balance; } ?> </td>
                                                        <td align="left"></td>
                                                        <td align="left" style="color: #a9101a;">Total Fee Deducted from Advance :</td>
                                                        
                                                        <td align="left" style="color: #a9101a;"><?php echo $total_collected  ?></td>
                                                        ...
                                                        <td align="left" > </td>
                                                          ...
                                                          <td align="left" style="color: #a9101a;">Balance Advance : </td>
                                                       
                                                      
                                                         <td align="left" style="color: #a9101a;" ><?php echo $fee_value->balance_amount ?> </td>
...
?>
                                                        ...
                                                        <td align="left"><input class="checkbox" type="checkbox" name="fee_checkbox"> </td>
                                                        <td align="left"></td>
                                                        <td align="left" style="color: #a9101a;">Balance Advance Amount</td>
                                                        <td align="left"></td>
                                                         <td align="left"></td>-->
                                                        <!--<td align="left"><span class="label label-success"><?php //echo $this->lang->line('paid'); ?></span></td>-->
                                                       <!--<td align="left"><?php //echo ( number_format($fee_ad->amount, 2, '.', ''));?></td>
                                                         <td align="left"></td>-->
                                                        <!--<td class="text text-left">


                                                            <a href="#" data-toggle="popover" class="detail_popover" > </a>
                                                ...
                                                <?php //} ?>
                                                   ...
                                                   <td align="left"></td>
                                                    ...
                                                    <td align="left" style="color: #a9101a;">Balance advance</td>
                                                    <td class="text text-right"><?php //echo $fee_ad->amount ?> </td>
                                                    <td class="text text-right"></td>
                                                     <td class="text text-right"></td>
                                                      <td class="text text-right"></td>
                                                       <td class="text text-right"></td>
...
?></td>
                                        ...
                                        <td class="text text-right"><?php
										 ...
										 if($total_balance_amount >0)
										 {
                                            ...
                                            <div class="btn-group pull-right"> 
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_messfees_master_id="<?php echo $stud_feemaster; ?>" data-headwise_fine="<?php  echo $headwise_fine?>"  data-student_id="<?php echo $fee_value->student_id ?>" data-balance_amount="<?php echo $feetbalanceamount ?>" data-type="<?php echo $fee_value->type ?>" 
								 ...
								 foreach($val['type'] as $t_key=> $t )
								 {
								   ...
								   ?>
                                      ...
                                      <!--  <td> </td>-->
                                          ...
                                          <td> <a href="#" data-billamount="<?php echo $val['amount'] ?>" data-type="<?php echo $type?>" data-billdate="<?php echo $val['date'] ?>" data-mode="<?php echo $val['mode'] ?>" data-billno="<?php echo $key ?>"class="btn btn-xs btn-info print_billwise"><i class="fa fa-print"></i> <?php echo $this->lang->line('print'); ?> </a> </td>
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input  type="hidden" class="form-control" id="student_messfees_master_id" value="0" readonly="readonly"/>
                      ...
                      <input type="hidden" class="form-control" id="month" value="" />
...
<div class="delmodal modal fade" id="confirmadvancemess-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Do you want to proceed?</p>
                <p class="debug-url"></p>
                <input type="hidden" name="arraykey"  id="arraykey" value="">
                <input type="hidden" name="deposit_id" id="deposit_id"  value="">
                 <input type="hidden" name="mess_amount" id="mess_amount"  value="">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <a class="btn btn-danger confirmed"><?php echo $this->lang->line('revert'); ?></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input  type="hidden" class="form-control" id="re_student_messfees_master_id" value="0" readonly="readonly"/>
                        <input  type="hidden" class="form-control" id="re_messfeemasters_id" value="0" readonly="readonly"/>
...
<div class="modal fade" data-refresh="true" id="myFeesModal2" role="dialog" >
    <div class="modal-dialog">      
        <div class="modal-content">
           ...
           <input  type="hidden" class="form-control" id="guardian_phone" value="<?php echo $student['guardian_phone'] ?>" readonly="readonly"/>
                        <input  type="hidden" class="form-control" id="guardian_email" value="<?php echo $student['guardian_email'] ?>" readonly="readonly"/>
                        <input  type="hidden" class="form-control" id="student_messfees_master_id1" value="0" readonly="readonly"/>
                   ...
                   <input type="hidden" class="form-control" id="stud_name" value="<?php echo $student["firstname"] . " " . $student["lastname"]; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" autofocus="" class="form-control modal_amount" id="amount2" value=""  readonly="readonly" >
        ...
        <select multiple="multiple" name="t_fee_groups_feetype_id" class="form-control t_fee_type selectpicker" id="t_fee_type">
                        ...
                        <!--<div class="form-group mb0">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-5 col-sm-5">
                             <div class="form-group">
                                        <input type="text" class="form-control" id="fine" value="<?php  //echo (number_format($total_fine_amount, 2, '.', '')); ?>0.00">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.print_billwise', function () {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {'billamount':billamount,'billdate':billdate,'billno':billno,'studname':studname,'type':type,'mode':mode,course:course,admin_no:admin_no},
       ...
       /* $(document).on('click', '.printInv', function () {
            ...
            var mess_fee_session_id = $(this).data('mess_fee_session_id');
            var messfeemasters_id = $(this).data('messfeemasters_id');
            $.ajax({
                url: '<?php //echo site_url("studentmessfee/printFeesByGroup") ?>',
                type: 'post',
                data: {'messfeemasters_id': messfeemasters_id, 'fee_master_id': fee_master_id, 'mess_fee_session_id': mess_fee_session_id},
                success: function (response) {
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        var student_messfees_master_id = $('#student_messfees_master_id').val();
        ...
        $.ajax({
            url: '<?php echo site_url("studentmessfee/addstudentfee") ?>',
            type: 'post',
            data: {date: date, amount: amount, amount_fine: amount_fine, description: description, student_messfees_master_id: student_messfees_master_id, payment_mode: payment_mode, guardian_phone: guardian_phone, guardian_email: guardian_email,stud_name:stud_name,type:type},
            dataType: 'json',
            success: function (response) {
                // console.log(response);
                $this.button('reset');
...
<script type="text/javascript">
    ...
    $(document).on('click', '.save_button2', function (e) {
        ...
        var student_messfees_master = $('#student_messfees_master_id1').val();
       
		var stud_name=$('#stud_name').val();
		
		
		
		if(student_messfees_master.length > 1)
		{
			 var student_messfees_master_id = student_messfees_master.split(',');
			
		}
		
		else
		{
			student_messfees_master_id = student_messfees_master;
		}
       ...
       // var student_fees_discount_id = $('#discount_group').val();
        ...
        $.ajax({
            url: '<?php echo site_url("studentmessfee/addstudentfee2") ?>',
            type: 'post',
            data: {date: date,cal_amount:cal_amount,  amount:amount, amount_fine: amount_fine, description: description, student_messfees_master_id: student_messfees_master_id, payment_mode: payment_mode, guardian_phone: guardian_phone, guardian_email: guardian_email,balance:balancenew,stud_name:stud_name},
            dataType: 'json',
            success: function (response) {
                // console.log(response);
                $this.button('reset');
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('show.bs.modal', function (e) {
			...
			$('#type_name', this).val($(e.relatedTarget).data('type'));
		...
		$('#confirm-refund').on('show.bs.modal', function (e) {
            ...
            $('#student_messfees_master_id', this).val("");
            $('#refund_amount', this).val("");
			$('#messfeemasters_id', this).val("");
		
			

           
            $('#re_student_messfees_master_id', this).val($(e.relatedTarget).data('fee_master_id'));
			
            $('#refund_amount', this).val($(e.relatedTarget).data('total_refund_amount'));
			
			$('#re_messfeemasters_id', this).val($(e.relatedTarget).data('messfeemasters_id'));
		 ...
		 $('#confirm-refund').on('click', '.btn-refund', function (e) {
			...
			var student_messfees_master_id = $('#re_student_messfees_master_id').val();
			var messfeemasters_id = $('#re_messfeemasters_id').val();
			var date = $('#date').val();
            var payment_mode = $('input[name="payment_mode_fee"]:checked').val();
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentmessfee/refund_fee") ?>',
                dataType: 'JSON',
                data: {'refund_amount': refund_amount, 'student_messfees_master_id': student_messfees_master_id,'messfeemasters_id':messfeemasters_id,'date':date,'payment_mode':payment_mode},
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
         ...
         $modalDiv.addClass('modalloading');
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentmessfee/deleteFee") ?>',
                dataType: 'JSON',
                data: {'main_invoice': main_invoice, 'sub_invoice': sub_invoice,'type':type},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    location.reload(true);
                }
        ...
        $('#confirm-discountdelete').on('click', '.btn-discountdel', function (e) {
		 ...
		 $('#confirmadvancemess-delete').on('show.bs.modal', function (e) {
           
              $('#arraykey', this).val("");
			  $('#mess_amount', this).val("");
			  $('#deposit_id', this).val("");
			  
			$('#arraykey', this).val($(e.relatedTarget).data('arraykey'));
			$('#mess_amount', this).val($(e.relatedTarget).data('amount'));
			$('#deposit_id', this).val($(e.relatedTarget).data('deposit_id'));
        });
        ...
        $(document).on('click', '.confirmed', function (e) {
            var $modalDiv = $(e.delegateTarget);
            var arraykey = $('#arraykey').val();
            var mess_amount = $('#mess_amount').val();
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentmessfee/revert_messadvance") ?>',
                dataType: 'JSON',
                data: {'deposit_id': deposit_id, 'mess_amount': mess_amount,'arraykey':arraykey},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    location.reload(true);
                }
...
<script type="text/javascript">
    ...
    $("#myFeesModal").on('shown.bs.modal', function (e) {
		...
		var student_messfees_master_id = data.student_messfees_master_id;
        var student_session_id = data.student_session_id;

        $('.fees_title').html("<b>" + type + ":</b> " + month);
        $('#student_messfees_master_id').val(student_messfees_master_id);
		$('#type').val(type);
		$('#month').val(month);
        ...
        $.ajax({
            type: "post",
            url: '<?php echo site_url("studentmessfee/geBalanceFee") ?>',
            dataType: 'JSON',
            data: {
...
$(".t_fee_type").select2({
  tags: true,
    ...
    $("#myFeesModal2").on('shown.bs.modal', function (e) {
		...
		if(data.student_messfees_master_id.length >1)
		{
		var student_messfees_master_id = data.student_messfees_master_id.split(',');	
		}
		else
		{
			var stud_array=[];
			stud_array.push(data.student_messfees_master_id);
			student_messfees_master_id = stud_array ;
			
		}
		
		 var student_session_id = data.student_session_id;
         var balance = data.balance_amount;
		  //$('#student_messfees_master_id1').val(student_messfees_master_id);	 
	...
	/*	$('#totalbalance_amount').val(balance);*/
		...
		*/
        ...
        $.ajax({
            type: "post",
            url: '<?php echo site_url("studentmessfee/getBalanceFee2") ?>',
            ...
            success: function (data) {
				...
				var weeks=Math.round(days/7);		
					...
					if(obj.finetype=='Monthly')
					 ...
					 t_feetype +="<option  data-amount="+obj.amount+" value="+obj.id+ "> "+obj.type+" ["+obj.amount+"]</option>";	
					}
					else 
					{
					...
					//discount=Number(discount)+Number(t.amount_discount); 
					 ...
					 if(balance_amount!==0)
					 {
						...
						t_feetype +="<option  data-amount="+balance_amount+" value="+obj.id+ " > "+obj.type+ " ["+ balance_amount +" ]</option>";	
						}
    ...
    $('#student_messfees_master_id1').val(samplesSelected);
...
<script type="text/javascript">
	 ...
	 $(document).on('click', '.btn_feeadvance', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentmessfee/fee_advance") ?>',
                dataType: 'JSON',
                data: {'ad_amount': ad_amount, 'ad_date': ad_date,'ad_note':ad_note,'payment_mode_fee':payment_mode,'student_id':student_id,'stud_name':stud_name,student_session_id:student_session_id},
                success: function (data) {
	...
	*/
		...
		$(document).on('click', '.btn_fee_ad', function (e) {
            ...
            $.ajax({
                type: "post",
                url: '<?php echo site_url("studentmessfee/deleteFee_ad") ?>',
                dataType: 'JSON',
                data: {'id': fee_ad_id},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
