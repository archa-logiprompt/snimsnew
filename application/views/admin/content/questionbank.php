                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                              ...
                                              <?php foreach ($mexpl as $ex) {
                                                 ?>
                                                <a href="<?php echo base_url(); ?>admin/content/download/<?php echo $ex ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                    <i class="fa fa-download"></i>
                                                </a>
                                                <?php } ?>
                                                <a href="<?php echo base_url(); ?>admin/content/deletequestionbank/<?php echo $data['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
