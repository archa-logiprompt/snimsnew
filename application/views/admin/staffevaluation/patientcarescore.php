                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Allotted API Score (Total : 15)";?> 
                                                	</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "OP/IP – Dental care training :  5
(0.1/ hour)
";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Laboratory Services and Case-record logbook : 5
( 1 per 10 case records  / one lab service)
...
";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Participation in Dental Health camps : 5
";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
