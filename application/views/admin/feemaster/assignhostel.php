                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" name="hostel_room_nos"
                                                value="<?php echo $hostelroomnumber ?>" id="hostel_room_nos">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="date1" name="date1" placeholder="" type="text"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="date2" name="date2" placeholder="" type="text"
                                                        class="form-control" value="" autocomplete="off" />
                                                    <span class="text-danger">
                                                        <?php echo form_error('date'); ?>
                                                    </span>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <button type="button" class="remove-fees btn btn-danger btn-sm remove_students"
                                                id="load"
                                                data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait..">
                                                Remove
                                            </button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#date1').datepicker({
            format: 'MM yyyy', // Use full month name and year format
    ...
    $("#date2").change(function (e) {
        ...
        let start_month = ($('#date1').val());
        let end_month = ($('#date2').val());
        ...
        let [startMonthName, startYear] = start_month.split(' ');
        let [endMonthName, endYear] = end_month.split(' ');

        let startMonthIndex = monthNames.indexOf(startMonthName);
        let endMonthIndex = monthNames.indexOf(endMonthName);
        let startDate = new Date(startYear, startMonthIndex);
        let endDate = new Date(endYear, endMonthIndex);
        ...
        if (monthsInRange.length != 0) {
            ...
            $.ajax({
                ...
                data: { 'months': JSON.stringify(monthsInRange), 'hostelid': hostelId },
                success: function (data) {
                    let student_ids = (data[0]['student_session_ids']).split(',')
                    student_ids.forEach(student_session_id => {
                        console.log(student_session_id);  // Log the student_session_id
    ...
    $("#assign_form").submit(function (e) {
        ...
        let start_month = ($('#date1').val());
        let end_month = ($('#date2').val());
        if (start_month.length == 0 || end_month.length == 0) {
    ...
    function checkExists(checkbox) {
        ...
        if (checkbox.checked) {
            ...
            $.ajax({
                type: "POST",
                dataType: 'Json',
                url: base_url + "Studentfee/checkstudentexists",
                data: {
                    'student_sesstion_id': id,
                ...
                success: function (data) {
                    ...
                    if (data) {
                        if (confirm("This student is already assigned. CLick ok to delete existing and assign new hostel room.")) {
                            $.ajax({
                                type: "POST",
                                dataType: 'Json',
                                url: base_url + "Studentfee/deletehosteldata",
                                data: {
                                    'id': id,
                                }, // serializes the form's elements.
                                success: function (data) {
