            ...
            <aside class="main-sidebar" id="alert2">               
                <section class="sidebar">  
                    ...
                    <ul class="sidebar-menu verttop38" id="sibe-box">
                            ...
                            <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                                ...
                                <ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('content/assignment'); ?>"><a href="<?php echo base_url(); ?>user/content/assignment"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('assignments'); ?></a></li>
                                     ...
                                     <li class="<?php echo set_Submenu('content/questionpaper'); ?>"><a href="<?php echo base_url(); ?>user/content/questionpaper"><i class="fa fa-angle-double-right"></i> <?php echo 'Question Paper'; ?></a></li>


                                     <li class="<?php echo set_Submenu('content/questionbank'); ?>"><a href="<?php echo base_url(); ?>user/content/questionbank"><i class="fa fa-angle-double-right"></i> <?php echo 'Question Bank'; ?></a></li>
                        ...
                        if ($this->module_lib->hasActive('student_attendance')) {
                            ?>
                            <li class="treeview <?php echo set_Topmenu('Weeklycalendarstudent'); ?>"><a href="<?php echo base_url(); ?>user/weeklycalendarstudent"><i class="fa fa-calendar-check-o"></i> Weekly Timetable</a></li>
                            <?php
                        }
						...
						if ($this->module_lib->hasActive('live_class')) {
						 ...
						 <li class="<?php echo set_Topmenu('live_class');?>" ><a href="<?php echo base_url() ?>user/live_class"><i class="fa fa-mortar-board"></i> <span><?php echo $this->lang->line('live_class'); ?></span> 
                                    </a>
						<?php
						}
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>">
                                        <a href="https://www.pdfdrive.com/dental-book-books.html">
                                            <i class="fa fa-angle-double-right"></i> <?php echo 'PDF Drive'; ?></a>
                                    </li>
                                    <!--<li class="<?php echo set_Submenu('library/Library_web'); ?>">-->
                                    <!--    <a href="https://pcd.libsoft.org/">-->
                                    <!--        <i class="fa fa-angle-double-right"></i> <?php echo 'LIBRARY WEB OPAC'; ?></a>-->
                                    <!--</li>-->
                                    <li class="<?php echo set_Submenu('library/ebsco_host'); ?>">
                                        <a href="http://search.ebscohost.com">
                                            <i class="fa fa-angle-double-right"></i> <?php echo 'EBSCO HOST'; ?></a>
                                    </li>
