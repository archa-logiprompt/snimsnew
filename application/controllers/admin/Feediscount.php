...
class Feediscount extends Admin_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('name','Name','required|is_unique[fees_discounts.name]');
        ...
        $centre_id=$admin['centre_id'];
            ...
            $insert_id=$this->feediscount_model->add($data);
			
			$data2=array(
			'fees_discount_id' =>$insert_id,
			'status'=>'assigned'
			);
			
			$this->feediscount_model->allotdiscount($data2);
