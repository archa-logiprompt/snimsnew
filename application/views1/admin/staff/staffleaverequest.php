                                ...
                                <div class="tab-pane active table-responsive no-padding">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
									 ...
									 if ($this->rbac->hasPrivilege('approve_leave_request', 'can_edit')) {
                                                    if ($value["hod"] == "approve") {
                                                        $label = "class='label label-success'";
                                                    } else if ($value["hod"] == "pending") {
                                                        $label = "class='label label-warning'";
                                                    } else if ($value["hod"] == "disapprove") {
                                                        $label = "class='label label-danger'";
                                                    }
													$s=$value["hod"];
									 }
									  elseif ($this->rbac->hasPrivilege('approve_leave_requestpr', 'can_edit')) {
									     
                                                    if ($value["pstatus"] == "approve") {
                                                        $label = "class='label label-success'";
                                                    } else if ($value["pstatus"] == "pending") {
                                                        $label = "class='label label-warning'";
                                                    } else if ($value["pstatus"] == "disapprove") {
                                                        $label = "class='label label-danger'";
                                                    }
													$s=$value["pstatus"];
									 }
									 elseif ($this->rbac->hasPrivilege('approve_leave_requestdr', 'can_edit')) {
                                                    if ($value["dstatus"] == "approve") {
                                                        $label = "class='label label-success'";
                                                    } else if ($value["dstatus"] == "pending") {
                                                        $label = "class='label label-warning'";
                                                    } else if ($value["dstatus"] == "disapprove") {
                                                        $label = "class='label label-danger'";
                                                    }
													$s=$value["dstatus"];
									 }
                                                    ?>
                                                    <td><span data-toggle="popover" class="detail_popover" data-original-title="" title=""><small <?php echo $label ?>><?php echo $s; ?></small></span>
                                                    ...
                                                    <td class="pull-right no-print">
                                                        ...
                                                        <?php if ($value["applied_by"] == $this->customlib->getAdminSessionUserName()) { ?>
                                                            ...
                                                            if ($this->rbac->hasPrivilege('approve_leave_request', 'can_edit')) {
                                                                ?> 
                                                                <a href="#addleave" onclick="editRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-pencil"></i></a>
                                                            <?php } ?>
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
				...
				<?php echo $this->lang->line('details'); ?></h4>
            </div>
                            ...
                            <table class="table mb0 table-striped table-bordered examples">
                                ...
                                <tr>
                                    ...
                                    if ($this->rbac->hasPrivilege('approve_leave_requestpr', 'can_edit')) {
                                        ?> 
                                        <td colspan="4">
                                            <button type="button" class="btn btn-primary submit_schsettingpr pull-right" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> Save</button>
                                        </td>
										<?php }
                                    if ($this->rbac->hasPrivilege('approve_leave_requestdr', 'can_edit')) {
                                        ?> 
                                        <td colspan="4">
                                            <button type="button" class="btn btn-primary submit_schsettingdr pull-right" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">Save</button>
                                        </td>
                                    <?php } ?>
                                </tr>
                            </table>
                    ...
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                         ...
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6" id="reason">
                            ...
                            <textarea class="form-control" style="resize: none;" rows="4" id="status" name="status" placeholder=""></textarea>
                            <span class="text-danger"><?php echo form_error('status'); ?></span>
