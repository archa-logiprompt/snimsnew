                                                ...
                                                <td>
                                                    <div class="btn-group pull-right">
                                                        <button type="button"
                                                            ...
                                                            data-fine="<?php echo (number_format($fixed_fine, 2, '.', '')); ?>"
        ...
        <?php } ?>
                                    ...
                                    <?php if (!empty($fee_excess)) { ?>
                                        <tr class="box box-solid total-bg">
                                            ...
                                            echo ($currency_symbol . number_format($excess_balance, 2, '.', ''));
                                            ?></td>
                                            <td class="text text-right"></td>
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="fixed"
                                            value="<?php  //echo (number_format($total_fine_amount, 2, '.', '')); ?>0.00">
...
$(document).ready(function() {
    ...
    $('#confirm-refund').on('click', '.btn-refund', function(e) {
        ...
        if(refund_amount>refund_amount_hidden){
