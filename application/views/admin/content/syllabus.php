                ...
                <div class="box box-primary" id="syllabus">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('syllabus_list'); ?></div>
                                    ...
                                    foreach ($list as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                <a href="<?php echo base_url(); ?>uploads/school_content/material/<?php $file=explode('|',$data['file']);
                                                echo $file[0]; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
