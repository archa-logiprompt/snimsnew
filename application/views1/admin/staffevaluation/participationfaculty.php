                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Name of Participation";?> 
                                                	</th>
                                                	 
                                                   
                                                     <th class="text text-center">
                                                        <?php echo "Name(s) of Courses/ Programmes";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Duration Days/ Hours";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Total Hours/ academic year";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "% of Participation against allotment ";?>
                                                    </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Faculty Development Programmes (FDP) undergone";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Resource Person for Faculty Development Programme ";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
