...
class Transcript extends Admin_Controller {
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'transcript/index');
        $data['title'] = 'transcript';
        $class = $this->class_model->get();
		$data['classlist'] = $class;
		//$calhour=$this->class_model->get_hour();
		//$data['get_hour']=$calhour;
		 
        $this->load->view('layout/header', $data);
        $this->load->view('admin/transcript/transcript', $data);
	...
	function get_student()
	{
		...
		else
		{
		  ...
		  if(isset($search))
		   ...
		   $student_list = $this->student_model->searchByClassSection($class, $section);
		   $data['student_list']=$student_list;
        //    var_dump($data['student_list']);exit;
   ...
   function get_transcript()
   {
	  ...
	  $transcript=$this->class_model->get_transcript($class_id,$student_session_id,$student_id);
	  //$transcript=$this->transcript_model->get_transcript($class_id);
    ...
    /*function search() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/header', $data);
            $this->load->view('Transcript/studentfeeSearch', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $class = $this->input->post('class_id');
            $section = $this->input->post('section_id');
    ...
    /*function reportbyname() {
        if (!$this->rbac->hasPrivilege('Examinations', 'can_view')) {
            access_denied();
        }
        $this->session->set_userdata('top_menu', 'Examinations');
        $this->session->set_userdata('sub_menu', 'transcript/reportbyname');
        $data['title'] = 'student fees';
        $data['title'] = 'student fees';
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/header', $data);
            $this->load->view('transcript/reportByName', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $this->form_validation->set_rules('section_id', 'Section', 'trim|required|xss_clean');
            $this->form_validation->set_rules('class_id', 'Class', 'trim|required|xss_clean');
    ...
    /*function reportbyclass() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            $this->load->view('layout/header', $data);
            $this->load->view('transcript/reportByClass', $data);
            $this->load->view('layout/footer', $data);
        } else {
    ...
    /*function view($id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('transcript/studentfeeShow', $data);
        $this->load->view('layout/footer', $data);
    }
*/
   /* function deleteFee() {
    ...
    /*function addfee($id) {
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('transcript/studentAddfee', $data);
        $this->load->view('layout/footer', $data);
    }*/
...
*/
    ...
    /*function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('transcript/studentfeeCreate', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
    ...
    /*function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('transcript/studentfeeEdit', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
                'id' => $id,
