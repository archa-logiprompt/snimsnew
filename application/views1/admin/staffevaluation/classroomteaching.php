                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Nature of classroom – teaching";?> 
                                                	</th>
                                                	 
                                                   
                                                     <th class="text text-center">
                                                        <?php echo "Class (UG/PG) taught ";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Hours / week allotted";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Total Hours taken/week & for academic year";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "% of classes taken as per record";?>
                                                    </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "LECTURES";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "SEMINARS";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "JOURNAL CLUBS";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "DENTAL CLINIC/LAB DEMONSTRATION CLASSES";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
