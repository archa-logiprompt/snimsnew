                                ...
                                <td>        <?php echo $student['firstname'] . " " . $student['lastname']; ?> </td>
                                               ...
                                               <?php  foreach($student['subarr'] as $key=> $marks){?>
                                                            <td>
                                                                <div class="form-group">
                                                                 <label>
                                                                 <input type="checkbox" <?php echo $check; ?> name="student_absent<?php echo $student['student_session_id'] . "_" . $marks['subject_id']; ?>" value="ABS" <?php //if ($exam_schedule['attendence'] == "ABS") echo "checked"; ?>>Absent</label>
