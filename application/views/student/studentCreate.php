                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="around10">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">
                                                    <?php echo $this->lang->line('centre or board registration'); ?></label>
                                                <small class="req"></small>
                                                <input id="kuhs_reg" name="kuhs_reg" placeholder="" type="text" class="form-control" value="<?php echo set_value('centre or board registration'); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Age(as on 31.12.2023)" ?></label><small class="req"> *</small>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="year" name="year" class="form-control">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $feeyear['id'] ?>" <?php if (set_value('year') == $feeyear['year']) echo "selected=selected" ?>><?php echo $feeyear['year'] ?></option>
                                                    <?php
                                                        $count++;
                                                    }
                                                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="annual_income" name="annual_income" placeholder="" type="text" class="form-control" value="<?php echo set_value('annual_income'); ?>" />
                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="around10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('father_phone'); ?></label><small class="req"> *</small>
                            ...
                            <div class="box-group collapsed-box">
                                <div class="panel box box-success collapsed-box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        if ($this->module_lib->hasActive('transport')) {
                                        ?>
                                            <div class="tshadow mb25 bozero" id="plustwo" style="display:none">
                                                ...
                                                <div class="around10">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Last Institution Attended" ?></label><small class="req"> *</small>
                                                                <input id="previous_school" name="previous_school" placeholder="" type="text" class="form-control" value="<?php echo set_value('previous_school'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('previous_school'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Name of Qualifying Examination" ?></label><small class="req"> *</small>
                                                                <input id="qualifying_exam" name="qualifying_exam" placeholder="" type="text" class="form-control" value="<?php echo set_value('qualifying_exam'); ?>" />
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="regno" name="regno" placeholder="" type="text" class="form-control" value="<?php echo set_value('regno'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('regno'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Month & Year" ?></label><small class="req"> *</small>
                                                                <input id="monthyear" name="monthyear" placeholder="" type="text" class="form-control" value="<?php echo set_value('monthyear'); ?>" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Neet exam details" ?></label><small class="req"> *</small> 
                                                ...
                                                <span class="text-danger"><?php echo form_error('neetname'); ?></span>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Neet Rank" ?></label><small class="req"> *</small>
                                                                <input id="neetrank" name="neetrank" placeholder="" type="text" class="form-control" value="<?php echo set_value('total_mark'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('neetrank'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Total Mark" ?></label><small class="req"> *</small>
                                                                <input id="totmark" name="totmark" placeholder="" type="text" class="form-control" value="<?php echo set_value('total_mark'); ?>" />
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="chem_markob" class="form-control" name="chem_markob" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="chem_maxmark" class="form-control" name="chem_maxmark" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="chem_per" class="form-control chem-percentage" name="chem_per" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="phy_markob" class="form-control" name="phy_markob" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="phy_maxmark" class="form-control" name="phy_maxmark" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="phy_per" class="form-control" name="phy_per" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="bio_markob" class="form-control" name="bio_markob" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="bio_maxmark" class="form-control" name="bio_maxmark" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="bio_per" class="form-control" name="bio_per" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_markob" class="form-control" name="tot1" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_maxmark" class="form-control" name="tot2" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_per" class="form-control eng-percentage" name="tot3" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_markob" class="form-control" name="eng_markob" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_maxmark" class="form-control" name="eng_maxmark" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="eng_per" class="form-control eng-percentage" name="eng_per" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="total_markobtained" class="form-control" name="total_mark" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="total_maxmark" class="form-control" name="total_maxmark" value="<?php echo set_value('table_data[' . $i . '][column3]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="total_per" class="form-control" name="total_per" value="<?php echo set_value('table_data[' . $i . '][column4]'); ?>" />
                                                                            </div>
                                                                        </td>
                                        ...
                                        ?>
                                            <div class="tshadow mb25 bozero" id="medical">
                                                <h4 class="pagetitleh2"><?php echo "NEET DETAILS " ?></h4>

                                                <div class="around10">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Neet Registration Number" ?></label><small class="req"> *</small>
                                                                <input id="neet_reg" name="neet_reg" placeholder="" type="text" class="form-control" value="<?php echo set_value('neet_reg'); ?>" />
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Neet Rank" ?></label><small class="req"> *</small>
                                                                <input id="neet_rank" name="neet_rank" placeholder="" type="text" class="form-control" value="<?php echo set_value('neet_rank'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('neet_rank'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Neet Marks" ?></label> <small class="req"> *</small>
                                                                <input id="neet_marks" name="neet_marks" placeholder="" type="text" class="form-control" value="<?php echo set_value('neet_marks'); ?>" />
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="neet_phy_mark_obtained" class="form-control" name="neet_phy_mark_obtained" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="neet_chem_mark_obtained" class="form-control" name="neet_chem_mark_obtained" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="neet_bio_mark_biology" class="form-control" name="neet_bio_mark_biology" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <input type="text" id="neet_percentile" class="form-control" name="neet_percentile" value="<?php echo set_value('table_data[' . $i . '][column2]'); ?>" />
                                                                            </div>
                                                                        </td>
                                        ...
                                        ?>
                                            <div class="tshadow mb25 bozero" id="medical">
                                                <h4 class="pagetitleh2"><?php echo "KEAM DETAILS " ?></h4>

                                                <div class="around10">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Keam Roll Number" ?></label><small class="req"> *</small>
                                                                <input id="keam_roll_no" name="keam_roll_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('keam_roll_no'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('keam_roll_no'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Kerala Medical Rank" ?></label><small class="req"> *</small>
                                                                <input id="kerala_medical_rank" name="kerala_medical_rank" placeholder="" type="text" class="form-control" value="<?php echo set_value('kerala_medical_rank'); ?>" />
                                                                <span class="text-danger"><?php echo form_error('kerala_medical_rank'); ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1"><?php echo "Seat Type AIQ/Open merit/NRI" ?></label> <small class="req"> *</small>
                                                                <input id="seat_type" name="seat_type" placeholder="" type="text" class="form-control" value="<?php echo set_value('seat_type'); ?>" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="scholarship" name="scholarship" class="form-control">
                                                            ...
                                                            <?php if (!empty($sch)) foreach ($sch as $scholar) { ?>
                                                                <option value="<?php echo $scholar['id'] ?>" <?php echo set_value('scholarship') ?>><?php echo $scholar['name'] ?></option>
                                                            <?php  } ?>
