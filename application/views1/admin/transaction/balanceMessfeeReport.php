...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-money"></i> <?php echo $this->lang->line('mess'); ?> <?php echo $this->lang->line('fees_collection'); ?> <small> <?php echo $this->lang->line('filter_by_name1'); ?></small></h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/transaction/balancemessfeereport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-info" id="transfee">
                                ...
                                <div class="box-body table-responsive">
									...
									<?php echo $this->lang->line('balance_fees_report'); ?></div>    
