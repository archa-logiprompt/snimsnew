...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('fees_group', 'can_add') || $this->rbac->hasPrivilege('mess_fee_group', 'can_edit')) {
                ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/messfeegroup/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                         ...
                                         <select autofocus="" id="class_id" name="class_id" class="form-control" >
                                            ...
                                            foreach ($classlist as $class) {
                                                ?>
                                                <option <?php if($class['id']==$feegroup['class_id']) { echo 'selected="selected"';} ?> value="<?php echo $class['id'] ?>" ><?php echo $class['class'] ?></option>
                                                <?php
                                                $count++;
                                            }
                                            ?>
                              ...
                              <input type="hidden" id="sectionid" name="sectionid" value="<?php echo $feegroup['section_id'] ?>" />      
            ...
            if ($this->rbac->hasPrivilege('mess_fee_group', 'can_add') || $this->rbac->hasPrivilege('mess_fee_group', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('mess_fee_group', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/messfeegroup/edit/<?php echo $feegroup['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('mess_fee_group', 'can_delete')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/messfeegroup/delete/<?php echo $feegroup['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
