...
class Certificate extends Admin_Controller {
    ...
    public function index() {
        ...
        // if(!$this->rbac->hasPrivilege('design_certificate','can_view')){
        //      access_denied();
        //      }
    ...
    function delete($id) {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Certificate deleted successfully</div>');
        redirect('admin/certificate/index');
    }
