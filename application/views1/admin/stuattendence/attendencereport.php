                                                                        ...
                                                                        if ($value['date'] != "xxx") {
                                                                            ...
                                                                            ?>
                                                                                    <div class="radio radio-info radio-inline">
                                                                                        <input <?php if ($c == 1)
                                                                                            echo "checked"; ?> type="radio" id="attendencetype<?php echo $value['student_session_id']; ?>" value="<?php echo $type['id'] ?>" name="attendencetype<?php echo $value['student_session_id']; ?>">
	...
	function getSubjectByClassandSection(class_id_post, section_id_post, sub_id_post) {
        ...
        if (class_id_post != "" && section_id_post != "" && sub_id_post != "") {
		 ...
		 $(document).on('change', '#section_id', function (e) {
            ...
            var base_url = '<?php echo base_url() ?>';
            var div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>';
            console.log(section_id+" "+class_id);
            $.ajax({
                type: "POST",
