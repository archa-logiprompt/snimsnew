                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('issue_item'); ?></div>
                                    ...
                                    if (empty($itemissueList)) {
                                        ...
                                        foreach ($itemissueList as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php echo $item['name'] . " " . $item['surname'] . "(" . $item['employee_id'] . ")";
                                                    ;
                                                    ?>
                                                </td>
                                                ...
                                                <td class="mailbox-date pull-right"">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/issueitem/delete/<?php echo $item['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
