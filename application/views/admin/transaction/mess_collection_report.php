        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <select autofocus="" id="pay_mode" name="pay_mode" class="form-control" >
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                ...
                <?php  if(isset($feeList)) {
                    ...
                    <form method="post" action="<?php echo base_url(); ?>admin/excel_export/mess_excel">
                    <input type="hidden" name="date_from" value="<?php echo $date_from ?>" />
                    <input type="hidden" name="date_to" value="<?php echo $date_to ?>" /> 
                    <input type="hidden" name="income_head" value="<?php echo $head ?>" />  
                                  ...
                                  <table style="width:100%;" border="1">
                                   ...
                                   <th style="padding: 5px;"><?php echo $this->lang->line('bill_date'); ?></th>
                                     ...
                                     <th style="padding: 5px;" class="text text-right"> <?php echo $this->lang->line('fee'); ?> <?php echo $this->lang->line('amount'); ?> <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
											...
											$d=	json_decode($fee['amount_detail'], true);
											//var_dump($fee['amount_detail']);
										
											$fine=$d[$fee['invoice_no']]['amount_fine'];
												 $payment_mode='';
												 $description="";
												
											  $total=$total+$fee['amount']+$fine;
										  ...
										  else 
										  {
											 ...
											 $description=$fee['description'];
                                              ...
                                              <td style="text-align:center"><?php echo $fee['invoice_no'] ?></td>
                                               ...
                                               <td style="text-align:center"><?php echo $payment_mode.'/ '. $fee['description'] ?></td>
                                              ...
                                              <td style="text-align:center"><?php echo $fee['amount']+$fine ?></td>
