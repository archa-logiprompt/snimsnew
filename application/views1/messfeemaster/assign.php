        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/messfeemaster/assign/' . $id) ?>" method="post" class="form-horizontal">
                                        ...
                                        <div class="col-md-4">
                                            <div class="table-responsive">
                                                ...
                                                foreach ($feegroupList as $feegroup) {
                                                    ?>
                                                    <h4>
                                                        <input type="hidden" name="mess_fee_session_id" value="<?php echo $feegroup->id; ?>">
                                                        ...
                                                        if (empty($resultlist)) {
                                                            ...
                                                            foreach ($resultlist as $student) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> 
                                                                        <?php
                                                                        if ($student['studentlist']['student_messfees_master_id'] != 0) {
																			
                                                                            $sel = "checked='checked'";
                                                                        } 
																		else if($student['advance_id']!='')
																		{
																			 $sel = "checked='checked'";
																			}
                                                                        ...
                                                                        ?>
                                                                        <input class="checkbox" type="checkbox" name="student_session_id[]"  value="<?php echo $student['studentlist']['student_session_id']; ?>" <?php echo $sel; ?>/>
                                                                        <input type="hidden" name="student_messfees_master_id_<?php echo $student['studentlist']['student_session_id']; ?>" value="<?php echo $student['studentlist']['student_messfees_master_id']; ?>">
                                                                        <input type="hidden" name="student_ids[]" value="<?php echo $student['studentlist']['student_session_id']; ?>">
  <input type="hidden" name="student_id_<?php echo $student['studentlist']['student_session_id']; ?>" value="<?php echo $student['studentlist']['id']; ?>">                                                                 
                                                                    </td>

                                                                    <td><?php echo $student['studentlist']['admission_no']; ?></td>
                                                                    <td><?php echo $student['studentlist']['firstname'] . " " . $student['studentlist']['lastname']; ?></td>
                                                                    <td><?php echo $student['studentlist']['class'] . "(" . $student['studentlist']['section'] . ")" ?></td>
                                                                    <td><?php echo $student['studentlist']['father_name']; ?></td>
                                                                    <td><?php echo $student['studentlist']['category']; ?></td>
                                                                    <td><?php echo $student['studentlist']['gender']; ?></td>
