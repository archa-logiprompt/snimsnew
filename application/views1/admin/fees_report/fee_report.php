...
<div class="content-wrapper" style="min-height: 946px;">
        ...
        <div class="row">
          ...
          <tr >
            ...
            <td style="padding:0px 6px;" colspan="3">Sem/Year</td><td>:</td><td style="width: 216px;" colspan="3"></td>
                       ...
                       <?php if ($header == 'BillNumber and FeeHeadwise Details' || $header == 'Fee Recieved In Excess' || $header == 'Fee Recieved In Advance') { ?>                         
    ...
    border-top: 1px dashed;" class="text text-right">  <?php $st_total = $total_amount + $ad_total + $ex_total;
                                    echo number_format($st_total, 2, '.', ''); ?>  </td>
                                                                                            <td style="    border-bottom: 1px dashed;
    ...
    border-top: 1px dashed;" class="text text-right"> <?php echo number_format($fine, 2, '.', ''); ?> </td>
                                                                    ...
                                                                    <tr class="box box-solid total-bg" style="border-top: 1px solid;">
                                                                        ...
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"><?php //echo ($currency_symbol . number_format($deleted_amount['deleted_amount'], 2, '.', '')); ?></td> -->
                                                                    </tr>
