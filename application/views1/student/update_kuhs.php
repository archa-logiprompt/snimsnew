...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            ...
            <?php echo $this->lang->line('student_information'); ?> <small>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('student/kuhs') ?>" method="post"
                                        class="">
                        ...
                        <div class="tab-content">
                            ...
                            <form role="form" action="<?php echo site_url('student/update_kuhs') ?>" method="post" class="">
                                <div class="tab-pane active table-responsive no-padding" id="tab_1">
                                            ...
                                            if (empty($resultlist)) {
                                                ...
                                                foreach ($resultlist as $student) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <input type="int" name="kuhs_<?php echo $student['student_id'] ?>"
                                                                id="kuhs" data-id="<?php echo $student['student_id'] ?>" value="<?php if (trim($student['kuhs_reg_no']) != "") {
                                                                       echo $student['kuhs_reg_no'];
                                                                   } ?>" />
                                                        </td>
                                                        <td><span class="text-danger"
                                                                id="error_msg_<?php echo $student['student_id'] ?>">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button type="submit" name="search" value="" id="update_btn"
                                                class="btn btn-primary pull-right btn-sm checkbox-toggle">
...
<script type="text/javascript">
    function getSectionByClass(class_id, section_id) {
        if (class_id != "" && section_id != "") {
            $(' #section_id').html(""); var base_url = '<?php echo base_url() ?>'; var
                div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>'
                ; $.ajax({
                    type: "GET", url: base_url + "sections/getByClass",
                    data: { 'class_id': class_id }, dataType: "json", success:
                        function (data) {
                            $.each(data, function (i, obj) {
                                var sel = ""; if
                                    (section_id == obj.section_id) { sel = "selected"; } div_data
                                        += "<option value=" + obj.section_id + " " + sel + ">" + obj.section
                                        + "</option>";
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#class_id', function (e) {
            $('#section_id').html(""); var class_id = $(this).val(); var
                base_url = '<?php echo base_url() ?>'; var
                    div_data = '<option value=""><?php echo $this->lang->line('select'); ?></option>'
                ; $.ajax({
                    type: "GET", url: base_url + "sections/getByClass",
                    data: { 'class_id': class_id }, dataType: "json", success:
                        function (data) {
                            $.each(data, function (i, obj) {
                                div_data
                                    += "<option value=" + obj.section_id + ">" + obj.section
                                    + "</option>";
                            }); $('#section_id').append(div_data);
                        }
                });
        });
        $(document).on('change', '#kuhs', function (e) {
            ...
            $.ajax({
                type: "POST"
                , url: base_url + "Student/CheckKuhs", data: { 'value': value },
            ...
            $('input[id="kuhs"]').not(this).each(function () {
                if ($(this).val() == value) {
                    exist = true
                }
            });
            ...
            if (exist) {
                $("#error_msg_" + id).text("KUHS Already Exists");
