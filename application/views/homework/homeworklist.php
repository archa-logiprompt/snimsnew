                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select  id="subject_id" name="subject_id" class="form-control subject_id" >
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                </select>
                                <span class="section_id_error text-danger"></span>
                            </div>
                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo 'Homework description'; ?></th>
...
<?php foreach ($homeworklist as $key => $homework) {
   ...
   <label><a  href="<?php echo base_url() . "uploads/homework/" . $homework["document"] ?>" class="btn btn-default btn-xs" download> <i class="fa fa-download"></i></a></label>                                                <?php } if ($this->rbac->hasPrivilege('homework', 'can_edit')) { ?>   
...
<?php } ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control subject_id" name="subject_id" id="subject_id">
                                            <option value=""><?php echo $this->lang->line('select') ?></option>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="homework_date" name="homework_date" class="form-control" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="submit_date" name="submit_date"class="form-control" value="<?php echo set_value('follow_up_date', date($this->customlib->getSchoolDateFormat())); ?>" >
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
...
<?php } ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('homework_date'); ?></label>
                                        <input type="date" id="homeworkdate" name="homework_date" class="form-control" value="" >
                                        <span id="date_add_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('submission_date'); ?></label>
                                        <input type="date" id="submitdate" name="submit_date" class="form-control" value="" >
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('attach_document'); ?></label>
                                        <input type="file" id="file" name="userfile" class="form-control filestyle" value="" style="opacity:100">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i, obj) {
                    div_data += "<option value=" + obj.subject_id + ">" + obj.name + " (" + obj.code + ")" + "</option>";
                });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(i, obj) {
                ...
                var sel = "";
                if (sub_id_post == obj.subject_id) {
                    sel = "selected";
                }
                div_data += "<option value=" + obj.subject_id + " " + sel + ">" + obj.name + " (" + obj
                    .code + ")" + "</option>";
    ...
    function getSubject(section_id, classid, htmlid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $.each(data, function(i, obj) {
                    div_data += "<option value=" + obj.subject_id + ">" + obj.name + " (" +
                        obj.code + ")" + "</option>";
                });
                console.log(data)
                $('.subject_id').append(div_data);
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function (i, obj)
                    {
                        ...
                        div_data += "<option value=" + obj.subject_id + " " + sel + ">" + obj.name + " (" + obj.code + ")" + "</option>";
                    });
