...
class Itemsupplier extends Admin_Controller {
    ...
    function create() {
        ...
        $this->form_validation->set_rules('phone', 'Phone','required|regex_match[/^[0-9]{10}$/]', 'trim|numeric|xss_clean');
        $this->form_validation->set_rules('email', 'Email', 'trim|xss_clean|valid_email');
        $this->form_validation->set_rules('contact_person_phone','required|regex_match[/^[0-9]{10}$/]', 'Phone', 'trim|numeric|xss_clean');
