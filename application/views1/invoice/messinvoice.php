<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('mess_invoice', 'can_add')) { ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('mess'); ?> <?php echo $this->lang->line('invoice'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('invoice/mess_invoice') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="invoice" name="invoice" placeholder="" type="text" class="form-control"  value="<?php echo set_value('invoice',$list->invo); ?>" />
