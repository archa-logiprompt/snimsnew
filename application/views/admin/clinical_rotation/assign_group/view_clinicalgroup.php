        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php if ($this->rbac->hasPrivilege('clinical_group', 'can_add')) { ?>
                        <a href="<?php echo base_url(); ?>admin/clinical_group" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="<?php echo $this->lang->line('clinical_group'); ?>" >
                            <i class="fa fa-plus"></i> <?php echo $this->lang->line('new_group'); ?>
                        </a>
                    <?php } ?>
                </div>
                                   ...
                                   $i=1;foreach($group as $key=>$grp)
								  {
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo $grp['group_name'] ?></td>
                                               ...
                                               <td class="pull-right">
                                                   <a href="<?php echo base_url(); ?>admin/clinical_group/delete/<?php echo $grp['id'] ?>"class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                        <?php echo "Delete"; ?>
                                                    </a>
...
/* $('.checkbox').change(function () {
	...
	*/
	 ...
	 $(document).on('click', '.schedule_modal', function () {
        ...
        $('.modal-title').html("<?php echo $this->lang->line('clinical_rotation'); ?> ");
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            type: "post",
            url: base_url + "admin/clinical_group/get_studentbygroup",
...
<div id="scheduleModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
         ...
         <form role="form" id="release_form" action="<?php echo base_url()?>admin/Clinical_group/release_stud" method="post" class="">
