<div class="content-wrapper">  
    <section class="content-header">
        <h1><i class="fa fa-sitemap"></i> <?php echo $this->lang->line('human_resource'); ?>
            <?php if ($this->rbac->hasPrivilege('superviser_leave', 'can_add')) { ?>
                <small class="pull-right"><a href="#addleave" onclick="addSleave()" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $this->lang->line('apply_leave'); ?></a></small>
            <?php } ?></h1>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    <td class="pull-right no-print"><a href="#leavedetails" onclick="getRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-reorder"></i></a>                      
                                                    </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        $("#addleave_form").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url("admin/leaverequest/add_superviser_leave") ?>",
                type: "POST",
