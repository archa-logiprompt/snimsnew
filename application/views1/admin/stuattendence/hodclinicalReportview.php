        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/staffevaluation/hodclinicalReportview') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="box-header with-border" >
                                <div class="row">
                                    <div class="col-md-4 col-sm-4">
                                        <h3 class="box-title"><i class="fa fa-users"></i> <?php echo 'Clinical Approve Report'; ?> </h3>
                                    </div>
