                	...
                	<div class="box-header with-border">
                    	<h3 class="box-title">
                       	...
                       	<div class="box-tools pull-right">
                        	...
                        	<a href="<?php echo base_url(); ?>admin/weeklycalendar/create" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="<?php echo $this->lang->line('add_timetable'); ?>" >
                            	<i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?>
                        	</a>
                            <?php } ?>
                        </div>
                    </div>
                    <form action="<?php echo site_url('admin/weeklycalendar/index')?>" method="post" accept-charset="utf-8">
                    	<div class="box-body">
