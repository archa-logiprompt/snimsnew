...
class Customlib {
  ...
  function getcontenttype() {
        ...
        $status['Question_paper'] = 'Question Paper';
        $status['Question_bank'] = 'Question Bank';
	...
	/*function getMonthDropdownTwo() {
        $array = array();
        for ($m = 1; $m <= 12; $m++) {
            $monthstwo = date('F', mktime(0, 0, 0, $m, 1, date('Y')));
            $array[$monthstwo] = $monthstwo;
        }
        return $array;
    }
 function getMonthListTwo() {
        $monthstwo = array(1 => '01', 2 => '02', 3 => '03', 4 => '04', 5 => '05', 6 => '06', 7 => '07', 8 => '08', 9 => '09', 10 => '10', 11 => '11', 12 => '12');
        return $monthstwo;
    }*/
	...
	function getstudentsession($id)
	{
		$getstudentsession=$this->CI->student_model->studentSessionlist($id);
		$sessionlist=$getstudentsession;
		return  $sessionlist;
