        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/live_class/create') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                  ...
                  <label for="exampleInputEmail1"><?php echo $this->lang->line('class'); ?></label>
                      ...
                      <!--   <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Apid</label>
                                        <input type="text" name="apid" value="" class="form-control" />
                ...
                if (!empty($timetableSchedule)) {
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($timetableSchedule)) {
                                ?>
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('admin/live_class/create') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
...
<input type="hidden" value="<?php echo $val->post_id;?>" class="edit_id" name="edit_<?php echo $key;?>[]"></input>
                                                    ...
                                                    <input type="hidden" name="teacher_id" value="<?php echo $teacher_id; ?>">
                                                        ...
                                                        <th>
                                                          ...
                                                          <th>
                                                         <input type="text" name="apid_<?php echo $key; ?>[]" value=" <?php echo $val->apid ?>" class="form-control"  /></th>
                         ...
                         <input type="hidden" value="<?php echo $key; ?>"  class="edit_day" name="i[]"> </input>
<input type="hidden" value="<?php echo $value->post_id;?>" class="edit_id" name="edit_<?php echo $key;?>[]"></input>
                                     ...
                                     <input type="hidden" name="key[]" value="<?php echo $key ?>"/>     
                                                        ...
                                                        <th>
                                                          ...
                                                          <th>
                              <input type="text" name="apid_<?php echo $key; ?>[]" value="<?php echo $val->apid ?>" class="form-control"  />
                                                        </th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var subject_id = '<?php echo set_value('subject_id') ?>';
		 var teacher_id = '<?php echo set_value('teacher_id') ?>';
