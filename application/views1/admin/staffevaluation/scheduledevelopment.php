                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Nature of duties";?> 
                                                	</th>
                                                	 
                                                   
                                                     <th class="text text-center">
                                                        <?php echo "Details of Batches responsible for";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Teaching Schedule documentation";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Clinical Schedule documentation";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "% of compliance and Record Submission to authorities";?>
                                                    </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Departmental Schedule preparation – Teaching & Clinical ";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Documentation of conduction as per schedule – Teaching & Clinical ";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Monthly Statement of documentation to office";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Yearly report on compliance of duties as per schedules provided ";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
