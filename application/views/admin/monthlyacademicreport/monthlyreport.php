        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/monthlyacademicreport/index')?>" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1">Select Month</label><small
                                            class="req"> *</small>
                                ...
                                <table style="width:100%;" border="1">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="padding: 5px;">Total Hours</th>

                                            <th style="padding: 5px;">Completed Hours (Till Last Month)</th>
                                            
                                            <th style="padding: 5px;">Faculty</th>
                                            
                                            <th style="padding: 5px;">Alloted Hours (This Month)</th>
                                            
                                            <th style="padding: 5px;">Hours Taken (This Month)</th>
                                            
                                            <th style="padding: 5px;">Cumulative Hours Completed</th>
                                    ...
                                    <tbody>
                                       ...
                                       ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center"><?php echo $value['total_hours']; ?></td>
                                            <td style="text-align:center"><?php echo abs($value['completed_hours_this_month']- $value['completed_hours']); ?></td>

                                            
                                           
                                            <td style="text-align:center">

                                            <?php foreach ($value['teacher'] as $subjectkey => $subjectvalue) {
                                                    echo '<br/>';
                                                    echo $subjectvalue;
                                                    echo '<br/>'; 
                                                    echo '<br/>'; 
                                            ...
                                            <td style="text-align:center"><?php echo $value['alloted_hours_this_month']; ?></td>
                                            <td style="text-align:center"><?php echo $value['completed_hours_this_month']; ?></td>
                                            <td style="text-align:center"><?php echo $value['completed_hours']; ?></td>
...
$(document).on('click', '#collection_print', function () {
    ...
    // Make an AJAX request to the 'index2' method with the class parameter
    $.ajax({
