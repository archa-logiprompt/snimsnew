                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/content') ?>"  id="employeeform" name="employeeform" method="post"  enctype='multipart/form-data' accept-charset="utf-8">
                                ...
                                <div class="row newrow">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="filestyle form-control" data-height="40" type='file' name='file[]' id="file"   />
                            ...
                            <div class="row">
                                ...
                                <button class="btn btn-info" style="margin-left: 30px" type="button"  id="btnsubmit">Add More File
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('content_list'); ?></div>
                                    ...
                                    foreach ($list as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                               <?php $mexpl= explode('|',$data[file])?>
                                              <?php foreach ($mexpl as $ex) {
 if($ex!=""){?>
                                                    <a href="<?php echo base_url(); ?>uploads/school_content/material/<?php echo $ex ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('upload_content', 'can_delete')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/content/delete/<?php echo $data['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
//     })
    ...
    if (input.files && input.files[0]) 
    {
        ...
        {
            th.parent().parent().parent().find('#imgup').attr('src', e.target.result);
            //console.log(th.parent().parent().find('#imgfiles'));
            //th.parent().parent().find('#oldimg').remove();
...
$(document).on('change','#img',function()
{
    ...
    <div class="dropify-wrapper" style="height: 42px;"><div class="dropify-message"><p><i class="fa fa-cloud-upload dropi18"></i>Drag and drop a file here or click</p><p class="dropify-error">Ooops, something wrong appended.</p></div><div class="dropify-loader"></div><div class="dropify-errors-container"><ul></ul></div><input class="filestyle form-control" data-height="40" type="file" name="file[]" id="file" size="20"><button type="button" class="dropify-clear">Remove</button><div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner"></span></p><p class="dropify-infos-message">Drag and drop or click to replace</p></div></div></div></div></div>
         ...
         $('.newrow').append(html);
        //$('.ctrl-remove-taxo').html('<i class="icon-minus"></i>');
