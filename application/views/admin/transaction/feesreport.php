...
<h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('select_criteria'); ?></h3>
                    ...
                    <form action="<?php echo site_url('admin/transaction/fees_report') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-info" id="transfee">
                                <div class="box-header ptbnull">
                                    <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('fees_report'); ?></h3>
                                </div>                              
                                <div class="box-body table-responsive">
                                    <div class="download_label"><?php echo $this->lang->line('fees_report'); ?></div>    
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            <tr>
                                               ...
                                               <?php /*?> <th class="text text-left"><?php echo $this->lang->line('father_name'); ?></th><?php */?>
                                            ...
                                            if (!empty($student_due_fee)) {
                                                foreach ($student_due_fee as $key => $student) {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <?php /*?> <td><?php echo $student->father_name; ?>   </td>
<?php */?>
