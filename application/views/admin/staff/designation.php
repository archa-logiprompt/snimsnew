                        ...
                        <form id="form1" action="<?php echo site_url('admin/designation/designation') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('designation'); ?> <?php echo $this->lang->line('name'); ?></label><small class="req"> *</small>
                ...
                <div class="box box-primary" id="tachelist">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('designation'); ?></div>
