...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('mess_fee_group', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/messfeegroup"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
