                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="annual_income" name="annual_income" placeholder="" type="number" class="form-control"  value="<?php echo set_value('annual_income'); ?>" />
    ...
    <option value="<?php echo $hostel_value['id'] ?>" <?php echo set_select('hostel_id', $hostel_value['id']); ?>>
        ...
        echo $hostel_value['hostel_name']; ?>
                                   ...
                                   <?php } ?>         
                                                ...
                                                <div class="row around10">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="bank_account_no" name="bank_account_no" placeholder="" type="number" class="form-control"  value="<?php echo set_value('bank_account_no'); ?>" />
                                            ...
                                            <div class="radio" style="margin-top: 2px; display:none">
