                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('classes/edit/' . $id) ?>"  method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('degree_awarded_by'); ?></label><small class="req"> *</small>
                                    <input autofocus="" id="degree_award" name="degree_award" placeholder="Degree Awarded BY" type="text" class="form-control"  value="<?php echo set_value('degree_award',$vehroute[0]->award); ?>" />
                                    <span class="text-danger"><?php echo form_error('degree_award'); ?></span>
                                </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('class_list'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('class', 'can_delete')) {
                                                    ?>  
                                                    <a href="<?php echo base_url(); ?>classes/delete/<?php echo $vehroute->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
