...
<div class="content-wrapper" style="min-height: 946px;">
        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/clinical_department/batchwiseattendancereport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
    ...
    function getSubjectByClassandSection(class_id_post, section_id_post, sub_id_post) {
        ...
        if (class_id_post != "" && section_id_post != "" && sub_id_post != "") {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "admin/clinical_department/getavailbatchs",
