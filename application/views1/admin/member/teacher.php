                ...
                <div class="box box-primary" id="tachelist">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('staff_member_list'); ?></div>
                                            ...
                                            <tr class="<?php echo $clsactive; ?>">
                                                ...
                                                <td class="text text-right">
                                                    ...
                                                    if ($teacher['libarary_member_id'] == 0) {
                                                        ...
                                                        ?>
                                                        <button type="button" class="btn btn-default btn-xs surrender-teacher" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.." data-toggle="tooltip" data-memberid="<?php echo $member_id; ?>" title="<?php echo $this->lang->line('surrender_membership'); ?>"><i class="fa fa-mail-reply"></i></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('admin/member/addteacher') ?>" id="add_member" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm add-member" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait..">Add</button>
                </form>
            </div>
        </div>
    </div>
