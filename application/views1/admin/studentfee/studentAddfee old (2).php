...
?>
	...
	?>
                                                       ...
                                                       <td align="left"></td>
                                                        ...
                                                        <td class="text text-left"><?php echo $examount->payment_mode; ?></td>
                                                        <td class="text text-left">
...
?>
                                                       ...
                                                       <td align="left"></td>
                                                        ...
                                                        <td class="text text-left"><?php echo $admount->payment_mode; ?></td>
                                                        <td class="text text-left">
                    ...
                    <div class="box-body">
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" autofocus="" class="form-control modal_amount" id="ex_invo" name="ex_invo" value=""  >
...
<script type="text/javascript">
	 ...
	 $(document).on('click', '.btn_feeadvance', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'ad_amount': ad_amount, 'ad_date': ad_date,'ad_note':ad_note,'payment_mode_fee':payment_mode,'student_id':student_id},
                success: function (data) {
	...
	$(document).on('click', '.btn_feeexcess', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'ex_amount': ex_amount, 'ex_date': ex_date,'ex_note':ex_note,'payment_mode_fee':payment_mode,'student_id':student_id},
