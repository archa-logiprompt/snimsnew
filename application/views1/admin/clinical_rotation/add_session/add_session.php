        ...
        <div class="row">
            ...
            //if ($this->rbac->hasPrivilege('add_session', 'can_add')) {
               ...
               <h3 class="box-title"><?php echo $this->lang->line('add_session'); ?></h3>
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/clinical_department/add_session"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                               ...
                               <div style="margin-top: 74px;">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input autofocus="" id="in_time" name="in_time" type="text" class="form-control clockpicker" readonly="readonly" value="" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input autofocus="" id="out_time" name="out_time" type="text" class="form-control clockpicker" readonly="readonly" value="" />
