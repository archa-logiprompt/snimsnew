            ...
            if ($this->rbac->hasPrivilege('scholarship', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/scholarship"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" type="text" class="form-control"  value="<?php echo set_value('year'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="valid_from" name="valid_from" type="date" class="form-control"  value="<?php echo set_value('valid_from'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="valid_to" name="valid_to" type="date" class="form-control"  value="<?php echo set_value('valid_to'); ?>" />
