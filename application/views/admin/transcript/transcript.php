...
$(document).on('click', '.schedule_modal', function () {
	//$("#scheduleModal").modal('show');
        $('.modal-title').html("");
		   ...
		   var date_of_completion=$(this).data('date_of_completion');	
		   var duration=$(this).data('duration');	
		   var date_of_result=$(this).data('date_of_result');	 
        ...
        $.ajax({
			...
			data +='<div class="row"> <div class="col-md-5"> <label>Duration of the course</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label>'+duration+'</label> </div> </div>';
			...
			data +='<div class="row"> <div class="col-md-5"> <label>Date of completion of course</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label>'+date_of_completion+'</label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Date of publication of Final Result </label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label>'+date_of_result+'</label> </div> </div>';
...
data +='</tr><tr><th style="font-size: 16px;font-weight: bold;text-align: left;">Total</th><th></th><th> </th><th></th><th></th><th></th><th></th><th> </th><th></th><th>'+grandtotal+'/800</th></tr>';
		...
		let percentage = Math.floor((Number(grandtotal)/800)*100)
        
		data +='</table>';		
			 
			     
			  data += '<div class="row" style="margin-top: 64px;"> <div class="col-md-3"> <label>Aggregate Marks</label> </div><div class="col-md-1"> :'+grandtotal+'</div>    <div class="col-md-3"> <label></label> </div><div class="col-md-4"> <label> Max Marks(Four Years) : 3250</label> </div>  </div> ';
			 
			  data +='<div class="row"> <div class="col-md-3"> <label>Percentage Marks</label> </div>  <div class="col-md-1"> :'+percentage+' </div>   <div class="col-md-6"> <label></label></div> </div> ';
...
data += '<div class="row"> Date: ' + formattedDate + ' </div>';		
