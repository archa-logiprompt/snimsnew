...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> <?php echo $this->lang->line('inventory'); ?> <small></small></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/itemreport/storewise') ?>" method="post" class="">
                                     ...
                                     <!--   <div class="col-sm-6"></div>-->
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('store'); ?></label><small class="req"> *</small> 
                                                <select  id="store" name="store" class="form-control" >
                                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                <?php if(!empty($itemstore)) foreach($itemstore as $st) {?>
                                                    <option value="<?php echo $st['id'] ?>" <?php if (set_value('store') == $st['id']) echo "selected=selected" ?>><?php echo $st['item_store'] ?></option>
                                                    <?php } ?>
                                                </select>
                                ...
                                <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($store)) {
                                            ...
                                            $count = 1;
                                            foreach ($store as $storewise) {
                                                ?>
                                                <tr>
                                    <td><?php echo $storewise->name ?></td>
                                    <td><?php echo $storewise->item_category ?></td>
                                    <td><?php echo $storewise->item_supplier ?></td>
                                   <td><?php echo $storewise->quantity ?></td>
                                  <td><?php echo $storewise->date ?></td>
