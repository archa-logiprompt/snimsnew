<div class="content-wrapper">  
    <section class="content-header">
        <h1><i class="fa fa-sitemap"></i> <?php echo $this->lang->line('human_resource'); ?>
            <?php
            if ($this->rbac->hasPrivilege('superviser_approve', 'can_add')) {
                ?>
                <small class="pull-right"><a href="#addleave" onclick="addSleave()" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('leave_request'); ?></a></small>
            <?php } ?></h1>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    <?php
                                                    if ($value["statue"] == "approve") {
                                                        $label = "class='label label-success'";
                                                    } else if ($value["statue"] == "pending") {
                                                        $label = "class='label label-warning'";
                                                    } else if ($value["statue"] == "disapprove") {
                                                        $label = "class='label label-danger'";
                                                    }
                                                    ?>
                                                    <td><span data-toggle="popover" class="detail_popover" data-original-title="" title=""><small <?php echo $label ?>><?php echo $status[$value["statue"]]; ?></small></span>
