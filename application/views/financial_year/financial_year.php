<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('financial_year', 'can_add')) { ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('financial_year'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('financial_year/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('financial_year'); ?></label><small class="req"> *</small>
                                    <input autofocus="" id="finance_year" name="finance_year" placeholder="" type="text" class="form-control"  value="<?php echo set_value('finance_year'); ?>" />
                                    <span class="text-danger"><?php echo form_error('finance_year'); ?></span>
                                </div>
                            </div>
            ...
            ?>"> 
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('financial_year'); ?></h3>
                    </div>
                    <div class="box-body">
