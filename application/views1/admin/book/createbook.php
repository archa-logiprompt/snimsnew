                    ...
                    <form id="form1" action="<?php echo site_url('admin/book/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="book_no" name="book_no" placeholder="" type="number" class="form-control"  value="<?php echo set_value('book_no'); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="isbn_no" name="isbn_no" placeholder="" type="number" class="form-control"  value="<?php echo set_value('isbn_no'); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="rack_no" name="rack_no" placeholder="" type="number" class="form-control"  value="<?php echo set_value('rack_no'); ?>" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="perunitcost" name="perunitcost" placeholder="" type="number" class="form-control"  value="<?php echo set_value('perunitcost'); ?>" />
