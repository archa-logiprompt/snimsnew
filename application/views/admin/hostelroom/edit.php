                        ...
                        <form action="<?php echo site_url('admin/hostelroom/edit/' . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus=""  name="room_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('room_no', $hostelroom['room_no']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="no_of_bed" placeholder="" type="text" class="form-control"  value="<?php echo set_value('no_of_bed', $hostelroom['no_of_bed']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if($hostelroom['is_yearly']=='1'){ ?>
                                    <input id="amount" name="cost_per_bed" placeholder="" type="text" class="form-control"  value="<?php echo $hostelroom['cost_per_bed']/12; ?>" />
                                    <?php }else{ ?>
                                        <input id="amount" name="cost_per_bed" placeholder="" type="text" class="form-control"  value="<?php echo  $hostelroom['cost_per_bed']; ?>" />
                                ...
                                <div class="checkbox" style="display:none">
                                        <label>
                                            <input type="radio" name="collected_yearly" value="0" class='collected_in' <?php if($hostelroom['is_yearly']==0){echo 'checked';}?>> Monthly
                                        </label>
                                        <label>
                                            <input type="radio" name="collected_yearly" value="1" class='collected_in' <?php if($hostelroom['is_yearly']==1){echo 'checked';}?>> Yearly
                                        </label>
                                            
                                             
                                       </div>
                                       <div class="total_fee_div" style="display:none">
                                        Total Fee of <span id="total_amount"></span> is collected Yearly
                                       </div>
                ...
                <div class="box box-primary" id="hroom">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('hostel_room_list'); ?></div>
                                        ...
                                        foreach ($hostelroomlist as $hostelroom) {
                                            ...
                                            <tr>
                                                ...
                                                <?php if($hostelroom['is_yearly']=='1'){ ?>
                                                    ...
                                                    <td class="mailbox-name"> <?php echo $currency_symbol . $hostelroom['cost_per_bed']/12 ?></td>
                                                    <?php }else{ ?>
...
<script>
    $('.collected_in').on('change',function(){
        let value = $(this).val()
        let amount = $('#amount').val() 
        if(amount!=''){

            if(value=='1'){
                let yearlyamount = Number(amount)*12
                $('#total_amount').text(yearlyamount)
                $('#total_amount_final').val(yearlyamount)
                $('.total_fee_div').show()
            }else{
                $('#total_amount_final').val(amount)
                $('#total_amount').text('')
                $('.total_fee_div').hide()
