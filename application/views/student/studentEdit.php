                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="mobileno" name="mobileno" placeholder="" type="number" class="form-control"  value="<?php echo set_value('mobileno', $student['mobileno']); ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  id="year" name="year" class="form-control"  >
                                                    ...
                                                    foreach ($feeyearlist as $feeyear) {
                                                        ?>
                                                        <option value="<?php echo $feeyear['id'] ?>"<?php if ($student['year'] == $feeyear['id']) echo "selected=selected" ?>><?php echo $feeyear['year'] ?></option>
                                                        <?php
                                                        $count++;
                                                    }
                                                    ?>
                                        ...
                                        <div class="col-md-3">
                                         ...
                                         <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="nationality" name="nationality" placeholder="" type="text" class="form-control"  value="<?php echo set_value('nationality',$student['nationality']); ?>" />
                                                <span class="text-danger"><?php //echo form_error('cast'); ?></span>
                                            </div>
                                        </div>
...
if($this->module_lib->hasActive('transport')){
        ?>
                        <div class="tshadow mb25 bozero" id="plustwo"  >
                                          <h4 class="pagetitleh2"><?php echo "12th Exam details " ?></h4>

                                            <div class="around10">  
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Last Institution Attended" ?></label>
                                                <input id="previous_school" name="previous_school" value="<?php echo $student['previous_school'] ?>" placeholder="" type="text" class="form-control"  value="<?php echo set_value('previous_school'); ?>" />
                                                <span class="text-danger"><?php echo form_error('previous_school'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Name of Qualifying Examination" ?></label>
                                                <input id="qualifying_exam" name="qualifying_exam"  value="<?php echo $student['qualifying_exam'] ?>" placeholder="" type="text" class="form-control"  value="<?php echo set_value('qualifying_exam'); ?>" />
                                                <span class="text-danger"><?php echo form_error('qualifying_exam'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Reg No" ?></label>
                                                <input id="regno" name="regno" placeholder="" value="<?php echo $student['regno']?>" type="text" class="form-control"  value="<?php echo set_value('regno'); ?>" />
                                                <span class="text-danger"><?php echo form_error('regno'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Month & Year" ?></label>
                                                <input id="monthyear" name="monthyear" placeholder="" value="<?php echo $student['monthyear'] ?>" type="text" class="form-control"  value="<?php echo set_value('monthyear'); ?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Total mark Scored" ?></label>
                                                <input id="total_mark" name="total_mark" placeholder="" value="<?php echo $student['total_mark'] ?>"  type="number" class="form-control"  value="<?php echo set_value('total_mark'); ?>" />
                                                <span class="text-danger"><?php echo form_error('total_mark'); ?></span>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Neet exam details" ?></label>
                                                <input id="neetname" name="neetname" placeholder="" type="text" value="<?php echo $student['neetname'] ?>" class="form-control"  value="<?php echo set_value('total_mark'); ?>" />
                                                <span class="text-danger"><?php echo form_error('neetname'); ?></span>
                                            </div>
                                        </div> -->
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Neet Rank" ?></label>
                                                <input id="neetrank" name="neetrank" placeholder="" type="text" value="<?php echo $student['neetrank'] ?>" class="form-control"  value="<?php echo set_value('total_mark'); ?>" />
                                                <span class="text-danger"><?php echo form_error('neetrank'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Total Mark" ?></label>
                                                <input id="totmark" name="totmark" placeholder="" value="<?php echo $student['totmark'] ?>" type="text" class="form-control"  value="<?php echo set_value('total_mark'); ?>" />
                                                <span class="text-danger"><?php echo form_error('totmark'); ?></span>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "Maximum Mark" ?></label>
                                                <input id="maxmark" name="maxmark" placeholder="" value="<?php echo $student['maxmark'] ?>" type="text" class="form-control"  value="<?php echo set_value('total_mark'); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="text" id="chem_markob" class="form-control" name="chem_markob" value="<?php echo $student['chem_markob'] ?>" />
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="chem_maxmark" class="form-control" name="chem_maxmark"  value="<?php echo $student['chem_maxmark'] ?>" />
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="chem_per" class="form-control chem-percentage" name="chem_per" value="<?php echo $student['chem_per'] ?>" />
                        </div>
                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text"  id="phy_markob" class="form-control" name="phy_markob" value="<?php echo $student['phy_markob'] ?>" />
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" id="phy_maxmark" class="form-control" name="phy_maxmark" value="<?php echo $student['phy_maxmark'] ?>" />
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" id="phy_per" class="form-control" name="phy_per" value="<?php echo $student['phy_per'] ?>" />
                                    </div>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" id="bio_markob" class="form-control" name="bio_markob" value="<?php echo $student['bio_markob'] ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input type="text" id="bio_maxmark" class="form-control" name="bio_maxmark" value="<?php echo $student['bio_maxmark'] ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input type="text" id="bio_per"class="form-control" name="bio_per" value="<?php echo $student['bio_per'] ?>"/>
                                </div>
                            </td>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_markob" class="form-control" name="tot1" value="<?php echo $student['tot1'] ?>"/>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_maxmark" class="form-control" name="tot2" value="<?php echo $student['tot2'] ?>"/>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_per" class="form-control eng-percentage" name="tot3" value="<?php echo $student['tot3'] ?>" />
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_markob" class="form-control" name="eng_markob"  value="<?php echo $student['eng_markob'] ?>"/>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_maxmark" class="form-control" name="eng_maxmark" value="<?php echo $student['eng_maxmark'] ?>" />
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" id="eng_per" class="form-control eng-percentage" name="eng_per" value="<?php echo $student['eng_per'] ?>" />
                        </div>
                    </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" id="total_markobtained"class="form-control" name="total_mark" value="<?php echo $student['total_mark'] ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input type="text" id="total_maxmark" class="form-control" name="total_maxmark" value="<?php echo $student['total_maxmark'] ?>"  />
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input type="text" id="total_per" class="form-control" name="total_per" value="<?php echo $student['total_per'] ?>" />
                                </div>
                            </td>
...
if($this->module_lib->hasActive('transport')){
        ?>
         <div class="tshadow mb25 bozero" id="medical">
                                        <h4 class="pagetitleh2"><?php echo "Details of qualifying details(MBBS) " ?></h4>

                                          <div class="around10">  
                                  <div class="row">
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Name of college" ?></label><small class="req"> </small> 
                                              <input id="previous_school" name="med_previous_school" placeholder="" type="text" class="form-control"  value="<?php echo set_value('previous_school'); ?>" />
                                              <span class="text-danger"><?php echo form_error('previous_school'); ?></span>
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Name of Council" ?></label><small class="req"> </small> 
                                              <input id="qualifying_exam" name="med_qualifying_exam" placeholder="" type="text" class="form-control"  value="<?php echo set_value('qualifying_exam'); ?>" />
                                              <span class="text-danger"><?php echo form_error('qualifying_exam'); ?></span>
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Reg No" ?></label> <small class="req"> </small> 
                                              <input id="regno" name="med_regno" placeholder="" type="text" class="form-control"  value="<?php echo set_value('regno'); ?>" />
                                              <span class="text-danger"><?php echo form_error('regno'); ?></span>
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Year" ?></label><small class="req"> *</small> 
                                              <input id="monthyear" name="med_year" placeholder="" type="text" class="form-control"  value="<?php echo set_value('monthyear'); ?>" />
                                              <span class="text-danger"><?php echo form_error('monthyear'); ?></span>
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Distinction/first class/second class" ?></label><small class="req"> *</small> 
                                              <input id="dfs" name="dfs" placeholder="" type="text" class="form-control"  value="<?php echo set_value('dfs'); ?>" />
                                  ...
                                  <div class="row">
                                      <!-- <div class="col-md-3">
                                          <div class="form-group">
                                              <label for="exampleInputEmail1"><?php echo "Total mark Scored" ?></label><small class="req"> *</small> 
              ...
              <tr>
                  <td>
                      <div class="form-group">
                          <?php echo "1st Year MBBS"?>
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="first_mbbs_scored" class="form-control" name="first_mbbs_scored" value="<?php echo $student['first_mbbs_scored'] ;?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="first_mbbs_max" class="form-control" name="first_mbbs_max" value="<?php echo $student['first_mbbs_max']; ?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="first_mbbs_per" class="form-control chem-percentage" name="first_mbbs_per" value="<?php echo $student['first_mbbs_per']; ?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="first_mbbs_year" class="form-control chem-percentage" name="first_mbbs_year" value="<?php echo $student['first_mbbs_year']; ?>" />
                      </div>
                  </td>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="form-group">
                                      <input type="text"  id="phy_markob" class="form-control" name="second_mbbs_scored" value="<?php echo $student['second_mbbs_scored']; ?>" />
                                  </div>
                              </td>
                              <td>
                                  <div class="form-group">
                                      <input type="text" id="phy_maxmark" class="form-control" name="second_mbbs_max" value="<?php echo $student['second_mbbs_max']; ?>" />
                                  </div>
                              </td>
                              <td>
                                  <div class="form-group">
                                      <input type="text" id="phy_per" class="form-control" name="second_mbbs_per" value="<?php echo $student['second_mbbs_per']; ?>" />
                                  </div>
                              </td>
                              <td>
                                  <div class="form-group">
                                      <input type="text" id="phy_per" class="form-control" name="second_mbbs_year" value="<?php echo $student['second_mbbs_year']; ?>" />
                                  </div>
                              </td>
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_scored" class="form-control" name="third_mbbs_scored" value="<?php echo $student['third_mbbs_scored'];  ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_max" class="form-control" name="third_mbbs_max" value="<?php echo $student['third_mbbs_max']; ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_per"class="form-control" name="third_mbbs_per" value="<?php echo $student['third_mbbs_per'];  ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_year"class="form-control" name="third_mbbs_year" value="<?php echo $student['third_mbbs_year']; ?>" />
                              </div>
                          </td>
                  ...
                  <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_scored2" class="form-control" name="third_mbbs_scored2" value="<?php echo $student['third_mbbs_scored2']; ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_max2" class="form-control" name="third_mbbs_max2" value="<?php echo $student['third_mbbs_max2']; ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_per2"class="form-control" name="third_mbbs_per2" value="<?php echo $student['third_mbbs_per2']; ?>" />
                              </div>
                          </td>
                          <td>
                              <div class="form-group">
                                  <input type="text" id="third_mbbs_year2"class="form-control" name="third_mbbs_year2" value="<?php echo $student['third_mbbs_year2']; ?>" />
                              </div>
                          </td>
              ...
              <tr>
                  ...
                  <td>
                      <div class="form-group">
                          <input type="text" id="med_total" class="form-control" name="med_total_scored" value="<?php echo $student['med_total_scored']; ?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="med_total" class="form-control" name="med_total_max" value="<?php echo $student['med_total_max']; ?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="med_total" class="form-control eng-percentage" name="med_total_per" value="<?php echo $student['med_total_per']; ?>" />
                      </div>
                  </td>
                  <td>
                      <div class="form-group">
                          <input type="text" id="med_total" class="form-control eng-percentage" name="med_total_year" value="<?php echo $student['med_total_year']; ?>" />
                      </div>
                  </td>
                                ...
                                <div class="around10">  
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">
                                                                <?php echo $this->lang->line('kuhs_reg'); ?>
                                                            </label>
                                                            <input id="kuhs_reg" name="kuhs_reg" placeholder="" type="text" class="form-control"  value="<?php echo set_value('kuhs_reg',$student['kuhs_reg_no']); ?>" />
                                         ...
                                         <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="course_completion" name="course_completion" placeholder="" type="date" class="form-control"  value="<?php echo set_value('kuhs'); ?>" />
                                                            <span class="text-danger"><?php //echo form_error('kuhs_reg'); ?></span>
                                                        </div>
                                                    </div>
                                                      ...
                                                      <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="annual_income" name="annual_income" placeholder="" type="text" class="form-control"  value="<?php echo set_value('annual_income',$student['annual_income']); ?>" />
                                       ...
                                       <div class="col-md-4">
                                                    ...
                                                    <?php if(!empty($sch)) foreach($sch as $scholar) { ?>
                                                     <option <?php if($scholar['id']==$student['scholarship']) { echo 'selected=selected';} ?>value="<?php echo $scholar['id'] ?>" ><?php echo $scholar['name']?></option>
                                                    <?php  }?>
