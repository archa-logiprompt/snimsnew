...
class Enquiry extends Admin_Controller {
    ...
    public function index() {
        ...
        $data["status"] = "";
         ...
         $this->form_validation->set_rules('enquiry_date', 'Date', 'trim|required|xss_clean');
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('contact', 'Contact', 'trim|required|numeric|max_length[10]|min_length[10]');
...
//print_r($data);
    ...
    function follow_up_insert() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $c=$this->session->userdata('addmin');
