                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right"> 
                                                                ...
                                                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs" data-invoiceno="<?php echo $fee_value->student_fees_deposite_id . "/" . $fee_deposits_value->inv_no; ?>" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>" data-type="<?php echo $fee_value->type ?>" data-studentname="<?php echo $student['firstname'].' '.$student['lastname'] ?>"    data-toggle="modal" data-target="#confirm-delete" title="<?php echo 'Reverts' ?>">
                ...
                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($examount->date)); ?>
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right"> 
                                                                    ...
                                                                    <button class="btn btn-default btn-xs"  data-id="<?php echo $ex_fee->id ?>"  data-invo="<?php echo $examount->invo;  ?>" data-toggle="modal" data-target="#fee_ex_delete" title="<?php echo $this->lang->line('revert'); ?>">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
                ...
                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($admount->date)); ?>
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right"> 
                                                                ...
                                                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs"  data-id="<?php echo $fee_ad->id ?>" data-invo="<?php echo $admount->invo ?>"  data-toggle="modal" data-target="#fee_ad_delete" title="<?php echo $this->lang->line('revert'); ?>">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
                   ...
                   <div class="box box-info" style="padding:5px;">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                               <?php   if(isset($billdetail)) foreach($billdetail as $key=>$val) {
                      ...
                      <input type="hidden" class="form-control" id="group" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="number" autofocus="" class="form-control modal_amount amountcheck" id="amount" value="0" min="0"  >
                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="number" class="form-control amountcheck" id="amount_discount" value="0">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="number" class="form-control amountcheck" id="amount_fine" value="0">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('mode'); ?><small class="req">*</small></label>
                            <div class="col-sm-9">
           ...
           <input type="hidden" class="form-control" id="stud_name" value="<?php echo $stvalue["firstname"] . " " . $stvalue["lastname"]; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="number" autofocus="" class="form-control modal_amount amountcheck" id="ad_amount" name="ad_amount" value=""  min='0' >
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="number" autofocus="" class="form-control modal_amount amountcheck" id="ex_amount" name="ex_amount" value="" min='0'  >
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        // Set the "Cash" option as the default checked option
        document.querySelector('input[name="payment_mode_fee"][value="Cash"]').checked = true;
    });
</script>
    ...
    $(document).ready(function () {
        ...
        $('#confirm-delete').on('click', '.btn-ok', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'main_invoice': main_invoice, 'sub_invoice': sub_invoice,'studentname':studentname,'type':cancelledtype},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    location.reload(true);
                }
            ...
            success: function (data) {
				...
				var weeks=Math.round(days/7);		
					...
					if(obj.finetype=='Monthly')
					 ...
					 t_feetype +="<option data-fine="+fixed_fine+" data-amount="+obj.amount+" data-master_id="+obj.id+" value="+obj.fee_groups_feetype_id+ "> "+obj.type+" ["+obj.amount+"]</option>";	
					}
					else 
					{
					...
					discount=Number(discount)+Number(t.amount_discount); 
					 ...
					 if(balance_amount!==0)
					 {
						...
						t_feetype +="<option data-fine="+datafine+" data-master_id="+obj.id+" data-amount="+balance_amount+" value="+obj.fee_groups_feetype_id+ " > "+obj.type+ " ["+ balance_amount +" ]</option>";	
						}
...
<script type="text/javascript">
	 ...
	 $(document).on('click', '.btn_feeadvance', function (e) {
		  ...
		  var stud_name=$('#stud_name').val();
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'ad_amount': ad_amount, 'ad_date': ad_date,'ad_note':ad_note,'payment_mode_fee':payment_mode,'student_id':student_id,'stud_name':stud_name},
                success: function (data) {
	...
	$(document).on('click', '.btn_feeexcess', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'ex_amount': ex_amount, 'ex_date': ex_date,'ex_note':ex_note,'payment_mode_fee':payment_mode,'student_id':student_id,'stud_name':stud_name},
		...
		$(document).on('click', '.btn_fee_ad', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'id': fee_ad_id,'invoice':adv_inv},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    location.reload(true);
                }
		 ...
		 $(document).on('click', '.btn_fee_ex', function (e) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {'id': fee_ex_id,'invoice':ex_invo},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    location.reload(true);
                }
