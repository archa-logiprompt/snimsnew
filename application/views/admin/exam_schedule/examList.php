                            ...
                            <div class="row">
                               ...
                               <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <option <?php if($sub_type=='Theory') { echo 'selected';} ?> value="Theory">Theory</option>
                                 ...
                                 if($centre_id==1){
                                 ?>
                                 <option <?php if($sub_type=='Cocurricular') { echo 'selected';} ?> value="Cocurricular">Cocurricular</option>            
                                 <?php } ?>
                                        </select>
                                    ...
                                    if (empty($examSchedule)) {
                                        ...
                                        foreach ($examSchedule as $exam) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="pull-right">
                                                <a href="<?php echo base_url(); ?>admin/examschedule/deleted/<?php echo $exam['id'] ?>/<?php echo $exam['exam_id']?>/<?php echo $sub_type ?>"class="btn btn-primary btn-sm" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                            Delete
                                                        </a>
                                                
                                                    <a  class="btn btn-primary btn-sm schedule_modal" data-toggle="tooltip" title="" data-examname="<?php echo $exam['name']; ?>" data-examid="<?php echo $exam['exam_id']; ?>" data-subject_code="<?php echo $exam['code']?>" data-original-title="<?php echo $this->lang->line('view_detail'); ?>" data-sectionid='<?php echo $section_id ?>' data-classid='<?php echo $class_id ?>' data-classname="<?php echo $exam['class_name'] ?>"  data-sectionname="<?php echo $exam['section_name'] ?>">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.schedule_modal', function () {
        ...
        $.ajax({
            ...
            data: {'exam_id': exam_id, 'section_id': section_id, 'class_id': class_id,'sub_type':sub_type},
            dataType: "json",
            success: function (response) {
                ...
                $.each(response, function (i, obj)
                {
                    ...
                    data += '<td class="text text-center">' +  obj.staffname + ' ' +obj.surname +'</td>';
