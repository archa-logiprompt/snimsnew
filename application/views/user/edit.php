        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("user/user/studentedit/".$id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">                    
                        <div class="box-body">
    ...
    $(document).ready(function () {
        ...
        function getSectionByClass(class_id, section_id, select_control) {
            ...
            if (class_id != "") {
                ...
                $.ajax({
                    type: "GET",
                    url: base_url + "user/getByClassedit",
