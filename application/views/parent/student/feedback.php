<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            ...
            <button class="btn btn-info pull-right btn-sm" id="englishbtn" type="button" style="display:none">English</button>
            <button class="btn btn-info pull-right btn-sm" id="malayalambtn" type="button" style="display:block">Malayalam</button> </h1>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">               
                <div class="box box-primary" id="malayalam" style="display:none" >
                ...
                <div class="box box-primary" id="english" style="display:block">
                   <form method="post" action="" name="feedform"> 
                    <div class="box-body box-profile">
                         <h3 class="profile-username text-center"><?php echo $student['firstname'] . " " . $student['lastname']; ?></h3>
                        <ul class="list-group list-group-unbordered">
