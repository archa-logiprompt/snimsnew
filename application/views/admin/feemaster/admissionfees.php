                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                <?php echo "Add Admission fees" . " : " . $this->setting_model->getCurrentSessionName(); ?>
                            </h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/feemaster/admission_fees_master"
                            id="feemasterform" name="feemasterform" method="post" accept-charset="utf-8">
                            <div class="box-body">
...
-->
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('fees_group'); ?></label>
                                            ...
                                            <select autofocus="" id="fee_groups_id" name="fee_groups_id"
                                                ...
                                                foreach ($admissionquotalist as $feegroup) {
                                                    ...
                                                    <option value="<?php echo $feegroup['id'] ?>" <?php
                                                       ...
                                                       ?>><?php echo $feegroup['name'] . ' [ ' . $feegroup['year'] . ' ] '; ?>
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('fees_type'); ?></label><small
                                                class="req"> *</small>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('due_date'); ?></label>
                                            <input id="due_date" name="due_date" placeholder="" type="text"
                                                class="form-control" value="<?php echo set_value('due_date'); ?>"
                                                readonly="readonly" />
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('amount'); ?></label><small
                                                class="req"> *</small>
                                        ...
                                        <div id="fineid" hidden>
                                            <div class="form-group" id="finetype">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('fine_type'); ?></label><small
                                                    class="req"> *</small>
                                            ...
                                            <div class="form-group" id="amounttype">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('amount_type'); ?></label><small
                                                    class="req"> *</small>
                                            ...
                                            <div class="form-group" id="fixamount" hidden>
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('fixed_amount'); ?></label><small
                                                    class="req"> *</small>
                                                <input id="fixedamount" name="fixedamount" placeholder="" type="text"
                                                    class="form-control" value="<?php echo set_value('fixed_amount'); ?>" />
                                                <span class="text-danger"><?php echo form_error('fixed_amount'); ?></span>
                                            </div>

                                            <div class="form-group" id="percent" hidden>
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('percentage'); ?></label><small
                                                    class="req"> *</small>
                                                <input id="percentage" name="percentage" placeholder="" type="text"
                                                    class="form-control" value="<?php echo set_value('percentage'); ?>" />
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">
                            <?php echo "Admission Fees List" . " : " . $this->setting_model->getCurrentSessionName(); ?>
                        </h3>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td class="mailbox-date pull-right">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('fees_master', 'can_delete')) { ?>
                                                    <a href="<?php echo base_url(); ?>admin/feemaster/deleteadmissionfees/<?php echo $feegroup['aid'] ?>"
                                                        class="btn btn-default btn-xs" data-toggle="tooltip"
                                                        title="<?php echo $this->lang->line('delete'); ?>"
                                                        onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                        <i class="fa fa-remove"></i>
