...
<script src="https://cdn.jsdelivr.net/gh/djibe/clockpicker@6d385d49ed6cc7f58a0b23db3477f236e4c1cd3e/dist/bootstrap4-clockpicker.min.js"> </script>
        ...
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('minutes', 'can_add')) {
               ...
               <h3 class="box-title"><?php echo $this->lang->line('minutes'); ?></h3>
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/minutes"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="min_title" name="min_title" type="text" class="form-control"  value="<?php echo set_value('min_title'); ?>" />
 ...
 <textarea id="report" name="report" class="form-control compose-textarea">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input autofocus="" id="meeting_adjourned" name="meeting_adjourned" type="text" class="form-control clockpicker" readonly="readonly" value="<?php echo set_value('year'); ?>" />
