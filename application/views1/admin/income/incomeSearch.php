                                       ...
                                       <td style="text-align:center"><?php echo $income['amount']  ?> </td>
                                           ...
                                           <td style="text-align:center"> </td>
                                              ...
                                              <tr class="box box-solid total-bg">
                                                ...
                                                <td  class="text text-right"></td>
                                                <td  class="text text-right"></td>
                                                <td  class="text text-right"> <?php echo ($currency_symbol . number_format($total_collection, 2, '.', '')); ?> </td></tr>
                                              ...
                                              <tr  style="border-bottom: 1px solid;">
                                                ...
                                                <td  class="text text-right"></td>
                                                <td  class="text text-right"></td>
                                                <td  class="text text-right" style="color: #e80a0a;"><?php echo ($currency_symbol . number_format($total_collection, 2, '.', '')); ?>  </td></tr>
