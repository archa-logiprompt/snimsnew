        ...
        <div class="col-md-12">
            <section class="content-header">
                <h1>
                    ...
                    <?php echo $this->lang->line('fees_collection'); ?><small><?php echo $this->lang->line('student_fee'); ?></small>
                </h1>
            </section>
        </div>
        <div>
                                    ...
                                    if ($stvalue['section_id'] == $snvalue["section_id"]) {
                                        ...
                                        <div class="studentname">
                                            <a class="" href="<?php echo base_url() . "studentfee/addfee/" . $stvalue["id"] ?>">
                                                <div class="icon"><img src="<?php echo base_url() . $stvalue["image"]; ?>"
                                                        alt="User Image"></div>
                                                <div class="student-tittle">
                                                    <?php echo $stvalue["firstname"] . " " . $stvalue["lastname"] . " (" . $stvalue["admission_no"] . ")"; ?>
                                                </div>
                                            </a>
                                        </div>
                                        <?php
                    ...
                    <div class="box-body" style="padding-top:0;">
                                            ...
                                            <table class="table table-striped mb0 font13">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th class="bozero">
                                                            <?php echo $this->lang->line('class_section'); ?></th>
                                                        <td class="bozero">
                        ...
                        <div class="row no-print">
                            <div class="col-md-2 mDMb10">
                                <a href="#" class="btn btn-xs btn-info printSelected"><i class="fa fa-print"></i>
                                    <?php echo $this->lang->line('print_selected'); ?> </a>
                                <span class="pull-right"><?php echo $this->lang->line('date'); ?>:
                                    <?php echo date($this->customlib->getSchoolDateFormat()); ?></span>
                            </div>

                            <div class="col-md-2 mDMb10">
                                <a data-toggle="modal" data-target="#fee_advance" href="#"
                                    class="btn btn-xs btn-info fee_advance ">
                                    <?php echo $this->lang->line('fee_advance'); ?> </a>
                            </div>

                            <div class="col-md-2 mDMb10">
                                <a data-toggle="modal" data-target="#fee_excess" href="#"
                                    class="btn btn-xs btn-info fee_excess ">
                                    <?php echo $this->lang->line('fee_excess'); ?> </a>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                ...
                                <tbody>
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right">
                                                        <button type="button"
                                                            ...
                                                            data-fine="<?php echo (number_format($fixed_fine, 0, '.', '')); ?>"
                                                            ...
                                                            data-toggle="modal" data-target="#myFeesModal"><i
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-right">
                                                            <div class="btn-group pull-right">
                                                                ...
                                                                <?php
                                                                $fee_detail = json_decode($fee_value->amount_detail, true);
                                                                if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                    <button class="btn btn-default btn-xs"
                                                                        ...
                                                                        data-type="<?php echo $fee_value->type ?>"
                                                                        data-studentname="<?php echo $student['firstname'] . ' ' . $student['lastname'] ?>"
                                                                        data-studentid="<?php echo $student['id'] ?>"
                                                                        data-paymode="<?php echo $fee_deposits_value->payment_mode ?>"
                                                                        data-amount="<?php echo $total_fee_paid ?>"
                                                                        data-toggle="modal" data-target="#confirm-delete"
                                                                        title="<?php echo 'Reverts' ?>">
                                                                ...
                                                                <?php }
                                                                 ...
                                                                 $is_refund = false;
                                                                 if (!empty($fee_value->refund_detail)) { 
                                                                    ...
                                                                    $refund_total = 0;
                                                                    foreach ($r_amount as $key => $value) {
                                                                        $refund_total += $value->amount; 
                                                                    }

                                                                    $balance_in_refund = $refund_total-$total_fee_paid; 
                                                                 

                                                                    // echo $bal_refund_amount;
                                                                    foreach ($r_amount as $key => $value) {
                                                                        $bal_refund_amount += $total_refund - $value->amount; 
                                                                    }  
                                                                                     
                                                                    $is_refund=true;
                                                                } else {
                                                                    $is_refund=false;
                                                                    $bal_refund_amount = $total_fee_paid;
                
                                                                } 
                                                                if($balance_in_refund!=0 || !$is_refund){
                                                                ...
                                                                <button class="btn btn-xs btn-default printDoc"
                                                                    ...
                                                                    title="<?php echo $this->lang->line('print'); ?>"><i
                                                                        class="fa fa-print"></i> </button>
                                                                        <?php if($bal_refund_amount!=0) {?>
                                                                        <button class="btn btn-default btn-xs"
                                                                data-total_refund_amount="<?php echo $bal_refund_amount ?>"
                                                                data-fine="<?php echo $fine ?>"
                                                                data-refunded_amount="<?php echo $r_amount->amount; ?>"
                                                                data-fee_master_id="<?php echo $fee_value->id ?>"
                                                                data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id ?>"
                                                                data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id ?>"
                                                                data-toggle="modal" data-target="#confirm-refund"
                                                                title="<?php echo $this->lang->line('refund'); ?>">
                                    ...
                                    foreach ($student_due_fee['hostel_fee'] as $key => $fee) {
                                        foreach ($fee->fees as $fee_key => $fee_value) {
...
<tr class="box box-solid total-bg">
                                        ...
                                        <td class="text text-right">
                                            ...
                                            <div class="btn-group pull-right">
                                                <button type="button"
                                                    data-student_session_id="<?php echo $fee->student_session_id; ?>"
                                                    data-student_fees_master_id="<?php echo $stud_feemaster; ?>"
                                                    data-headwise_fine="<?php echo $headwise_fine ?>"
                                                    data-fee_groups_feetype_id="<?php echo $feetype ?>"
                                                    data-student_id="<?php echo $fee_value->student_id ?>"
                                                    data-balance_amount="<?php echo $feetbalanceamount ?>"
                                                    data-group="Total Fee"
                                                    class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>"
                                                    title="<?php echo $this->lang->line('add_fees'); ?>"
                                                    data-toggle="modal" data-target="#myFeesModal2">
                                    ...
                                    foreach ($fee_excess as $ex_fee) {
                                        ...
                                        foreach ($ex_amount as $examount) {
                                            ...
                                            <tr class="white-td">
                                                <td align="left"><input class="checkbox" type="checkbox" name="fee_checkbox">
                                                </td>
                                                <td align="left"></td>
                                                ...
                                                <td class="text text-right"></td>
                                                <td class="text text-right"><?php echo (number_format($examount->amount, 0, '.', ''));
                                                ...
                                                <td class="text text-right">
                                                    <div class="btn-group pull-right">
                                                <?php if ($excess_balance >= $examount->amount) { ?>

                                                            <button class="btn btn-default btn-xs"
                                                                data-id="<?php echo $ex_fee->id ?>"
                                                                data-invo="<?php echo $examount->invo; ?>" data-toggle="modal"
                                                                data-target="#fee_ex_delete"
                                                                data-ex-amount="<?php echo $examount->amount ?>"
        ...
        <?php } ?>
                                    ...
                                    foreach ($fee_advance as $fee_ad) {
                                        ...
                                        foreach ($ad_amount as $admount) {
                                            ...
                                            <tr class="white-td">
                                                ...
                                                <td class="text text-right"></td>
                                                <td class="text text-right"></td>
                                                <td class="text text-right"><?php echo (number_format($admount->amount, 0, '.', ''));
                                                ...
                                                <td class="text text-right">
                                                    ...
                                                    if ($advance_balance >= $admount->amount) { ?>
                                                
                                                
                                                            <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                                                <button class="btn btn-default btn-xs"
                                                                    data-id="<?php echo $fee_ad->id ?>"
                                                                    data-invo="<?php echo $admount->invo ?>" data-toggle="modal"
                                                                    data-target="#fee_ad_delete"
                                                                    data-amount="<?php echo $admount->amount ?>"
                                                                    data-studentname="<?php echo $student['firstname'] . ' ' . $student['lastname'] ?>" 
                                                                    data-admissionno="<?php echo $student['admission_no'] ?>"  
                                                                    title="<?php echo $this->lang->line('revert'); ?>">
                                                                    <i class="fa fa-undo"> </i>
                                                                </button>
                ...
                <?php if (!empty($billdetail) || !empty($refunddata)) { ?>
                                    ...
                                    <?php if (isset($billdetail)){
                                        ...
                                        foreach ($billdetail as $key => $val) {
                                            ...
                                            if (is_array($val['type'])) {
                                                ...
                                                foreach ($val['type'] as $t_key => $t) {

                                                    array_push($feetype, $t);

                                                }
                                                $type = implode('/', $feetype);
                                            } else {
                                                $type = $val['type'];
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="#" data-billamount="<?php echo $val['amount'] ?>"  data-rectype='Collection'
                                                        data-type="<?php echo $type ?>" data-billdate="<?php echo $val['date'] ?>"
                                                        data-mode="<?php echo $val['mode'] ?>" data-billno="<?php echo $key ?>" 
                                                      
                                                        class="btn btn-xs btn-info print_billwise"><i class="fa fa-print"></i>
                                                        <?php echo $this->lang->line('print'); ?> </a> </td>
                                    ...
                                    <?php if (isset($refunddata)){
                                        foreach ($refunddata as $key => $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $val['is_refund']==1?'Refunded':'Reverted'; ?></td>
                                                <td> <a href="#" data-billamount="<?php echo $val['amount'] ?>"  data-rectype='<?php echo $val['is_refund']==1?'Refund':'Revert'; ?>'
                                                         data-billdate="<?php echo $val['date'] ?>"
                                                        data-mode="<?php echo $val['mode'] ?>" data-billno="<?php echo $key ?>"  data-reverted_by="<?php echo $val['reverted_by'] ?>"
                                                        data-refundtype="<?php echo $val['type'] ?>"
                                                        class="btn btn-xs btn-info print_billwise"><i class="fa fa-print"></i>
                                                        <?php echo $this->lang->line('print'); ?> </a> </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" class="form-control" id="student_id" value="<?php echo $student['id'] ?>" />
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('amount'); ?> </label><small
                                class="req"> *</small>
                            <div class="col-sm-9">

                                <input type="number" autofocus="" class="form-control modal_amount amountcheck"
                                    id="amount" value="0" min="0">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                ...
                                <?php echo $this->lang->line('group'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group mb0">
                            <label for="inputPassword3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('discount'); ?><small
                                    class="req">*</small></label>
                            <div class="col-sm-9">

                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="number" class="form-control amountcheck" id="amount_discount"
                                            value="0">
                                ...
                                <div class="col-md-2 col-sm-2 ltextright">
                                    ...
                                    <label for="inputPassword3"
                                        class="row control-label"><?php echo $this->lang->line('fine'); ?><small
                                            class="req">*</small></label>
                                </div>
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="number" class="form-control amountcheck" id="amount_fine"
                                            value="0">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                ...
                                <?php echo $this->lang->line('mode'); ?><small class="req">*</small></label>
                            <div class="col-sm-8">
                                <form>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" value="Cash" class="cash-radio"
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee"
                                            value="Bank"><?php echo $this->lang->line('bank'); ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee"
                        ...
                        <div class="form-group"  id="excess_balance_div" >
                            <label for="inputPassword3"
                                class="col-sm-3 control-label">Excess Balance</label>

                            <div class="col-sm-9">
                                <input class="form-control" type="text" value="<?php echo $excess_balance ?>" readonly></input>
                            </div>
                        </div>
                        <div class="form-group"  id="advance_balance_div" >
                            <label for="inputPassword3"
                                class="col-sm-3 control-label">Advance Balance</label>

                            <div class="col-sm-9">
                                <input class="form-control" type="text" value="<?php echo $advance_balance ?>" readonly></input>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="box-body">
                    ...
                    <button type="button" class="btn cfees save_button" id="load"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="cancelledtype" id="cancelledtype" value="">
                <input type="hidden" name="cancelledamount" id="cancelledamount" value="">
                <input type="hidden" name="studentid" id="student_id" value="">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                    data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <a class="btn btn-danger btn-ok" data-studentname="<?php echo $student['firstname'].' '.$student['lastname'] ?>" data-admissionno="<?php echo $student['admission_no'] ?>"><?php echo $this->lang->line('revert'); ?></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" class="form-control" id="re_student_fees_master_id" value="0"
                            readonly="readonly" />
                        <input type="hidden" class="form-control" id="re_fee_groups_feetype_id" value="0"
                            readonly="readonly" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" autofocus="" class="form-control modal_amount" id="refund_amount"
                                value="0">
                                <input type="hidden" autofocus="" class="form-control modal_amount" id="refund_amount_hidden"
                                value="0">
                        ...
                        <div class="form-group">
                            <form>
                                <label for="inputPassword3"
                                    class="col-sm-3 control-label"><?php echo $this->lang->line('payment'); ?>
                                    <?php echo $this->lang->line('mode'); ?></label>
                                <div class="col-sm-9">
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" value="Cash" class="cash-radio"
                                            checked="checked"><?php echo $this->lang->line('cash'); ?>
            ...
            <div class="modal-footer">
                <div class="box-body">
                    <button type="button" class="btn btn-default pull-left"
                        data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                    <button data-studentname="<?php echo $student['firstname'].' '.$student['lastname'] ?>" data-admissionno="<?php echo $student['admission_no'] ?>" type="button" class="btn cfees btn-refund" id="load"
                        data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                        <?php echo $currency_symbol; ?> <?php echo $this->lang->line('refund'); ?> </button>
                </div>
            </div>
    ...
    <div class="modal-dialog">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body" id="m_boxbody">
                        ...
                        <input type="hidden" class="form-control" id="guardian_email"
                            value="<?php echo $student['guardian_email'] ?>" readonly="readonly" />
                        <input type="hidden" class="form-control" id="student_fees_master_id1" value="0"
                            readonly="readonly" />

                        <input type="hidden" class="form-control" id="fee_groups_feetype_id1" value=""
                            readonly="readonly" />
                        <input type="hidden" class="form-control" id="totalbalance_amount" value="0"
                            readonly="readonly" />
                        ...
                        <div class="form-group">
                            <label for="inputEmail3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('date'); ?></label>
                            <div class="col-sm-9">
                                <input id="t_date" name="admission_date" placeholder="" type="text"
                                    class="form-control date"
                                    value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>"
                                    readonly="readonly" />
                            </div>
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('fee_type'); ?></label><small
                                class="req"> *</small>
                            <div class="col-sm-9" id="selectmulti">
                                <select multiple="multiple" name="t_fee_groups_feetype_id"
                                    class="form-control t_fee_type selectpicker" id="t_fee_type">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                        ...
                        <div id="show_feetype">
                            <div class="form-group">
                                <label for="inputPassword3"
                                    class="col-sm-3 control-label"><?php echo $this->lang->line('fees_type'); ?>
                                </label><small class="req"> *</small>
                                <div class="col-sm-9">
                                    <select title="Select fee type to apply discount group " name=" dis_fee_type_id "
                                        class="form-control modal_discount_group required" id="dis_fee_type_id">
                                        ...
                                        <?php foreach ($student_due_fee as $key => $fee) {
                                            foreach ($fee->fees as $fee_key => $fee_value) {
                                                ...
                                                <option value="<?php echo $fee_value->fee_groups_feetype_id ?>">
                                                    <?php echo $fee_value->type ?> </option> <?php }
                                        } ?>
                                    </select>
                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="fixed"
                                            value="<?php  //echo (number_format($total_fine_amount, 0, '.', '')); ?>0.00">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3"
                            class="col-sm-3 control-label"><?php echo $this->lang->line('note'); ?>
                        </label>

                        <div class="col-sm-9">
                            <textarea class="form-control" rows="3" id="alldescription" placeholder=""></textarea>
                        </div>
        ...
        <div class="modal-footer">
            <div class="box-body">
                <button type="button" class="btn btn-default pull-left"
                    data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <button type="button" class="btn cfees save_button2" id="load"
                    data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                    <?php echo $currency_symbol; ?> <?php echo $this->lang->line('collect_fees'); ?> </button>
            </div>
        </div>
    ...
    <div class="modal-dialog">
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" class="form-control" name="student_id" id="student_id"
                            value=" <?php echo $student['id'] ?>" readonly="readonly" />
                        <input type="hidden" class="form-control" id="stud_name"
                            value="<?php echo $stvalue["firstname"] . " " . $stvalue["lastname"]; ?>" />
                        <div class="form-group">
                            <label for="inputEmail3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('date'); ?></label>
                            <div class="col-sm-9">
                                <input id="ad_date" name="ad_date" placeholder="" type="text" class="form-control date"
                                    value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>"
                                    readonly="readonly" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="number" autofocus="" class="form-control modal_amount amountcheck"
                                    id="ad_amount" name="ad_amount" value="" min='0'>

                                <span class="text-danger" id="amountadvance_error"></span>
                            </div>
                        </div>
                       ...
                       -->
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" value="Cash" id='advance'
                                            class="cash-radio"
                                            checked="checked"><?php echo $this->lang->line('cash'); ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" id='advance'
                                            value="Cheque"><?php echo $this->lang->line('cheque'); ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" id='advance'
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="3" id="ad_note" name="ad_note"
        ...
        <div class="modal-footer">
            <div class="box-body">
                <button type="button" class="btn btn-default pull-left"
                    data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <button type="submit" class="btn cfees btn_feeadvance" id="load"
                    data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                    <?php echo $currency_symbol; ?> <?php echo $this->lang->line('collect_fees'); ?> </button>
            </div>
        </div>
...
<div class="modal fade" id="fee_excess" role="dialog">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('date'); ?></label>
                            <div class="col-sm-9">
                                <input id="ex_date" name="ex_date" placeholder="" type="text" class="form-control date"
                                    value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>"
                                    readonly="readonly" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="number" autofocus="" class="form-control modal_amount amountcheck"
                                    id="ex_amount" name="ex_amount" value="" min='0'>

                                <span class="text-danger" id="amountexcess_error"></span>
                            </div>
                        </div>
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" id='excess' value="Cash"
                                            class="cash-radio"
                                            checked="checked"><?php echo $this->lang->line('cash'); ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" id='excess'
                                            value="Cheque"><?php echo $this->lang->line('cheque'); ?>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="payment_mode_fee" id='excess'
    ...
    <div class="modal-footer">
        <div class="box-body">
            <button type="button" class="btn btn-default pull-left"
                data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
            <button type="submit" class="btn cfees btn_feeexcess" id="load"
                data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">
                <?php echo $currency_symbol; ?> <?php echo $this->lang->line('collect_fees'); ?> </button>
        </div>
    </div>
...
<div class="delmodal modal fade" id="fee_ad_delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="adv_invo" id="adv_invo" value="">
                <input type="hidden" name="student_id" id="student_id" value="<?php echo $student['id'] ?>">
                <input type="hidden" name="admission_no" id="admission_no" value="<?php echo $student['admission_no'] ?>">
                <input type="hidden" name="student_name" id="student_name" value="<?php echo $student['firstname'].' '.$student['lastname'] ?>">
                <input type="hidden" name="ad_amount" id="advance_revert_amount" value="">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                    data-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                <a class="btn btn-danger btn_fee_ad" data-studentname="<?php echo $student['firstname'].$student['lastname'] ?>" ><?php echo $this->lang->line('revert'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="delmodal modal fade" id="fee_ex_delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="ex_invo" id="ex_invo" value="">
                <input type="hidden" name="student_id" id="student_id" value="<?php echo $student['id'] ?>">
                <input type="hidden" name="ex_amount" id="excess_revert_amount" value="">
                <input type="hidden" name="admission_no" id="admission_no_ex" value="<?php echo $student['admission_no'] ?>">
                <input type="hidden" name="student_name" id="student_name_ex" value="<?php echo $student['firstname'].' '.$student['lastname'] ?>">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.print_billwise', function() {
        ...
        var course = '<?php echo $student['class'] . " (" . $student['section'] . ")" ?> ';
        var feetype = $(this).data('type');
        var mode = $(this).data('mode'); 
        var rectype = $(this).data('rectype'); 
        var refundtype = $(this).data('refundtype'); 
        var reverted_by = $(this).data('reverted_by');  
        var admin_no = '<?php echo $student['admission_no']; ?>';
...
$(document).on('click', '.save_button2', function(e) {
    ...
    var description = $('#alldescription').val();
    var guardian_phone = $('#guardian_phone').val();
    var guardian_email = $('#guardian_email').val();
    ...
    $.ajax({
        ...
        data: {
            ...
            'amount_discount': amount_discount,
            'amount_fine': amount_fine,
            'dis_fee_type_id': dis_fee_type_id,
            'description': description,
            'student_fees_master_id': student_fees_master_id,
            'fee_groups_feetype_id': feegroupnew,
            'payment_mode': payment_mode,
            'guardian_phone': guardian_phone,
            'guardian_email': guardian_email,
            'student_fees_discount_id': student_fees_discount_id,
...
$(document).ready(function() {
    ...
    $('#confirm-delete').on('show.bs.modal', function(e) {
        ...
        $('#studentname', this).val($(e.relatedTarget).data('studentname'));
        $('#student_id', this).val($(e.relatedTarget).data('studentid'));
        $('#paymode', this).val($(e.relatedTarget).data('paymode'));
        $('#cancelledtype', this).val($(e.relatedTarget).data('type'));
        $('#cancelledamount', this).val($(e.relatedTarget).data('amount'));
    ...
    $('#confirm-refund').on('show.bs.modal', function(e) {
        ...
        $('#refund_amount_hidden', this).val($(e.relatedTarget).data('total_refund_amount'));
    ...
    $('#confirm-refund').on('click', '.btn-refund', function(e) {
        ...
        var refund_amount_hidden = $('#refund_amount_hidden').val(); 

        

        if(Number(refund_amount)>Number(refund_amount_hidden)){
    ...
    $('#confirm-delete').on('click', '.btn-ok', function(e) {
        ...
        var cancelledtype = $('#cancelledtype').val();
        var student_id = $('#student_id').val();
        var amount = $('#cancelledamount').val();
    ...
    /* $(document).on('click', '.btn-ok', function (e) {
            ...
            var main_invoice = $('#main_invoice').val();
            var sub_invoice = $('#sub_invoice').val();
            var studentfeemaster=$('#studentfeemaster').val();
            var feegroupfeetype=$('#feegroupfeetype').val();
            var amount = $('#amount').val();
            alert(amount);
            $modalDiv.addClass('modalloading');
            $.ajax({
                ...
                url: '<?php echo site_url("studentfee/deleteFee") ?>',
                dataType: 'JSON',
                data: {'main_invoice': main_invoice, 'sub_invoice': sub_invoice,'studentfeemaster':studentfeemaster,'feegroupfeetype':feegroupfeetype,'amount':amount},
                success: function (data) {
                    $modalDiv.modal('hide').removeClass('modalloading');
                    //location.reload(true);
                }
        ...
        success: function(data) {
            ...
            if (data.status == "success") {
                ...
                $.each(data.discount_not_applied, function(i, obj) {
                    discount_group_dropdown += "<option value=" + obj
                        .student_fees_discount_id + " data-disamount=" + obj.amount + ">" +
                        obj.code + "</option>";
                });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status == "success") {
                ...
                $.each(data.discount_not_applied, function(i, obj) {
                    discount_group_dropdown += "<option value=" + obj
                        .student_fees_discount_id + " data-disamount2=" + obj.amount + ">" +
                        obj.code + "</option>";
                });
                ...
                $.each(data.t_fee_type, function(i, obj)

                    {
                        var fixed_fine = 0;
                        var d = new Date();
                        var current_date = d.getFullYear() + '-' + (d.getMonth() + 1) + '-' + d
                            .getDate();
                        ...
                        if (obj.finetype == 'Monthly') {
                            ...
                            while (i < months) {
                                if (obj.amounttype == 'Fixed Amount') {
                                    ...
                                    var per = (Number(obj.percentage) / 100) * Number(obj
                                        .amount);
                                    fixed_fine = Number(fixed_fine) + Number(per);
                        ...
                        if (obj.amount_detail == 0) {
                            ...
                            t_feetype += "<option data-fine=" + fixed_fine + " data-amount=" +
                                obj.amount + " data-master_id=" + obj.id + " value=" + obj
                                .fee_groups_feetype_id + "> " + obj.type + " [" + obj.amount +
                                "]</option>";
                        } else {
                            ...
                            var balance_amount = Number(obj.amount) - (Number(fee_paid) +
                                Number(discount));


                            if (balance_amount !== 0) {

                                t_feetype += "<option data-fine=" + datafine +
                                    " data-master_id=" + obj.id + " data-amount=" +
                                    balance_amount + " value=" + obj.fee_groups_feetype_id +
                                    " > " + obj.type + " [" + balance_amount + " ]</option>";
                            } else {}
...
$("select#t_fee_type").change(function() {
    ...
    $("select#t_fee_type option:selected").each(function() {
        ...
        masterid.push($(this).data("master_id") + " ");
    ...
    $('#fixed_fine').val(fine);
    $('#student_fees_master_id1').val(masterid);
});
...
$('#fee_ad_delete').on('show.bs.modal', function(e) {
    ...
    $('#adv_invo', this).val("");
    $('#adv_invo', this).val("");
    $('#advance_revert_amount', this).val("");

    $('#fee_ad_id', this).val($(e.relatedTarget).data('id'));
    $('#adv_invo', this).val($(e.relatedTarget).data('invo'));
    $('#advance_revert_amount', this).val($(e.relatedTarget).data('amount'));
...
$(document).on('click', '.btn_fee_ad', function(e) {
    ...
    var adv_inv = $('#adv_invo').val();
    var ad_amount = $('#advance_revert_amount').val();
    var student_id = $('#student_id').val();
...
$('#fee_ex_delete').on('show.bs.modal', function(e) {
    $('#fee_ex_id', this).val("");
    $('#ex_invo', this).val("");
    $('#excess_revert_amount', this).val("");
   

    $('#fee_ex_id', this).val($(e.relatedTarget).data('id'));
    $('#ex_invo', this).val($(e.relatedTarget).data('invo'));
    $('#excess_revert_amount', this).val($(e.relatedTarget).data('ex-amount'));
...
$(document).on('click', '.btn_fee_ex', function(e) {
    ...
    var ex_invo = $('#ex_invo').val();
    var excess_revert_amount = $('#excess_revert_amount').val();
    var studentname = $('#student_name_ex').val();
    var admissionno = $('#admission_no_ex').val();
    ...
    $.ajax({
        ...
        data: {
            'id': fee_ex_id,
            'invoice': ex_invo,
            'ex_amount': excess_revert_amount,
            'student_id': student_id,
            'studentname': studentname,
            'admissionno': admissionno
        },
...
$(document).on('keydown', '.amountcheck', function(e) {
    // Prevent 'e' character in input type number
    if (e.key === 'e' || e.key === 'E') {
        e.preventDefault();
    }
    if (e.key === '-') {
