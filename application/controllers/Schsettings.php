...
function set_session()
 {
	 $id=$this->input->post('institution');
	 $setting_result = $this->setting_model->loginget($id);
	 $f_year=$this->setting_model->get_financial_year($id);
	 
	 $this->session->userdata['admin']['financial_year']=$f_year['value'];
	 $this->session->userdata['admin']['centre_id']=$id;
	 $this->session->userdata['admin']['date_format'] = $setting_result['date_format'];
     $this->session->userdata['admin']['currency_symbol'] = $setting_result['currency_symbol'];
     $this->session->userdata['admin']['is_rtl'] = $setting_result['is_rtl'];
     $this->session->userdata['admin']['timezone'] = $setting_result['timezone'];
     $this->session->userdata['admin']['theme'] = $setting_result['theme'];
	 $this->session->userdata['admin']['school_name'] = $setting_result['name'];
	 $this->session->userdata['admin']['language'] = array('lang_id' => $setting_result['lang_id'], 'language' => $setting_result['language']);
	 $this->session->userdata['admin']['sch_name']=$setting_result['name'];
