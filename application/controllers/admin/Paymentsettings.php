...
class Paymentsettings extends Admin_Controller {
    ...
    public function stripe() {
        ...
        $this->form_validation->set_error_delimiters('', '');
        $this->form_validation->set_rules('api_secret_key', 'Secret key', 'trim|required|xss_clean');
        $this->form_validation->set_rules('api_publishable_key', 'Publishable key', 'trim|required|xss_clean');
    ...
    public function payu() {
        ...
        $this->form_validation->set_rules('salt', 'Salt', 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
			$admin=$this->session->userdata('admin');
            $data = array(
			    'centre_id'=>$admin['centre_id'],
    ...
    public function twocheckout() {
        ...
        $this->form_validation->set_rules('api_secret_key', 'Key', 'trim|required|xss_clean');
        $this->form_validation->set_rules('api_publishable_key', 'Salt', 'trim|required|xss_clean');
        if ($this->form_validation->run()) {
			$admin=$this->session->userdata('admin');
            $data = array(
			   'centre_id'=>$admin['centre_id'],
