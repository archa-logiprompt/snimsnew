...
<script src="<?php echo base_url(); ?>backend/dist/js/exceljs/dist/tableToExcel.js"></script>
...
<div class="row">
    <div class="modal fade" id="sessionModal" tabindex="-1" role="dialog" aria-labelledby="sessionModalLabel">
        <form action="<?php echo site_url('schsettings/header_session'); ?>" id="session-fromnew" class="form-horizontal" method="POST">
...
<select autofocus id="sessionjj" name="session" class="form-control" > 
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary submit_session" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait.."><?php echo $this->lang->line('save'); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<script type="text/javascript">
       ...
       $('#sessionnew').keydown(function(e)
        ...
        return false;
            ...
            $(document).on('change', '#sessionnew', function (e) {
                
                 
              $("form#session-fromnew").submit();
