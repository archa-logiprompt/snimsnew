...
<div class="content-wrapper" style="min-height: 946px;">  
                                                ...
                                                foreach ($resultlist as $student) {
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td class="pull-right">
                                                                <a href="#" class="btn btn-default btn-xs open-modal" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" data-student-id="<?php echo $student['id']; ?>">
                                                                        <button class="btn btn-success">Passed Out</button>
                                                                    </a>
                                                                                    ...
                                                                                    <span class="pull-right buttons">
                                                                                        <a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>" class="btn btn-info "  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                                                         ...
                                                                                         if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) {
                                                                                             ?>
                                                                                            <a href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student['id'] ?>" class="btn btn-info" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>" >    
                ...
                ?>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <b><?php echo "Admission No"?>: </b><?php echo $student['admission_no'] ?><br>
                                <b><?php echo "Name"?>: </b><?php echo $student['firstname'] . " " . $student['lastname'] ?><br>
                                <b><?php echo "Class-Section" ?>: </b><?php echo $student['class'] . "(" . $student['section'] . ")" ?><br>
                                <b><?php echo "Gender" ?>: </b><?php echo $student['gender'] ?><br>
                                <b><?php echo "Address" ?>: </b><?php echo $student['current_address'] ?><br>
                                <b><?php echo "Father Name" ?>: </b><?php echo $student['father_name'] ?><br>
                                <b><?php echo "City"?>: </b><?php echo $student['city'] ?><br>
                                <b><?php echo "Date Completion" ?>: </b><?php echo $student['date_completion'] ?><input type="text"></input><br>

                                    <!-- Replace this with your dynamic content based on studentId -->
                                    <!-- <p>Student ID: <span id="studentIdDisplay"></span></p> -->
                                    <!-- Add more details as needed -->

                                    <!-- Example: Display additional information based on studentId -->
    ...
    $(document).ready(function () {
        $('.open-modal').on('click', function () {
            ...
            // You can use studentId to load content dynamically or perform other actions
