                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  if((!empty($student['dob'])) && ($student['dob'] != null) ){ echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['dob'])); } ?></td>
                                                        ...
                                                        <div class="col-xs-6 col-md-6">
                                                            <address>
                                                                ...
                                                                <b><?php echo $this->lang->line('date_of_birth'); ?>:
                                                                    <?php if((!empty($student['dob'])) && ($student['dob'] != null) ){ echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['dob'])); } ?><br>
