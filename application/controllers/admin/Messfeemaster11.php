...
*/
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            $resultlist = $this->studentfeemaster_model->searchAssignMessFeeByClassSection($data['class_id'], $data['section_id'], $date, $data['category_id'], $data['gender'], $data['rte_status']);
