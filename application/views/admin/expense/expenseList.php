                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/expense"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('expenses'); ?> <?php echo $this->lang->line('name'); ?></label> <small class="req">*</small>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('expense_list'); ?></div>
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('expenses'); ?> <?php echo $this->lang->line('name'); ?>
                                        </th>
