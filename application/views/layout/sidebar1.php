                                ...
                                <li class="treeview <?php echo set_Topmenu('front_office'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('device_type', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/devicetype'); ?>"><a href="<?php echo base_url(); ?>admin/devicetype"><i class="fa fa-angle-double-right"></i> <?php echo 'Device Type'; ?></a></li>
                                         ...
                                         if ($this->rbac->hasPrivilege('parts_change', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/partchange'); ?>"><a href="<?php echo base_url(); ?>admin/partchange"><i class="fa fa-angle-double-right"></i> <?php echo 'Parts Change'; ?></a></li>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('parent_feedback', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('student/feedreport'); ?>"><a href="<?php echo base_url(); ?>student/feedreport"><i class="fa fa-angle-double-right"></i> <?php echo 'Parent Feedback'; ?></a></li>
                                        ...
                                        if ($this->rbac->hasPrivilege('update_kuhs', 'can_add')) {
                                            ...
                                            <li class="<?php echo set_Submenu('student/update_kuhs'); ?>"><a href="<?php echo base_url(); ?>student/kuhs"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('update_kuhs'); ?></a></li>
...
?>
                         ...
                         <li class="treeview <?php echo set_Topmenu('minutes'); ?>">
                             ...
                             <ul class="treeview-menu">
                                        ...
                                        <?php if($this->rbac->hasPrivilege('minutes_detail', 'can_view')) { ?>
                                            ...
                                            <li class="<?php echo set_Submenu('minutes/minutes_details'); ?>"><a href="<?php echo base_url(); ?>admin/minutes"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('minutes_detail'); ?></a></li><?php } ?>
                        ...
                        ?>
                         ...
                         <li class="treeview <?php echo set_Topmenu('centre'); ?>">
                             ...
                             <ul class="treeview-menu">
                                ...
                                <li class="<?php echo set_Submenu('centre/centre_detail'); ?>"><a href="<?php echo base_url(); ?>admin/centre"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('centre'); ?>  <?php echo $this->lang->line('details') ?></a></li><?php } ?>
                         ...
                         <li class="treeview <?php echo set_Topmenu('Scholarship'); ?>">
                             ...
                             <ul class="treeview-menu">
                                ...
                                <?php if ($this->rbac->hasPrivilege('apply_scholarship', 'can_view')) { ?>
                                            ...
                                            <li class="<?php echo set_Submenu('scholarship/apply_scholarship'); ?>"><a href="<?php echo base_url(); ?>admin/scholarship/apply_scholarship"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('apply_scholarship'); ?></a></li><?php } ?>               
                                ...
                                <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_view')) { ?>
                                            ...
                                            <li class="<?php echo set_Submenu('transaction/collectionreport'); ?>"><a href="<?php echo base_url(); ?>admin/collectionreport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_collect_rep'); ?></a></li> 
                                            <?php
                                        }
                                        ...
                                        if ($this->rbac->hasPrivilege('fees_carry_forward', 'can_view')) {
										 ...
										 if ($this->rbac->hasPrivilege('virtual_account', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('virtual_account/index'); ?>"><a href="<?php echo base_url(); ?>virtualaccount"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('virtual_account'); ?></a></li>
                                            <?php
                                        }
										
										 if ($this->rbac->hasPrivilege('upload', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('upload'); ?>"><a href="<?php echo base_url(); ?>admin/upload"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees') ?>  <?php echo $this->lang->line('upload'); ?></a></li>
                                            <?php
                                        }
                                        ...
                                        if ($this->rbac->hasPrivilege('file_reader', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('file_reader'); ?>"><a href="<?php echo base_url(); ?>admin/file_reader"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('file_reader'); ?></a></li>
                                            <?php
                                        }
					   ...
					   
					   {
						?>
                         ...
                         <li class="treeview <?php echo set_Topmenu('mess fee'); ?>">
                                    <a href="#">
                                        <i class="fa fa-money"></i> <span><?php echo $this->lang->line('mess_fee'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                             ...
                             <ul class="treeview-menu">
                              ...
                              <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('mess fee/collect fee'); ?>"><a href="<?php echo base_url(); ?>studentmessfee"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('collect_fees'); ?></a></li>
                             
                              
                             <?php } if($this->rbac->hasPrivilege('fees_master', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('mess fee/mess fee master'); ?>"><a href="<?php echo base_url(); ?>admin/messfeemaster"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_master'); ?></a></li><?php } ?>               
                                                          
                             
                             
                              <?php if($this->rbac->hasPrivilege('income', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('mess fee/income'); ?>"><a href="<?php echo base_url(); ?>admin/mess_income"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('income'); ?></a></li><?php } ?> 
                                            
                             

                         <?php if($this->rbac->hasPrivilege('income_head', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('mess fee/mess income head'); ?>"><a href="<?php echo base_url(); ?>admin/mess_income/mess_income_head"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('income_head'); ?></a></li><?php } ?>
                              ...
                              <?php if($this->rbac->hasPrivilege('collection_report', 'can_view')) { ?>
                                            ...
                                            <li class="<?php echo set_Submenu('mess fee/collection report'); ?>"><a href="<?php echo base_url(); ?>admin/collectionreport/mess_collection_report"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('collection_report'); ?></a></li><?php } ?>
                                            
                             
                                  <?php if($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) { ?>

                                            <li class="<?php echo set_Submenu('mess fee/balance fees report'); ?>"><a href="<?php echo base_url(); ?>admin/transaction/balancemessfeereport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('balance_fees_report'); ?></a></li><?php } ?>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Income'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('search_income', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('income/incomesearch'); ?>"><a href="<?php echo base_url(); ?>admin/income/incomesearch"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('collection'); ?> <?php echo $this->lang->line('report'); ?> </a></li>
                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('income_head', 'can_view')) {
                                            ?>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        <?php if ($this->rbac->hasPrivilege('student_attendance', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('stuattendence/index'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence"><i class="fa fa-angle-double-right"></i> <?php echo 'Attendance By Subject'; ?></a></li>
                                            <?php /*?><!--<?php
                                        }
       ...
       <li class="<?php echo set_Submenu('attendenceReportByday/classattendencereport'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classattendencereportbyday" style=" font-size: 9pt !important;"><i class="fa fa-angle-double-right"></i> <?php echo'Attendence Report '?></a></li>                                     
                                            
                                            
                                            
                                            <li class="<?php echo set_Submenu('stuattendence/classattendencereportbyperiod'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classattendencereportbyperiod" style=" font-size: 9pt !important;"><i class="fa fa-angle-double-right"></i> <?php echo'Attendence Report By Subject' ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                <?php
                                ...
                                <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('marks_earned', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('mark/earnedmark'); ?>"><a href="<?php echo base_url(); ?>admin/mark/earnedmark"><i class="fa fa-angle-double-right"></i> <?php echo 'Marks Earned'; ?></a></li>
                                            <?php
                                        }
                                       ...
                                       // }
										...
										if ($this->rbac->hasPrivilege('supplementry_exam', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('mark/supplementry'); ?>"><a href="<?php echo base_url(); ?>admin/mark/supplementry_exam"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('supplementry_exam'); ?></a></li>
                                            <?php
                                        }
...
<li class="<?php echo set_Submenu('transcript/index'); ?>"><a href="<?php echo base_url(); ?>admin/transcript"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('transcript'); ?></a></li><?php } ?>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_view')) {
										   ...
										   if ($this->rbac->hasPrivilege('timetable_new', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('timetablenew/index'); ?>"><a href="<?php echo base_url(); ?>admin/timetablenew"><i class="fa fa-angle-double-right"></i> <?php echo "Timetable New"; ?></a></li>
                                            <?php
                                        }
                        ...
                        <li class="<?php echo set_Submenu('live_class/live_class'); ?>"><a href="<?php echo base_url() ?>admin/live_class"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('live_class'); ?></a></li><?php } ?>
                         <?php if ($this->rbac->hasPrivilege('live_class_attendance', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('live_class/live_class_attendance'); ?>"><a href="<?php echo base_url() ?>admin/live_class/live_class_attendance"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('live_class'); ?> <?php echo $this->lang->line('attendance') ?> </a></li><?php } ?>
                        ...
                        <li class="<?php echo set_Submenu('groupwise_attendance/mark_attendance'); ?>"><a href="<?php echo base_url() ?>admin/clinical_department/mark_attendance"><i class="fa fa-angle-double-right"></i> <?php echo 'Mark Attendance' ?> </a></li><?php } ?>

                        <?php if ($this->rbac->hasPrivilege('batchwise_report', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('groupwise_attendance/batchwise_report'); ?>"><a href="<?php echo base_url() ?>admin/clinical_department/batchwiseattendancereport"><i class="fa fa-angle-double-right"></i> <?php echo 'Bachwise Report' ?> </a></li><?php } ?>
                   ...
                   <?php if ($this->rbac->hasPrivilege('clinical_group', 'can_view')) { ?>
                        ...
                        <!--<li class="<?php //echo set_Submenu('clinical_rotation/add_session'); ?>"><a href="<?php //echo base_url(); ?>admin/clinical_department/add_session"><i class="fa fa-angle-double-right"></i> <?php //echo $this->lang->line('add_session'); ?></a></li>--> <?php //} ?>
                        ...
                        <li class="<?php echo set_Submenu('clinical_rotation/clinical_attendance'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department/clinical_attendance"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('clinical_attendance'); ?></a></li><?php } ?>
                        <?php if ($this->rbac->hasPrivilege('clinical_report', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('clinical_rotation/clinical_report'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department/attendancereport"><i class="fa fa-angle-double-right"></i> <?php echo 'clinical report'; ?></a></li><?php } ?> 
                                     ...
                                     <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('clinical_reportapprove', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/clinicalReportApprove'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/clinicalReportApprove"><i class="fa fa-angle-double-right"></i><?php echo "Clinical Report Approve"; ?></a></li>
                                        <?php } ?>
                                        <?php
                                        
                                        if ($this->rbac->hasPrivilege('hodviewclinical_report', 'can_view')) {
                                            ?>
                                          <li class="<?php echo set_Submenu('admin/staffevaluation/hodclinicalReportview'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/hodclinicalReportview"><i class="fa fa-angle-double-right"></i><?php echo "HOD view Clinical Report"; ?></a></li>
                                        <?php } ?>
                    ...
                    <?php if ($this->rbac->hasPrivilege('marks_register', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('clinical_rotation/marks_register'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department/clinical_mark_reg"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('marks_register'); ?></a></li><?php } ?>      
                            ...
                            if (($this->rbac->hasPrivilege('staff', 'can_view') ||
                             $this->rbac->hasPrivilege('staff_attendance', 'can_view') ||
                              $this->rbac->hasPrivilege('staff_attendance_report', 'can_view') ||
							   ...
							   $this->rbac->hasPrivilege('superviser_leave', 'can_view') ||
                                ...
                                <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                                    ...
                                    <ul class="treeview-menu">
										...
										if ($this->rbac->hasPrivilege('superviser_leave', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staff/superviserrequest'); ?>"><a href="<?php echo base_url(); ?>admin/staff/superviserrequest"><i class="fa fa-angle-double-right"></i> <?php echo 'Superviser'; ?></a></li>
                                            <?php
                                        }
										...
										if ($this->rbac->hasPrivilege('approve_leave_request_hod', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/leaverequest/leaverequesthod'); ?>"><a href="<?php echo base_url(); ?>admin/leaverequest/leaverequesthod"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('approve_leave_request'); ?> HOD</a></li>
                                            <?php
                                        }
                                ...
                                <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('classroom_teaching_scores', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglectures'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglectures"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom teaching scores"; ?></a></li>
                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('classroom_teaching_lectures', 'can_view')) {
                                            ?>

                                            <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglectures'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglectures"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom Teaching Lectures"; ?></a></li>
                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('classroom_teaching_lectures_scores', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglecturesscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglecturesscore"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom teaching scores"; ?></a></li>
                                            <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('Dental_clinic_based_scores', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/dentalclinicbasedscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/dentalclinicbasedscore"><i class="fa fa-angle-double-right"></i> <?php echo "Dental clinic based scores"; ?></a></li>
                                        ...
                                        if ($this->rbac->hasPrivilege('departmental_schedule_development', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopment'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/scheduledevelopment"><i class="fa fa-angle-double-right"></i> <?php echo "Department Schedule Development"; ?></a></li>

                                            <?php
                                        }
                                        if ($this->rbac->hasPrivilege('Departmental_schedule_scores', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopmentscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/scheduledevelopmentscore"><i class="fa fa-angle-double-right"></i> <?php echo "Department Schedule Development Scores"; ?></a></li>
                                            <?php
                                        }
                                        ...
                                        if ($this->rbac->hasPrivilege('research_supervision_scores ', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/researchsupervisionscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/researchsupervisionscore"><i class="fa fa-angle-double-right"></i> <?php echo "Research Supervision scores"; ?></a></li>
                                     ...
                                     <?php
                                        ...
                                        if ($this->rbac->hasPrivilege('participation_in_faculty_scores ', 'can_view')) {
                                            ...
                                            <li class="<?php echo set_Submenu('admin/staffevaluation/participationfacultyscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/participationfacultyscore"><i class="fa fa-angle-double-right"></i> <?php echo "Participation faculty scores"; ?></a></li>
                                        <?php } ?>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Library'); ?>">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <?php if ($this->rbac->hasPrivilege('library_web', 'can_view')) { ?>
                                            <li class="<?php echo set_Submenu('library/Library_web'); ?>"><a href="https://pcd.libsoft.org/"><i class="fa fa-angle-double-right"></i><?php echo 'LIBRARY WEB OPAC'; ?></a></li>
                                        <?php } ?>
                                ...
                                <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                                    ...
                                    <?php if ($this->rbac->hasPrivilege('fees_report', 'can_view')) {
                                        ...
                                        <li class="<?php echo set_Submenu('Reports/feesreport'); ?>"><a href="<?php echo base_url(); ?>admin/fees_report"><i class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php echo $this->lang->line('fees'); ?> <?php echo $this->lang->line('report'); ?> </a></li>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        if ($this->rbac->hasPrivilege('session_setting', 'can_view')) {
										 ...
										 if ($this->rbac->hasPrivilege('financial_year', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('financial_year'); ?>"><a href="<?php echo base_url(); ?>financial_year"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('financial_year'); ?></a></li>
                                            <?php
                                        }
										
										 if ($this->rbac->hasPrivilege('starting_invoice', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('starting_invoice'); ?>"><a href="<?php echo base_url(); ?>invoice"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('invoice'); ?></a></li>
                                            <?php
                                        }
										...
										if ($this->rbac->hasPrivilege('mess_invoice', 'can_view')) {
                                            ?>
                                            <li class="<?php echo set_Submenu('mess invoice'); ?>"><a href="<?php echo base_url(); ?>invoice/mess_invoice"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('mess'); ?> <?php echo $this->lang->line('invoice'); ?></a></li>
                                            <?php
                                        }
