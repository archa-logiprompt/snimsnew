                	...
                	<div class="box-header with-border">
                    	<h3 class="box-title">
                       	...
                       	<div class="box-tools pull-right">
                        	...
                        	<a href="<?php echo base_url(); ?>admin/timetablenew/create" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="<?php echo $this->lang->line('add_timetable'); ?>" >
                            	<i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?>
                        	</a>
                            <?php } ?>
                        </div>
                    </div>
                    <form action="<?php echo site_url('admin/timetablenew/index')?>" method="post" accept-charset="utf-8">
                    	<div class="box-body">
                                             	...
                                             	$status = $valtime->status; if ($status == "Yes"){?> 
                                                	<div class="attachment-block clearfix">
                                                   	<?php if ($valtime->start_time != "" && $valtime->end_time != "") { ?>
                                                        ...
                                                        <strong class="text-green"><?php echo $this->lang->line('room_no'); ?>: <?php echo $value->room_no; ?></strong> <br/>
     <strong class="text-green">Department: <?php echo $valtime->department; ?></strong> 
     <strong class="text-green">Subject :<?php echo $valtime->subject; ?></strong>                                                        <?php } else { ?>
