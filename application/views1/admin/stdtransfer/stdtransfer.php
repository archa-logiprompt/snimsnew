    ...
    <section class="content">
        <div class="row">           
                ...
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stdtransfer/index') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary btn-sm pull-right"><?php echo $this->lang->line('array_search(needle, haystack)'); ?><?php echo $this->lang->line('search'); ?></
                        </div>
                    </form>
                </div>
            </div>
            ...
            if (isset($resultlist)) {
                            ...
                            <div class="table-responsive">    
                                <table class="table table-striped">
                                    <tbody>
                                      ...
                                      <th class=""><?php echo $this->lang->line('remarks'); ?></th>      
                                        ...
                                        <?php if (empty($resultlist)) {
                                            ...
                                            <input type="hidden" name="feeyear" value="<?php echo $student['year']; ?>"
                                            <tr>
             ...
             <input type="text" class="form-control"  name="remarks_<?php echo $student['id'] ?>" />
