                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('postal_dispatch'); ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo site_url('admin/dispatch') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">                        
                                ...
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('to_title'); ?></label>  <small class="req"> *</small>  
            ...
            ?>">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
						...
						<?php echo $this->lang->line('list'); ?></div>
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>                                    
                                        <th><?php echo $this->lang->line('dispatch'); ?> <?php echo $this->lang->line('to_title'); ?></th>
                                 ...
                                 <td class="mailbox-name"> <?php echo $value->from_title; ?></td>
                                          <td class="mailbox-name"> <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($value->date)); ?></td>
                                                <td class="mailbox-date pull-right" "="">
                                                    <a  onclick="getRecord(<?php echo $value->id; ?>)" class="btn btn-default btn-xs" data-target="#receviedetails" data-toggle="modal" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing" data-original-title="View">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('postal_dispatch', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/dispatch/delete/<?php echo $value->id; ?>/<?php echo $value->image; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete') ?>">
