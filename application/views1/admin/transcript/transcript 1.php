                                        ...
                                        if (empty($student_list)) {
                                            ...
                                            foreach ($student_list as $student) {
                                                ...
                                                <tr>
                                                  ...
                                                  <a  class="btn btn-primary btn-sm schedule_modal" data-toggle="tooltip" title="" data-student_session_id="<?php echo $student['student_session_id']?>" data-studname="<?php echo $student['firstname']."".$student['lastname']; ?>" data-guardian_name="<?php echo $student['guardian_name']; ?>" data-permanent_address="<?php echo $student['permanent_address'] ?>" data-dob="<?php echo $student['dob'] ?>" data-original-title=" <?php echo $this->lang->line('show_transcript'); ?>" data-sectionid='<?php //echo $section_id ?>' data-classid='<?php //echo $class_id ?>' data-classname="<?php //echo $exam['class_name'] ?>"  data-sectionname="<?php //echo $exam['section_name'] ?>">
...
$(document).on('click', '.schedule_modal', function () {
	//$("#scheduleModal").modal('show');
        $('.modal-title').html("");
        var stud_name = $(this).data('studname');
        var gender = $(this).data('examname');
        var parent = $(this).data('sectionid');
        var class_id = $(this).data('classid');
        var classname = $(this).data('classname');
        var sectionname = $(this).data('sectionname');
        $('.modal-title').html(" <?php echo strtoupper($this->setting_model->getCurrentSchoolName());?>   " + examname);
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            type: "post",
            ...
            success: function (response) {
				...
				data +=' <div class="col-md-9"><div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('name_of_student'); ?></label> </div> <div class="col-md-1"> :</div> <div class="col-md-6"> <label></label> </div> </div>';
				
				data +='<div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('gender'); ?></label> </div>  <div class="col-md-1"> :</div>  <div class="col-md-6"> <label></label> </div> </div>';
				
				data +='<div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('parent'); ?></label> </div> <div class="col-md-1"> :</div> <div class="col-md-6"> <label></label> </div> </div>';
				data +='<div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('permanent_address'); ?></label> </div> <div class="col-md-1"> :</div>  <div class="col-md-6"> <label></label> </div> </div>';
				
				data +='<div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('date_of_birth'); ?></label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
				
				data +='<div class="row"> <div class="col-md-5"> <label><?php echo $this->lang->line('nationality'); ?></label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
				
				<!--////////////////////-->	
				
			data +='<div class="row"> <div class="col-md-5"> <label>KUHS Registration Number</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Name of the course</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Medium of Instruction</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Degree awarded by </label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Name of the College of study</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			...
			data +='<div class="row"> <div class="col-md-5"> <label>Date of admission</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
			data +='<div class="row"> <div class="col-md-5"> <label>Date of completion of course</label> </div>  <div class="col-md-1"> :</div>    <div class="col-md-6"> <label></label> </div> </div>';
		...
		data +='<table style="width: 100%;margin-top: 21px;" border="1" class="tg" ><tr><th  rowspan="3">Subjects</th><th  colspan="2">Theory</th><th  colspan="2">Clinical Practice</th><th  colspan="4"><center>Marks Awarded</center></th><th  rowspan="3">Total Marks</th></tr><tr><th  rowspan="2">Allotted</th><th rowspan="2">Attended</th><th  rowspan="2">Allotted</th><th  rowspan="2">Attended</th><th  colspan="2">Theory</th><th  colspan="2">Practical&VivaVoce </th></tr><tr><th>Internal marks</th><th>University marks</th><th>Internal marks</th><th >University marks </th> </tr><tr><th style="font-size: 16px;font-weight: bold;text-align: left;" colspan="10">First Year</th></tr><tr class="tacenter"><td>1.Anatomy</td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>2.Physiology </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>3.Microbiology </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter" ><td> 4.Psychology</td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr><th style="font-size: 16px;font-weight: bold;text-align: right;">Total</th><th></th><th> </th><th></th><th></th><th></th><th></th><th>-</th><th></th><th></th></tr>';
	...
	data +='<tr><th style="font-size: 16px;font-weight: bold;text-align: left;" colspan="10">Third Year</th></tr><tr class="tacenter"><td>1..Medical Surgical Nursing 11 </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>2..Child Health Nursing  </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>3.Mental Health Nursing  </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter" ><td> 4.,Nursing Research & Statistics </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr><th style="font-size: 16px;font-weight: bold;text-align: right;">Total</th><th></th><th> </th><th></th><th></th><th></th><th></th><th>-</th><th></th><th></th></tr>';
	data +='<tr><th style="font-size: 16px;font-weight: bold;text-align: left;" colspan="10">Fourth Year</th></tr><tr class="tacenter"><td>1.Nursing Education </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>2..Management of Nursing Services & Education  </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter"><td>3..Obstetrics & Gynaecological Nursing </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr class="tacenter" ><td> 4. Community Health Nursing11 </td><td>60</td><td> </td><td>-</td><td>-</td><td>/25</td><td>/75</td><td>-</td><td>-</td><td>100</td></tr><tr><th style="font-size: 16px;font-weight: bold;text-align: right;">Total</th><th></th><th> </th><th></th><th></th><th></th><th></th><th>-</th><th></th><th></th></tr>';
...
<div id="scheduleModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="document">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-left: 34px; margin-right: 34px;">
