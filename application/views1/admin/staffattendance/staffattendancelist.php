                                        ...
                                        <table class="table table-hover table-striped example">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class=""><?php echo "Leave Type"; ?></th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($resultlist as $key => $value) {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><?php //var_dump($leavetype); ?><select id="selLeave" name="selLeave<?php echo $value["staff_id"] ?>">
                                                           
                                                            <option value="0">Select</option>
                                                            <?php foreach($leavetype as $key){ ?>
                                                            <option value="<?php echo $key['id']; ?>" <?php if($value['leave_type']==$key['type']){?> selected="selected"  <?php } ?>><?php echo $key['type']; ?></option>
                                                            <?php } ?>
                                                            </select></td>     
                                                        <?php } else { ?>
                                                            ...
                                                            <td>
                                                            <select id="selLeave" name="selLeave<?php echo $value["staff_id"] ?>">							
                                                            <option value="0">Select</option>
                                                           <?php foreach($leavetype as $key){ ?>
                                                            <option value="<?php echo $key['id']; ?>" <?php if($value['leave_type']==$key['id']){?> selected="selected"  <?php } ?>><?php echo $key['type']; ?></option>
                                                            <?php } ?>
                                                            </select></td>
                                                        <?php } ?>
                                                    </tr>
