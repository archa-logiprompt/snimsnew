                        ...
                        <form id="form1" action="<?php echo site_url('admin/visitors') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('purpose'); ?></label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('name'); ?></label>  <small class="req"> *</small>
                                    <input type="text" class="form-control" value="<?php echo set_value('name'); ?>" name="Visitorname">
                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                </div>

                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('phone'); ?></label>
                                    <input type="text" class="form-control" value="<?php echo set_value('contact'); ?>" name="contact">

                                </div>
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('icard'); ?></label>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('visited'); ?> <?php echo $this->lang->line('date'); ?></label><input type="text" id="date" class="form-control" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>"  name="date" readonly="">
                                        <span class="text-danger"><?php echo form_error('date'); ?></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('in_time'); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('out_time'); ?></label>
                                    <div class="bootstrap-timepicker">
                                        <div class="form-group">
                                            <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label for="pwd"><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('note'); ?></label>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('purpose'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('name'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('phone'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('visited'); ?> <?php echo $this->lang->line('date'); ?></th>
                                        <th><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('in_time'); ?>
                                        </th>
                                        <th><?php echo $this->lang->line('visitor'); ?> <?php echo $this->lang->line('out_time'); ?>
                                        </th>
