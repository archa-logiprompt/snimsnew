        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/attendencebyday') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php 
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($resultlist)) {
                                ...
                                ?>
                                <form action="<?php echo site_url('admin/attendencebyday/index') ?>" method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
            ...
            <?php echo $value['firstname'] . " " . $value['lastname']; ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            foreach ($attendencetypeslist as $key => $type) {
                                                                ...
                                                                if ($type['key_value'] != "F" && $type['key_value']!="H"){
