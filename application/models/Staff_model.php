...
class Staff_model extends CI_Model {
    ...
    function getStaffDesignation() {
         $admin=$this->session->userdata('admin');
         $centre_id = $admin['centre_id'];
        $query = $this->db->select('*')->where("is_active", "yes")->where('centre_id',$centre_id)->get("staff_designation");
    ...
    function getDepartment() {
         $admin=$this->session->userdata('admin');
         $centre_id = $admin['centre_id'];
        $query = $this->db->select('*')->where("is_active", "yes")->where('centre_id',$centre_id)->get('department');
        return $query->result_array();
    }
