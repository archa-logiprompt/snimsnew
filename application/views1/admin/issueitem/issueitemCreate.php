                ...
                <div class="box box-primary">
                 ...
                 <!--input autofocus="" name="account_type" class="ac_type" id="input-type-student" value="<?php echo $role_value['id']; ?>" type="radio" /-->
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input  class="form-control" type="number"  id="quantity_entered" name="quantity"/>
                                            <input  class="form-control" type="hidden"  id="quantity_hidden" name="quantity_hidden"/>
                                            <div id="div_avail">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="allot-fees btn btn-primary btn-sm pull-right" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><?php echo $this->lang->line('submit'); ?>
                            </button>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
        ...
        if (item_id != "") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#quantity_hidden').val(data.available); 
                    $('#div_avail').show();
                }
    ...
    $("#issueitem").submit(function (e)
    {
        ...
        let quantity_available = $('#quantity_hidden').val()
        let quantity_entered = $('#quantity_entered').val() 

        
        if( Number(quantity_available)<Number(quantity_entered)){
