...
class Roles extends Admin_Controller {
    ...
    //     $data['role'] = $role;
    //     $permission_model = $this->rolepermission_model->getPermissionWithSelectedByRole($id);
    //     $data['permissions'] = $permission_model;
    ...
    //             }
    //         }
    //         $this->rolepermission_model->getInsertBatch($insert_array, $role_id, $delete_array);
    //         $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">Permission updated successfully</div>');
