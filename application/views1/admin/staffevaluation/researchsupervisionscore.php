                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Allotted API Score (Total : 20)";?> 
                                                	</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "UG Summer Projects  : Each fresh candidate/year = 1 point
";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "BDS – Research Trainee - Projects  : Each fresh candidate/year = 1 points
";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "MDS Dissertations  : Each fresh candidate/year = 2 points
";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Ph.D. –  As main Supervisor : 3 points/each fresh candidate that year ; Co-guide: 2/each fresh candidate that year
";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
