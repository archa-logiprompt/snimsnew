<div class="content-wrapper">  
    ...
    <div id="errorModal" class="modal fade in bs-example-modal-lg" aria-hidden="true" role="dialog"
   <?php if(validation_errors()!=''){ echo 'style="display:block;"';}?>>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#class_id', function (e) {
            ...
            else if(class_id=='8'||class_id=='9'||class_id=='10'||class_id=='11'||class_id=='12'||class_id=='13'||class_id=='14'||class_id=='15')
