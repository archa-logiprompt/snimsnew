                                        ...
                                        <tbody>
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    ?>
                                                    <td><span data-toggle="popover" class="detail_popover" data-original-title="" title=""><small <?php echo $label ?>><?php echo $status[$value["hod"]]; ?></small></span>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.submit_schsetting', function (e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/leaverequest/leaveStatushod") ?>',
            type: 'post',
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('input[name="leavefrom"]').val(new Date(result.leave_from).toString("dd/MM/yyyy"));
