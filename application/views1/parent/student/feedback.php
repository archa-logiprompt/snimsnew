                                  ...
                                  അധ്യാപന നിലവാരത്തിൽ നിങ്ങൾ <br>എത്രമാത്രം തൃപ്തരാണ്? </td>
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review1" name="review1" type="radio" class="" <?php if ($review1 == '0')
                                         ...
                                         <input id="review1" name="review1" type="radio" class="" <?php if ($review1 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review1', 1); ?> />
                                          <label for="review1" class="">സംതൃപ്തം</label>

                                         <input id="review1" name="review1" type="radio" class="" <?php if ($review1 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review2" name="review2" type="radio" class="" <?php if ($review2 == '0')
                                         ...
                                         <input id="review2" name="review2" type="radio" class="" <?php if ($review2 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review2', 1); ?> />
                                          <label for="review2" class="">സംതൃപ്തം</label>

                                         <input id="review2" name="review2" type="radio" class="" <?php if ($review2 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review3" name="review3" type="radio" class="" <?php if ($review3 == '0')
                                         ...
                                         <input id="review3" name="review3" type="radio" class="" <?php if ($review3 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review3', 1); ?> />
                                          <label for="review3" class="">സംതൃപ്തം</label>

                                         <input id="review3" name="review3" type="radio" class="" <?php if ($review3 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review4" name="review4" type="radio" class="" <?php if ($review4 == '0')
                                         ...
                                         <input id="review4" name="review4" type="radio" class="" <?php if ($review4 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review4', 1); ?> />
                                          <label for="review4" class="">സംതൃപ്തം</label>

                                         <input id="review4" name="review4" type="radio" class="" <?php if ($review4 == '2')
                                    ...
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review5" name="review5" type="radio" class="" <?php if ($review5 == '0')
                                         ...
                                         <input id="review5" name="review5" type="radio" class="" <?php if ($review5 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review5', 1); ?> />
                                          <label for="review5" class="">സംതൃപ്തം</label>

                                         <input id="review5" name="review5" type="radio" class="" <?php if ($review5 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review6" name="review6" type="radio" class="" <?php if ($review6 == '0')
                                         ...
                                         <input id="review6" name="review6" type="radio" class="" <?php if ($review6 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review6', 1); ?> />
                                          <label for="review6" class="">സംതൃപ്തം</label>

                                         <input id="review6" name="review6" type="radio" class="" <?php if ($review6 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review7" name="review7" type="radio" class="" <?php if ($review7 == '0')
                                         ...
                                         <input id="review7" name="review7" type="radio" class="" <?php if ($review7 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review7', 1); ?> />
                                          <label for="review7" class="">സംതൃപ്തം</label>

                                         <input id="review7" name="review7" type="radio" class="" <?php if ($review7 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review8" name="review8" type="radio" class="" <?php if ($review8 == '0')
                                         ...
                                         <input id="review8" name="review8" type="radio" class="" <?php if ($review8 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review8', 1); ?> />
                                          <label for="review8" class="">സംതൃപ്തം</label>

                                         <input id="review8" name="review8" type="radio" class="" <?php if ($review8 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review9" name="review9" type="radio" class="" <?php if ($review9 == '0')
                                         ...
                                         <input id="review9" name="review9" type="radio" class="" <?php if ($review9 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review9', 1); ?> />
                                          <label for="review9" class="">സംതൃപ്തം</label>

                                         <input id="review9" name="review9" type="radio" class="" <?php if ($review9 == '2')
                                    ...
                                    <td><center>2.</center></td>
                                       ...
                                       <td>
                                           <input id="review10" name="review10" type="radio" class="" <?php if ($review10 == '0')
                                         ...
                                         <input id="review10" name="review10" type="radio" class="" <?php if ($review10 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review10', 1); ?> />
                                          <label for="review10" class="">സംതൃപ്തം</label>

                                         <input id="review10" name="review10" type="radio" class="" <?php if ($review10 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review11" name="review11" type="radio" class="" <?php if ($review11 == '0')
                                         ...
                                         <input id="review11" name="review11" type="radio" class="" <?php if ($review11 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review11', 1); ?> />
                                          <label for="review11" class="">സംതൃപ്തം</label>

                                         <input id="review11" name="review11" type="radio" class="" <?php if ($review11 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="c" name="review29" type="radio" class="" <?php if ($review29 == '0')
                                         ...
                                         <input id="review29" name="review29" type="radio" class="" <?php if ($review29 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review29', 1); ?> />
                                          <label for="review29" class="">സംതൃപ്തം</label>

                                         <input id="review29" name="review29" type="radio" class="" <?php if ($review29 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review12" name="review12" type="radio" class="" <?php if ($review12 == '0')
                                         ...
                                         <input id="review12" name="review12" type="radio" class="" <?php if ($review12 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review12', 1); ?> />
                                          <label for="review12" class="">സംതൃപ്തം</label>

                                         <input id="review12" name="review12" type="radio" class="" <?php if ($review12 == '2')
                                   ...
                                   <tr>
                                    <td><center></center></td>
                                       ...
                                       <td>
                                           <input id="review13" name="review13" type="radio" class="" <?php if ($review13 == '0')
                                         ...
                                         <input id="review13" name="review13" type="radio" class="" <?php if ($review13 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review13', 1); ?> />
                                          <label for="review13" class="">സംതൃപ്തം</label>

                                         <input id="review13" name="review13" type="radio" class="" <?php if ($review13 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review14" name="review14" type="radio" class="" <?php if ($review14 == '0')
                                         ...
                                         <input id="review14" name="review14" type="radio" class="" <?php if ($review14 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review14', 1); ?> />
                                          <label for="review14" class="">സംതൃപ്തം</label>

                                         <input id="review14" name="review14" type="radio" class="" <?php if ($review14 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review15" name="review15" type="radio" class="" <?php if ($review15 == '0')
                                         ...
                                         <input id="review15" name="review15" type="radio" class="" <?php if ($review15 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review15', 1); ?> />
                                          <label for="review15" class="">സംതൃപ്തം</label>

                                         <input id="review15" name="review15" type="radio" class="" <?php if ($review15 == '2')
                                   ...
                                   <tr>
                                    <td><center>3.</center></td>
                                       ...
                                       <td>
                                           <input id="review16" name="review16" type="radio" class="" <?php if ($review16 == '0')
                                         ...
                                         <input id="review16" name="review16" type="radio" class="" <?php if ($review16 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review16', 1); ?> />
                                          <label for="review16" class="">സംതൃപ്തം</label>

                                         <input id="review16" name="review16" type="radio" class="" <?php if ($review16 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review17" name="review17" type="radio" class="" <?php if ($review17 == '0')
                                         ...
                                         <input id="review17" name="review17" type="radio" class="" <?php if ($review17 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review17', 1); ?> />
                                          <label for="review17" class="">സംതൃപ്തം</label>

                                         <input id="review17" name="review17" type="radio" class="" <?php if ($review17 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review18" name="review18" type="radio" class="" <?php if ($review18 == '0')
                                         ...
                                         <input id="review18" name="review18" type="radio" class="" <?php if ($review18 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review18', 1); ?> />
                                          <label for="review18" class="">സംതൃപ്തം</label>

                                         <input id="review18" name="review18" type="radio" class="" <?php if ($review18 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review19" name="review19" type="radio" class="" <?php if ($review19 == '0')
                                         ...
                                         <input id="review19" name="review19" type="radio" class="" <?php if ($review19 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review19', 1); ?> />
                                          <label for="review19" class="">സംതൃപ്തം</label>

                                         <input id="review19" name="review19" type="radio" class="" <?php if ($review19 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review20" name="review20" type="radio" class="" <?php if ($review20 == '0')
                                         ...
                                         <input id="review20" name="review20" type="radio" class="" <?php if ($review20 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review20', 1); ?> />
                                          <label for="review20" class="">സംതൃപ്തം</label>

                                         <input id="review20" name="review20" type="radio" class="" <?php if ($review20 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review21" name="review21" type="radio" class="" <?php if ($review21 == '0')
                                         ...
                                         <input id="review21" name="review21" type="radio" class="" <?php if ($review21 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review21', 1); ?> />
                                          <label for="review21" class="">സംതൃപ്തം</label>

                                         <input id="review21" name="review21" type="radio" class="" <?php if ($review21 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review22" name="review22" type="radio" class="" <?php if ($review22 == '0')
                                         ...
                                         <input id="review22" name="review22" type="radio" class="" <?php if ($review22 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review22', 1); ?> />
                                          <label for="review22" class="">സംതൃപ്തം</label>

                                         <input id="review22" name="review22" type="radio" class="" <?php if ($review22 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review23" name="review23" type="radio" class="" <?php if ($review23 == '0')
                                         ...
                                         <input id="review23" name="review23" type="radio" class="" <?php if ($review23 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review23', 1); ?> />
                                          <label for="review23" class="">സംതൃപ്തം</label>

                                         <input id="review23" name="review23" type="radio" class="" <?php if ($review23 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review24" name="review24" type="radio" class="" <?php if ($review24 == '0')
                                         ...
                                         <input id="review24" name="review24" type="radio" class="" <?php if ($review24 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review24', 1); ?> />
                                          <label for="review24" class="">സംതൃപ്തം</label>

                                         <input id="review24" name="review24" type="radio" class="" <?php if ($review24 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review25" name="review25" type="radio" class="" <?php if ($review25 == '0')
                                         ...
                                         <input id="review25" name="review25" type="radio" class="" <?php if ($review25 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review25', 1); ?> />
                                          <label for="review25" class="">സംതൃപ്തം</label>

                                         <input id="review25" name="review25" type="radio" class="" <?php if ($review25 == '2')
                                   ...
                                   <tr>
                                    <td><center>5.</center></td>
                                       ...
                                       <td>
                                           <input id="review26" name="review26" type="radio" class="" <?php if ($review26 == '0')
                                         ...
                                         <input id="review26" name="review26" type="radio" class="" <?php if ($review26 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review26', 1); ?> />
                                          <label for="review26" class="">സംതൃപ്തം</label>

                                         <input id="review26" name="review26" type="radio" class="" <?php if ($review26 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review27" name="review27" type="radio" class="" <?php if ($review27 == '0')
                                         ...
                                         <input id="review27" name="review27" type="radio" class="" <?php if ($review27 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review27', 1); ?> />
                                          <label for="review27" class="">സംതൃപ്തം</label>

                                         <input id="review27" name="review27" type="radio" class="" <?php if ($review27 == '2')
                                   ...
                                   <tr>
                                    <td></td>
                                       ...
                                       <td>
                                           <input id="review28" name="review28" type="radio" class="" <?php if ($review28 == '0')
                                         ...
                                         <input id="review28" name="review28" type="radio" class="" <?php if ($review28 == '1')
                                             echo "checked='checked'"; ?> value="1" <?php echo $this->form_validation->set_radio('review28', 1); ?> />
                                          <label for="review28" class="">സംതൃപ്തം</label>

                                         <input id="review28" name="review28" type="radio" class="" <?php if ($review28 == '2')
...
?
                                ...
                                <div class="mb-5">
                                     <div class="col-md-6">
                                        <label for="exampleInputEmail1"><?php echo "Patron's Name:"; ?></label>
                                        <input autofocus="" id="ptname" style="width:400px" name="ptname" placeholder="" type="text" class="form-control" value="<?php echo set_value('ptname'); ?>" />
                                        <span class="text-danger"><?php echo form_error('ptname'); ?></span>
                                    </div>
                                    <div class="col-md-6">
