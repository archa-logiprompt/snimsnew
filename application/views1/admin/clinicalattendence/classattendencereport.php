...
<div class="content-wrapper" style="min-height: 946px;">
        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/clinical_department/attendancereport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="box-header with-border" >
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="lateday">
                                            <?php //var_dump($attendencetypeslist);
                                                          ...
                                                          //var_dump($monthAttendance[$i][$student_value['student_session_id']]) ;
                                                            ...
                                                            if ($total_school_days == 0) {
                                                               ...
                                                               //var_dump( $percentage);
                                                                ...
                                                                // print_r($this->db->last_query($percentage));exit;
                                                            }
                                                        ...
                                                        foreach ($attendence_array as $at_key => $at_value) {
                                                            ...
                                                            <th class="tdcls text text-center">
                                                                ...
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="color:#333"><?php 
                                                                   ...
                                                                   if (strip_tags($resultlist[$at_value][$student_value['student_session_id']]['date']) == $at_value) { 
    ...
    function getSubjectByClassandSection(class_id_post, section_id_post, sub_id_post) {
        ...
        if (class_id_post != "" && section_id_post != "" && sub_id_post != "") {
            ...
            $.ajax({
                type: "POST",
                url: base_url + "admin/clinical_department/getGroupByClassSectionandsubject",
