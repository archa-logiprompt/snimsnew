        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form" id="" class="addmarks-form" method="post"
                    action="<?php echo site_url('admin/worklog/create') ?>">
                            ...
                            <div class="container w-100">
                                ...
                                <div class="wrapping-container">
                                    ...
                                    <div class="row" style='display: flex;align-items: flex-end;width:111%'>
                                        ...
                                        <div class="col-md-12">
                                            <label
                                                for="exampleInputEmail1"><?php echo $this->lang->line('day'); ?></label>
...
$(document).ready(function() {
        ...
        <div class="row" style='margin-top: 20px;width: 100%;margin-left: 2px;display: flex;align-items: flex-end;'>
                                            ...
                                            <div class="col-md-2">
                                                <div class="bootstrap-timepicker">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="timefrom[`+id+`][]"
                                                            class="form-control timepicker stime" id="stime_"
                                                            value="<?php echo '01:00 AM'; ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                            ...
                                            <div class="col-md-2">
                                                <div class="bootstrap-timepicker">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="timeto[`+id+`][]"
                                                            class="form-control timepicker stime" id="stime_"
                                                            value="<?php echo '01:00 AM'; ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select name="worktype[`+id+`][]" id="worktype" class='form-control'>
                                                    <option value="0">Class </option>
                                                    <option value="1">Other</option>
                                                </select>
                                            </div> 
                                            <div class="col-md-2 classlist">
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('class'); ?></label>
                                                    <select autofocus="" id="class_id" name="class_id[`+id+`][]"
                                                        class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                        <?php
                                            ...
                                            <div class="col-md-2 classlist" >
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?></label>
                                                    <select id="section_id" name="section_id[`+id+`][]" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>
                                                    <span
                                            ...
                                            <div class="col-md-2 classlist" >
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('subject'); ?></label>
                                                    <select id="subject_id" name="subject_id[`+id+`][]" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>
                                                    <span
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <textarea id="stopic" name="worktopic[`+id+`][]"
                                                    class="form-control"></textarea>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <button id="btnAdd" data-planid="`+id+`"
                                                    class="btn btn-success btn-sm checkbox-toggle btnAdd"
                                                    style="background-color: #085d35fc !important;display: block;"
                                                    type="button"><i class="fa fa-plus"></i> Add</button>
                                            </div>
    ...
    $(document).on('click', '.btnAddWeek', function(e) {
        ...
        data += `     
        <div class="wrapping-container">
                                    <input type="hidden" name="workid[]" value="`+wrapid+`">
                                    <div class="row" style='display: flex;align-items: flex-end;width:111%'>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                <input name="date[`+wrapid+`]" placeholder="" type="text"
                                                    class="form-control date"
                                                    value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" />
                                                <div class="input-group-addon">
                                                    <i class="fa fa-calendar-check-o"></i>
                                        ...
                                        <div class="row"
                                            ...
                                            <div class="col-md-2">
                                                <div class="bootstrap-timepicker">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="timefrom[`+wrapid+`][]"
                                                            class="form-control timepicker stime" id="stime_"
                                                            value="<?php echo '01:00 AM'; ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                            ...
                                            <div class="col-md-2">
                                                <div class="bootstrap-timepicker">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="timeto[`+wrapid+`][]"
                                                            class="form-control timepicker stime" id="stime_"
                                                            value="<?php echo '01:00 AM'; ?>">
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-clock-o"></i>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select name="worktype[`+wrapid+`][]" id="worktype" class='form-control'>
                                                    <option value="0">Class </option>
                                                    <option value="1">Other</option>
                                                </select>
                                            </div> 
                                            <div class="col-md-2 classlist">
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('class'); ?></label>
                                                    <select autofocus="" id="class_id" name="class_id[`+wrapid+`][]"
                                                        class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                        <?php
                                            ...
                                            <div class="col-md-2 classlist" >
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?></label>
                                                    <select id="section_id" name="section_id[`+wrapid+`][]" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>
                                                    <span
                                            ...
                                            <div class="col-md-2 classlist" >
                                                    ...
                                                    <label
                                                        for="exampleInputEmail1"><?php echo $this->lang->line('subject'); ?></label>
                                                    <select id="subject_id" name="subject_id[`+wrapid+`][]" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?>
                                                        </option>
                                                    </select>
                                                    <span
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <textarea id="stopic" name="worktopic[`+wrapid+`][]"
                                                    class="form-control"></textarea>
                                            </div>
