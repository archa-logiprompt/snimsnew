                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Allotted API Score (Total : 30)";?> 
                                                	</th>
                                                	 
                                                   
                                                     <th class="text text-center">
                                                        <?php echo "API Score Secured";?>
                                                    </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Dental Out-patient – Clinic/Community dental clinic teaching : 5";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Skill-Lab based teaching : 5";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Training for advanced dental procedures/ development skills : 10";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Dental Science related investigational skills/training for use of dental equipment’s and Clinical Protocol development : 5";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Imparting Patient related operational skills and Medical Record documentation: 5";?> </th>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
