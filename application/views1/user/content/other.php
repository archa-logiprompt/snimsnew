            ...
            <div class="col-md-12">                
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('other_download_list'); ?></h3>
                        <div class="box-tools pull-right">
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('other_download_list'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date text-right">
                                              ...
                                              <?php foreach ($mexpl as $ex) {
                                                 ?>
                                                <a href="<?php echo base_url(); ?>user/content/download/<?php echo $ex ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
