        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/attendenceReportByday/classattendencereport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <!--<div class="col-md-2">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php /*?><?php echo $this->lang->line('subject'); ?><?php */?></label><small class="req"> *</small>
                                        <select  id="subject_id" name="subject_id" class="form-control" >
                                            <option value=""><?php /*?><?php echo $this->lang->line('select'); ?><?php */?></option>
                                        </select>
                                        <span class="text-danger"><?php /*?><?php echo form_error('subject'); ?><?php */?></span>
                                    </div>
                                </div>-->
                                                        ...
                                                        foreach ($attendence_array as $at_key => $at_value) {
                                                            ...
                                                            <th class="tdcls text text-center">
                                                                ...
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="color:#333"><?php
                                                                        if (strip_tags($resultlist[$at_value][$student_value['attedence_report_byday']]['key']) == "E") {

                                                                            $attendence_key = "L";
                                                                            $remark = "Late With Excuse";
                                                                        } else {

                                                                            $attendence_key = $resultlist[$at_value][$student_value['attedence_report_byday']]['key'];
                                                                            $remark = $resultlist[$at_value][$student_value['attedence_report_byday']]['remark'];
                                                                        }
