...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">  
            <form id='feesforward' action="<?php echo site_url('admin/feesforward/messfeeforward') ?>"  method="post" accept-charset="utf-8">
                <div class="col-md-12">
                                                    ...
                                                    foreach ($student_due_fee as $due_fee_key => $due_fee_value) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="student_id[<?php echo $i ?>]" value="<?php echo $due_fee_value->student_id  ?>"  />
