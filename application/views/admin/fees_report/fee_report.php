...
<div class="content-wrapper" style="min-height: 946px;">
        ...
        <div class="row">
            <div class="col-md-6">
                                    ...
                                    <label><?php echo $this->lang->line('fees_group'); ?></label>   
                                      ...
                                      <div class="col-md-5">
                                       ...
                                       <label><?php echo $this->lang->line('fee_category'); ?></label><br />
                                        <input <?php if ($feetype == 'all') {
                                            echo 'checked=checked';
                                        } ?> type="checkbox" name="fee_category" value="all" id="select_all"/> <?php echo $this->lang->line('all'); ?></div></div></div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-sm-4">
                                            ...
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                             <option <?php if ($payment_mode == 'All') {
                                                 echo 'selected=selected';
                                             } ?> value="All"><?php echo $this->lang->line('all'); ?></option>
                                        <option <?php if ($payment_mode == 'Cash') {
                                            echo 'selected=selected';
                                        } ?> value="Cash"><?php echo $this->lang->line('cash'); ?></option>
                                       <option <?php if ($payment_mode == 'Cheque') {
                                           echo 'selected=selected';
                                       } ?> value="Cheque"><?php echo $this->lang->line('cheque'); ?></option>
                                      <option <?php if ($payment_mode == 'DD') {
                                          echo 'selected=selected';
                                      } ?> value="DD"><?php echo $this->lang->line('dd'); ?></option>
                                      <option <?php if ($payment_mode == 'Bank') {
                                          echo 'selected=selected';
                                      } ?> value="Bank"><?php echo $this->lang->line('bank'); ?></option>
                        ...
                        <div class="around10">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <input <?php if ($report_type == 'billno_feeheadwise') {
                                            echo 'checked=checked';
                                        } ?> type="radio" name="rad_report" value="billno_feeheadwise"> Billno and feehead
                                        wise details
                                    </div>

                                    <div>

                                        <input <?php if ($report_type == 'fee_received_excess') {
                                            echo 'checked=checked';
                                        } ?> type="radio" name="rad_report" value="fee_received_excess"> Fee Received
                                        In Excess

                                    </div>

                                    <div>
                                        <input <?php if ($report_type == 'fee_received_advance') {
                                            echo 'checked=checked';
                                        } ?> type="radio" name="rad_report" value="fee_received_advance"> Fee
                                        Received In Advance
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <input <?php if ($report_type == 'feehead_summary') {
                                            echo 'checked=checked';
                                        } ?> type="radio" name="rad_report" value="feehead_summary"> FeeHeadwise Summary
                                    </div> 
                                </div>
               ...
               <?php echo $header ?>
                                                    ...
                                                    <tr>
                                                    <th style="width: 10px;" >From </th><th>: <?php echo $from ?></th> 
                                                    <th style="width: 10px;">To</th><th>: <?php echo $to; ?></th>
                                                    <th ></th>
          ...
          <tr >
            ...
            <td style="padding:0px 6px;" colspan="3">Sem/Year</td><td>:</td><td style="width: 216px;" colspan="3"></td>
                           ...
                           <?php if ($header == 'Bill Number and Fee Headwise Details' || $header == 'Fee Recieved In Excess' || $header == 'Fee Recieved In Advance') { ?>                         
                                    ...
                                    <table  style="border-left: 1px solid;border-right: 1px solid;width: 100%;">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        if (empty($list['feeList'])) {
                                                                            ...
                                                                            if (isset($list['feeList'])) {
                                                                                foreach ($list['feeList'] as $key => $value) {
                                                                                    ...
                                                                                    ?>
                                                                                                     ...
                                                                                                     <?php if (isset($value->collection_record))
                                                                                                         foreach ($value->collection_record as $key => $record) {
    ...
    border-top: 1px dashed;" class="text text-right">
                                                                                                                             ...
                                                                                                                             <?php }
                                                                                                     $ad_total = 0;
                                                                                                     if (!empty($value->feeadvance))
                                                                                                         foreach ($value->feeadvance as $advance) {
                                                                                                             ...
                                                                                                             ?>
                                                                                                                                        <tr>
                                                                                                                                          ...
                                                                                                                                          <td></td>  
                                                                                                                                            ...
                                                                                                                                            <td class="text text-right">
                                                                                                                             <?php echo number_format($advance['amount'], 0, '.', ''); ?>
                                                                                                                                            </td>
                                                                                                                       ...
                                                                                                                       0.00
                                                                                                                        ...
                                                                                                                        0.00
                                                                                                                                            ...
                                                                                                                                            <td  class="text text-right">
                                                                                                                                                ...
                                                                                                                                                echo number_format($advance['amount'], 0, '.', '');
                                                                                                                                                ?>
                                                                                                                                            </td>
    ...
    border-top: 1px dashed;" class="text text-right">
                                                                                                                         ...
                                                                                                                         <?php }
                                                                                                     $ex_total = 0;
                                                                                                     if (!empty($value->feeexcess))
                                                                                                         foreach ($value->feeexcess as $excess) {
                                                                                                             $ex_total = $ex_total + $excess['amount']; ?>   
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                          ...
                                                                                                                                          <td><?php echo $record['firstname'] . " " . $record['lastname']; ?></td>  
                                                                                                                                            ...
                                                                                                                                            <td class="text text-right">
                                                                                                                             <?php echo number_format($excess['amount'], 0, '.', ''); ?>
                                                                                                                                            </td>
                                                                                                                       ...
                                                                                                                       0.00
                                                                                                                        ...
                                                                                                                        0.00
                                                                                                                                            ...
                                                                                                                                            <td  class="text text-right">
                                                                                                                                                ...
                                                                                                                                                echo number_format($excess['amount'], 0, '.', '');
                                                                                                                                                ?>
                                                                                                                                            </td>
    ...
    border-top: 1px dashed;" class="text text-right"> Student Total:</td>
                                                                                                                <td style="border-bottom: 1px dashed;
    border-top: 1px dashed;" class="text text-right">  <?php $st_total = $total_amount + $ad_total + $ex_total;
                                    echo number_format($st_total, 0, '.', ''); ?>  </td>
                                                                                                                <td style="    border-bottom: 1px dashed;
    ...
    border-top: 1px dashed;" class="text text-right"> <?php echo number_format($fine, 0, '.', ''); ?> </td>
                                                                                                                ...
                                                                                                                echo (number_format($feetotal, 0, '.', '')) ?></td>
                                                                        ...
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"><?php echo ($currency_symbol . number_format($student_total, 0, '.', '')); ?></td>
                                                                        ...
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                        <td style=" border-bottom: 1px dashed;" class="text text-right"><?php //echo ($currency_symbol . number_format($deleted_amount['deleted_amount'], 0, '.', '')); ?></td> -->
                                                                                </tr>
                                                                        ...
                                                                        // echo ($currency_symbol . number_format($total_coll, 0, '.', '')); ?>  </td> --></tr>
    ...
    border-top: 1px dashed;" class="text text-right"> Bill Total:</td>
                                                                                                                            <td  style="border-bottom: 1px dashed;
    border-top: 1px dashed;" class="text text-right">  <?php echo number_format($pay['amount'], 0, '.', ''); ?>  </td>
                                                                                                                            <td  style="    border-bottom: 1px dashed;
    ...
    border-top: 1px dashed;"></td>-->
                                                                                        ...
                                                                                        <td style="border-bottom: 1px dashed;
    border-top: 1px dashed;font-weight:bold;" class="text text-right">  <?php echo number_format($other_student_total, 0, '.', ''); ?>  </td>
                                                                                        <td style="    border-bottom: 1px dashed;
    ...
    border-top: 1px dashed;font-weight:bold;" class="text text-right"> 0.00 </td>
                                                                                        ...
                                                                                        echo (number_format($other_student_total, 0, '.', '')) ?></td>
                                                                                   ...
                                                                                   <tr class="box box-solid total-bg" style="border-top: 1px solid;">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text-right"></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"><?php echo ($currency_symbol . number_format($other_student_total, 0, '.', '')); ?></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"> 0.00</td></tr>
                                                                                    ...
                                                                                    <td  class="text text-right"></td>
                                                                                    <td class="text text-right"></td>
                                                                                    <td  class="text text-right"> <?php echo ($currency_symbol . number_format($other_student_total, 0, '.', '')); ?></td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                                                                    <td style=" border-bottom: 1px dashed;" class="text text-right"><?php //echo  ($currency_symbol . number_format($other_cancelled, 0, '.', '')); ?>0.00</td></tr>
                                                                                 ...
                                                                                 <tr class="box box-solid total-bg">
                                                                                    ...
                                                                                    //echo ($currency_symbol . number_format($total, 0, '.', '')); ?> 0.00 </td></tr>
                                                                                ...
                                                                                <tr class="box box-solid total-bg" style="border-bottom: 1px solid;">
                                                                                    ...
                                                                                    <td  class="text text-right"></td>
                                                                                    <td  class="text text-right"></td>
                                                                                    <td  class="text text-right"> <?php echo ($currency_symbol . number_format($other_student_total, 0, '.', '')); ?> </td></tr>
                                                                       ...
                                                                       <tr  style="border-bottom: 1px solid;">
                                                                        ...
                                                                        echo ($currency_symbol . number_format($grand_total, 0, '.', '')); ?>  </td></tr> 
                                         ...
                                         <th  class="text text-center">Fine amount</th>  
                                                                      ...
                                                                      foreach ($list['headwise'] as $key => $value) {
                                                                         ...
                                                                         <td class="text text-center"  ><?php echo $i; ?>  </td> 
                                                                           ...
                                                                           <td class="text text-center" ><?php echo ($currency_symbol . number_format($value['amount'], 0, '.', '')) ?></td>   
                                                                           <td class="text text-center" ><?php echo ($currency_symbol . number_format($value['fine'], 0, '.', '')); ?></td>            
                                                                             </tr>         
                                                                      ...
                                                                      if (!empty($feeexcess)) { ?>
                                                                         ...
                                                                         <td class="text text-center"  ><?php echo $i; ?>  </td> 
                                                                           ...
                                                                           <td class="text text-center" ><?php echo ($currency_symbol . number_format($feeexcess, 0, '.', '')) ?></td>   
                                                               ...
                                                               <tr class="box box-solid total-bg" >
                                                                ...
                                                                <td class="text-right"> <?php echo $this->lang->line('total'); ?> (Fee collection) </td>
                                                                      ...
                                                                      <td ></td>
                                                                        ...
                                                                        $t = $t_head + $feeexcess;
                                                                        echo ($currency_symbol . number_format($t, 0, '.', '')); ?></td>
                                                
                                                
                                                                        <td  class="text text-center" > <?php echo ($currency_symbol . number_format($t_fine, 0, '.', '')); ?></td></tr>
                                                                        ...
                                                                        echo ($currency_symbol . number_format($collection, 0, '.', '')); ?></td>
                                                                        </tr>
                                                                        ...
                                                                        <td  class="text text-right"><?php //echo  ($currency_symbol . number_format($deleted_amount['deleted_amount'], 0, '.', '')); ?>0.00</td></tr>
                                                                   ...
                                                                   <tr class="box box-solid total-bg">
                                                                        ...
                                                                        echo ($currency_symbol . number_format($t, 0, '.', '')); ?>  </td></tr>
                                                                    ...
                                                                    <tr class="box box-solid total-bg">
                                                                        ...
                                                                        <td  class="text text-right"></td>
                                                                        <td  class="text text-right"> <?php echo ($currency_symbol . number_format($collection, 0, '.', '')); ?> </td>
                                                            ...
                                                            ?>
                                                                ...
                                                                foreach ($otherpayment as $key => $val) {
                                                                    ...
                                                                    ?>              
                                                                               <tr >        
                                                                                 ...
                                                                                 <td class="text text-center"><?php echo ($currency_symbol . number_format($val['amount'], 0, '.', '')) ?></td>   
                                                                                 <td class="text text-center">0.00</td>            
                                                                                         </tr>
                                                                ...
                                                                <td class="text-right"> <?php echo $this->lang->line('total'); ?> (Other Payments) </td>
                                                                      ...
                                                                      <td ></td>
                                                                        ...
                                                                        <td  class="text text-center" ><?php echo ($currency_symbol . number_format($c_total, 0, '.', '')); ?></td>
                                                                       ...
                                                                       <tr class="box box-solid total-bg">
                                                                        ...
                                                                        echo ($currency_symbol . number_format($c_total, 0, '.', '')); ?></td>
                                                                        </tr>
                                                                      ...
                                                                      <tr class="box box-solid total-bg">
                                                                        ...
                                                                        echo ($currency_symbol . number_format($c_total, 0, '.', '')); ?>  </td></tr>
                                                                ...
                                                                <td  class="text text-right"></td>
                                                                <td  class="text text-right"> <?php echo ($currency_symbol . number_format($c_total, 0, '.', '')); ?> </td>
