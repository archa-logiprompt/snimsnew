                        ...
                        <form id="form1" action="<?php echo site_url('admin/hostelroom/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" name="room_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('room_no'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input   name="no_of_bed" placeholder="" type="text" class="form-control"  value="<?php echo set_value('no_of_bed'); ?>" />
                                ...
                                <div class="checkbox" style="display:none">
                                        <label>
                                            <input type="radio" name="collected_yearly" value="0" class='collected_in' checked> Monthly
                                        </label>
                                        <label>
                                            <input type="radio" name="collected_yearly" value="1" class='collected_in' > Yearly
                                        </label>
