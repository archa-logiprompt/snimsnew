            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        ...
                        <li><a href="#tab_1" data-toggle="tab"><?php echo $this->lang->line('clickatell_sms_gateway'); ?></a></li>
                        <li class="pull-left header"><i class="fa fa-mobile"></i> <?php echo $this->lang->line('sms_setting'); ?></li>
                          <li  class="active"><a href="#tab_7" data-toggle="tab"><?php echo $this->lang->line('a4add'); ?></a></li>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 minheight170">
                                            <div class="col-md-7">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('hash_key'); ?></label>
                                                    <div class="col-sm-7">
                        ...
                        <div class="tab-pane active" id="tab_7">
                            <form role="form" id="a4add" action="<?php echo site_url('smsconfig/a4add') ?>" class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12 minheight170">
                                            <div class="col-md-7">
                                                <?php
                                                $clickatell_result = check_in_array('a4add', $smslist);
                                                ?>

                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('a4add_user'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input autofocus="" type="text" class="form-control" name="a4add_user" value="<?php echo $a4add_result->username; ?>">
                                                        <span class=" text text-danger a4add_user_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('a4add_password'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="password" class="form-control" name="a4add_password"  value="<?php echo $a4add_result->password; ?>">
                                                        <span class=" text text-danger a4add_password_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('a4add_sender_id'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="a4add_sender_id"  value="<?php echo $a4add_result->api_id; ?>">
                                                        <span class=" text text-danger a4add_sender_id_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('status'); ?><small class="req"> *</small></label>
                                                    <div class="col-sm-7">
                                                        ...
                                                        <select class="form-control" name="a4add_status">
                                                            <?php
                                                            foreach ($statuslist as $s_key => $s_value) {
                                                                ?>
                                                                <option 
                                                                    value="<?php echo $s_key; ?>"
                                                                    <?php
                                                                    if ($a4add_result->is_active == $s_key) {
                                                                        echo "selected=selected";
                                                                    }
                                                                    ?>
                                                                    ><?php echo $s_value; ?></option>
                                            ...
                                            <?php /*?><div class="col-md-5 text text-center disblock">
                                                <a href="https://www.clickatell.com/" target="_blank"><img src="<?php echo base_url() ?>backend/images/clickatell.png"><p>https://www.clickatell.com</p></a>
                                            </div><?php */?>
                                        </div>
