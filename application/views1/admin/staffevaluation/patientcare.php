                                	...
                                	<div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName();?> </br>
                                    	...
                                    	<table class="table table-bordered example">
                                        	<thead>
                                            	<tr>
                                                	<th>
                                                    	<?php echo "Patient care related Responsibilities";?> 
                                                	</th>
                                                	 
                                                   
                                                     <th class="text text-center">
                                                        <?php echo "Hospital and Medical Centre Work";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Hours/week or Night-duties/ week/No. of Camps";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "Hours of Work performed";?>
                                                    </th>
                                                     <th class="text text-center">
                                                        <?php echo "% of hours work as per record";?>
                                                    </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Rendering OP/IP  Dental care  training activities";?> </th>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Laboratory Services & Case-record logbook preparation";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                             ...
                                             <tr>
                                            	<th height="40"><?php echo "Dental Health camps participation";?> </th>
                                                 <td><input type="text" id="lectures" name="lectures" class="form-control"/></td> 
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
                                                <td><input type="text" id="lectures" name="lectures" class="form-control"/></td>
