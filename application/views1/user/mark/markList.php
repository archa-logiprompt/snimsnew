...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-map-o"></i> <?php echo $this->lang->line('examinations'); ?> </h1>
    </section>
                            ...
                            <div class="bozero">
                                ...
                                if (empty($examSchedule)) {
                                    ...
                                    foreach ($examSchedule as $key => $value) {
                                        // var_dump($value['exam_name']);
                                        // var_dump($examSchedule[$key+1]['exam_name']);
                                        ?>
                                        <div id="<?php echo 'print_view' . $counter ?>">
                                        <?php
                                        // if(($value['exam_name']!=$examSchedule[$key+1]['exam_name'])){
                                                    // continue;
                                                // }    ?>
