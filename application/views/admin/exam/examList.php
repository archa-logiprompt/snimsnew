                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/exam"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('class'); ?></label></label><small class="req"> *</small>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?></label></label><small class="req"> *</small>
                                        ...
                                        foreach ($examlist as $exam) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <a href="#" data-toggle="popover" class="detail_popover" ><?php echo $exam['name'] .' [ '.$exam['exam_type'].' ] '; ?>  </a>
