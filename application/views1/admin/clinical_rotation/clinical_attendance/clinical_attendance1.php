        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/clinical_department/clinical_attendance') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('group'); ?></label><small class="req"> *</small>
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($resultlist)) {
                              ...
                              if ($resultlist[0]['attendance_type_id']!=0) {
                                ...
                                ?>
                                <form action="<?php echo site_url('admin/clinical_department/save_attendance') ?>" method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
