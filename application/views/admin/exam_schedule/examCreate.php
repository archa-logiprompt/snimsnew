                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo $value['name'] . " ("  .$value['code'] .substr($value['type'], 0, 2) . ".)"?>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        ...
                                                        ?>
                                                        <div class="form-group">
                                        <input id="date_<?php echo $value['id'] ?> " name="date_<?php echo $value['id'] ?>" placeholder="Enter Date" type="text" class="form-control datepicker"  value="<?php echo $exam_date; ?>" readonly="readonly"/>
                                                    ...
                                                    <td>
                                                    <div class="form-group">
                                                     <select id="teacher_<?php echo $value['id'] ?>" name="teacher_<?php echo $value['id'] ?>" class="form-control">
                                                        <option value=""><?php echo "select" ?>
                                                    </option>
                                                    <?php foreach($teacherlist as $teacher){ ?>
                                                        <option value="<?php echo $teacher['id'] ?>" <?php if($teacher['id']==$value['scheduleteacher']){echo 'selected=selected';}?>><?php echo $teacher['name'] ?>
                                                    </option>
                                                  <?php   }  $count++; ?>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="topic_<?php echo $value['id'] ?>" class="form-control" id="topic_<?php echo $value['id'] ?>" value="<?php echo $value['topics'] ?>" placeholder="Enter Topics">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
