                        ...
                        <div class="col-xs-12">
                            <div class="box box-info" id="transfee">
                                ...
                                <div class="box-body table-responsive">
									...
									<?php echo $this->lang->line('student_fees_report'); ?></div>    
                                    <table class="table table-striped table-bordered table-hover example">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text text-right">
                                                            ...
                                                            if ($student->totalfee === "N/A") {
                                                                ...
                                                                echo (number_format($student->totalfee, 0, '.', ''));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="text text-right">
                                                            ...
                                                            if ($student->discount === "N/A") {
                                                                ...
                                                                echo (number_format($student->discount, 0, '.', ''));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="text text-right">
                                                            ...
                                                            if ($student->fine === "N/A") {
                                                                ...
                                                                echo (number_format($student->fine, 0, '.', ''));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="text text-right">
                                                            ...
                                                            if ($student->deposit === "N/A") {
                                                                ...
                                                                echo (number_format($student->deposit, 0, '.', ''));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="text-right">
                                                            ...
                                                            if ($student->balance === "N/A") {
                                                                ...
                                                                echo (number_format($student->balance, 0, '.', ''));
                                                            }
                                                            ?>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr  class="box box-solid total-bg">
                                            ...
                                            <td class="text text-right">
                                                <?php echo ($currency_symbol . number_format($grd_total, 0, '.', '') ); ?>
                                            </td>
                                            <td class="text text-right">
                                                <?php echo ($currency_symbol . number_format($grd_discount, 0, '.', '') ); ?>
                                            </td>
                                            <td class="text text-right">
                                                <?php echo ($currency_symbol . number_format($grd_fine, 0, '.', '') ); ?>
                                            </td>
                                            <td class="text text-right">
                                                <?php echo ($currency_symbol . number_format($grd_paid, 0, '.', '') ); ?>
                                            </td> 

                                            <td class="text text-right">
                                                <?php echo ($currency_symbol . number_format(($grd_total - ($grd_paid + $grd_discount)), 0, '.', '')); ?>
                                            </td>
                                        </tr>
