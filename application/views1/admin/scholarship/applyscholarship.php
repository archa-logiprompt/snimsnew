                    ...
                    <form action="<?php echo site_url('admin/timetable/index') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('scholarship'); ?></label><small class="req"> *</small>
                                        <select  id="scholarship_id" name="section_id" class="form-control" >
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php foreach($scholarship as $sch){?>
                                                <option value="<?php $sch['id']?>"><?php echo $sch['name'] ?></option>
                                           <?php  } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('scholarship_id'); ?></span>
                                    </div>
                                </div>
