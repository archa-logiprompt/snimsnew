        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('studentmessfee/feesearch') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                        ...
                                        foreach ($student_due_fee as $student) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text text-right">
                                                    <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?><a href="<?php echo base_url(); ?>studentmessfee/addfee/<?php echo $student['id'] ?>" class="btn btn-info btn-xs">
