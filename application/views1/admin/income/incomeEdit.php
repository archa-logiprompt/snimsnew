                        ...
                        <form action="<?php echo site_url("admin/income/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <label class="radio-inline">
                                    <input <?php if($income['mode']=='Cash') { echo 'checked=checked';} ?> type="radio" name="payment_mode_fee" value="Cash" ><?php echo $this->lang->line('cash'); ?>
                                </label>
                                <label class="radio-inline">
                                    <input <?php if($income['mode']=='Cheque') { echo 'checked=checked';} ?> type="radio" name="payment_mode_fee" value="Cheque"><?php echo $this->lang->line('cheque'); ?>
                                </label>
                                <label class="radio-inline">
                                    <input <?php if($income['mode']=='DD') { echo 'checked=checked';} ?> type="radio" name="payment_mode_fee" value="DD"><?php echo $this->lang->line('dd'); ?>
                                </label>
                                
                                
                                <label class="radio-inline">
                                    <input  <?php if($income['mode']=='Bank') { echo 'checked=checked';} ?>type="radio" name="payment_mode_fee" value="Bank"><?php echo $this->lang->line('bank'); ?>
                                </label>
