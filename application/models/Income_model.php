...
class Income_model extends CI_Model {
	...
	public function mess_collection_report($date_from, $date_to,$head_id=null,$payment_mode=null)
	{
		...
		if($head_id!=null)
		{
			if($head_id!="mess_fee")
			{
		  $this->db->where('mess_income.head_id',$head_id);
			}
			else if($head_id=="mess_fee")
			{
				 $this->db->where('mess_income.is_system',0);
			   ...
			   {
				   $this->db->where('mess_income.payment_mode',$payment_mode); 
