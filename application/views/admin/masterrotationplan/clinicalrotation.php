                            ...
                            <div class="col-md-12 ">
                                ...
                                <table style=" width: 100%;border-collapse: collapse;" border="1">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td style="text-align:center;padding:5px"><?php echo $groupName ?></td>
                                            <?php 
                                            // Loop through each date
                                            foreach ($dates as $date) { 
                                                // Check if the current date is present in the current group
                                                $wardFound = false;
                                                foreach ($group as $ward) {
                                                    
                                                    $wardDateRange =  date('d/m/y', strtotime($ward['datefrom'])). ' - ' . date('d/m/y', strtotime($ward['dateto']));
                                                    if ($wardDateRange === $date) {
                                                        echo '<td style="text-align:center;padding:5px">' . $ward['aliasname'] . '</td>';
                                                        $wardFound = true;
                                                        break;
                                                    }
                                                }
                                                // If the date is not found in the group, output an empty cell
                                                if (!$wardFound) {
