                                ...
                                <table style="width:100%;border-left: 1px solid;border-right: 1px solid;" border="0">
                                    ...
                                    <!-- <tr class="box box-solid total-bg">
                                        ...
                                        <td style=" border-bottom: 1px dashed;" class="text text-right">
                                            <?php echo ($currency_symbol . number_format($total, 0, '.', '')); ?>
                                        </td>
                                    </tr> -->
                                    <!-- <tr class="box box-solid total-bg">
                                        ...
                                        <td class="text text-right">
                                            <?php echo ($currency_symbol . number_format($total, 0, '.', '')); ?></td>
                                    </tr> -->
                                    ...
                                    <!-- <tr class="box box-solid total-bg">
                                        ...
                                        <td style=" border-bottom: 1px dashed;" class="text text-right"></td>
                                        <td style=" border-bottom: 1px dashed;" class="text text-right">
                                            <?php echo  ($currency_symbol . number_format($deleted_amount, 0, '.', '')); ?>
                                        </td>
                                    </tr> -->
