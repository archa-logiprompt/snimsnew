...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-object-group"></i> <?php echo $this->lang->line('scholarship information'); ?> <small></small></h1>
    </section>
    <!-- Main content -->
                   ...
                   <?php /*?> <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/scholarship/scholarship') ?>" method="post" class="">
                                    ...
                                    <thead>
                                        <tr>
                                         <th><?php echo $this->lang->line('admission_no'); ?></th>
                                           ...
                                           <?php /*?> <th><?php echo $this->lang->line('quantity'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($sch)) {
                                          ...
                                          <td><?php echo $val->admission_no; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>scholarship/assign/<?php // echo $val['id']; ?>"><?php echo $val->firstname . " " . $val->lastname; ?>
                                                        </a>
                                                    </td>
                                                     <td><?php echo $val->class . "(" . $val->section . ")" ?></td>
