                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!--<div class="col-md-6">
                            <div class="form-group">
                                <label><?php //echo $this->lang->line('section'); ?></label><small class="req"> *</small>
                               <select  class="form-control selectpicker " name="con[]" id="con" multiple="multiple">
                    <option value="0" disabled="disabled">select contractor</option>
...
$('.multiselect-container').materialSelect();
});
</script>
...
<script type="text/javascript">
    ...
    function appendRow(subject_id, teacher_id, row_id) {
        ...
        row += '<label for="inputValue" class="col-md-1 control-label">Subject</label>';
        row += '<div class="col-md-4">';
        row += '<select  multiple="multiple" tabindex="-1" id="subject_id_' + value + '" name="subject_id_' + value + '" class="form-control selectpicker " >';
        row += '<option value=""><?php echo $this->lang->line('select'); ?></option>';
<?php
foreach ($subjectlist as $subject) {
    ?>
...
?>
        ...
        row += '<label for="inputKey" class="col-md-1 control-label">Teacher</label>';
        row += '<div class="col-md-4">';
       row += '<select id="teacher_id_' + value + '" name="teacher_id_' + value + '" no="' + value + '" class="form-control selectpicker " >';
        row += '<option value=""><?php echo $this->lang->line('select'); ?></option>';
<?php
foreach ($teacherlist as $teacher) {
    ?>
