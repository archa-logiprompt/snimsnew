...
class Subject extends Student_Controller {
    ...
    function index() {
        ...
        $stu_record = $this->student_model->getRecentRecordStudent($stuid['student_id']);
        $subject_result = $this->teachersubject_model->getSubjectByClsandSection($stu_record['class_id'], $stu_record['section_id'],'Theory');


        // var_dump($stu_record);exit;
    ...
    function getSubjctByClassandSection() {
        ...
        $data = $this->teachersubject_model->getSubjectByClsandSection($class_id, $section_id,'Theory');
