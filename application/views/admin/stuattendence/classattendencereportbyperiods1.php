                    ...
                    <form id='form1' action="<?php echo site_url('admin/stuattendence/classattendencereportbyperiod') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <?php //var_dump(validation_errors()); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo 'Type'; ?></label><small class="req"> *</small>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                foreach ($attendence_array as $at_key => $at_value) {
                                                    ...
                                                    if (date('D', $this->customlib->dateyyyymmddTodateformat($at_value)) == "Sun") {if($at_value>=$from && $at_value<= $to){
                                                        ?>
                                                           ...
                                                           if($at_value>=$from && $at_value<= $to){ ?>
                                                            <th class="tdcls text text-center">
                                                                ...
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="color:#333"><?php
                                                                        if (($resultlist[$at_value][$student_value['student_session_id']]['key']) == "E") {
