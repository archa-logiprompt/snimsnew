<div class="row row-eq">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 paddlr">
        ...
        <form id="evaluation_data" method="post" class="ptt10" style="min-height: 500px;">
            <div class="download_label"><?php echo "Homework Evaluation Report " ?></div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($studentlist as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(!empty($value['uploads']))
                                    {?> <a href ="<?php echo base_url($value['uploads']) ?>" target="_blank" download ><i class="fa fa-download"></i></a>
                                </td>
<?php }else{
    echo "not yet uploaded";
                                ...
                                <td>
                                   ...
                                   <a href="<?php echo base_url('homework/updatestatus/'.$value['student_id'].'/'.$value['homework_id'])?>"> <button type="button" class="btn btn-success" name="mark_complete" >
                                        Mark as Complete
                                    </button></a>
                               <?php } else
                               {
                                                    ...
                                                    <span><?php echo $this->lang->line('evaluation_date'); ?><span>:<?php print_r(date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result[0]['date']))); ?>                                      
                                                            ...
                                                            <div class="task-info task-single-inline-wrap ptt10">
                                                                ...
                                                                <?php if (!empty($result[0]["document"])) { ?>  
                                                                   ...
                                                                   <label><a href="<?php echo base_url() . "uploads/homework/". $result[0]["document"] ?>" download><?php echo $this->lang->line('download') ?> <i class="fa fa-download"></i></a></label>
