        ...
        <ul class="sidebar-menu verttop">
            ...
            ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('front_office'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                <li style="display:none" class="<?php echo set_Submenu('admin/devicetype'); ?>"><a href="<?php echo base_url(); ?>admin/devicetype"><i class="fa fa-angle-double-right"></i>
                            ...
                            ?>
                                <li style="display:none" class="<?php echo set_Submenu('admin/assigned'); ?>"><a href="<?php echo base_url(); ?>admin/devicetype/assigned"><i class="fa fa-angle-double-right"></i> <?php echo 'Assigned'; ?></a></li>
                            ...
                            ?>
                                <li style="display:none" class="<?php echo set_Submenu('admin/partchange'); ?>"><a href="<?php echo base_url(); ?>admin/partchange"><i class="fa fa-angle-double-right"></i>
                            ...
                            ?>
                                ...
                                <li style="display:none" class="<?php echo set_Submenu('admin/complaint'); ?>"><a href="<?php echo base_url(); ?>admin/complaint"><i class="fa fa-angle-double-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('temporary_admission/index'); ?>"><a href="<?php echo base_url(); ?>admin/temporary_admission/index"><i class="fa fa-angle-double-right"></i>
                                        <?php echo "Temporary Admission"; ?></a></li>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/users/logindetailreport'); ?>">
                                    <a href="<?php echo base_url(); ?>admin/users/logindetailreport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student'); ?>
            ...
            if ($this->module_lib->hasActive('minutes')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('minutes'); ?>">
                        <a href="#">
                            <i class="fa fa-clock-o"></i> <span><?php echo $this->lang->line('minutes'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
            ...
            if ($this->module_lib->hasActive('centre')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('centre'); ?>">
                        <a href="#">
                            <i class="fa fa-university"></i> <span><?php echo $this->lang->line('centre'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Scholarship'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('scholarship_detail', 'can_view')) { ?>
                                ...
                                <li class="<?php echo set_Submenu('scholarship/scholarship_details'); ?>"><a href="<?php echo base_url(); ?>admin/scholarship"><i class="fa fa-angle-double-right"></i>
                                        <?php echo $this->lang->line('scholarship_detail'); ?></a></li><?php } ?>


                            <?php if ($this->rbac->hasPrivilege('apply_scholarship', 'can_view')) { ?>

                                <li class="<?php echo set_Submenu('scholarship/apply_scholarship'); ?>"><a href="<?php echo base_url(); ?>admin/scholarship/apply_scholarship"><i class="fa fa-angle-double-right"></i>
            ...
            if ($this->module_lib->hasActive('fees_collection')) {
                if (($this->rbac->hasPrivilege('collect_fees', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('hostel_fee_master', 'can_view') ||
                ...
                ?>
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('upload'); ?>"><a href="<?php echo base_url(); ?>admin/upload"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees') ?>
            ...
            if ($this->module_lib->hasActive('mess_fee')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('mess fee'); ?>">
                        <a href="#">
                            <i class="fa fa-money"></i> <span><?php echo 'Hostel Fee'; ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
            ...
            if ($this->module_lib->hasActive('income')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Income'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('income', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('income/index'); ?>"><a href="<?php echo base_url(); ?>admin/income"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_income'); ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('search_income', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('income/incomesearch'); ?>"><a href="<?php echo base_url(); ?>admin/income/incomesearch"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('collection'); ?>
                                        <?php echo $this->lang->line('report'); ?> </a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('income_head', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('incomeshead/index'); ?>"><a href="<?php echo base_url(); ?>admin/incomehead"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('income_head'); ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('student_attendance_report', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('admin/attendencebyday'); ?>"><a href="<?php echo base_url(); ?>admin/attendencebyday"><i class="fa fa-angle-double-right"></i> <?php echo 'Attendance'; ?></a></li>

                                <li class="<?php echo set_Submenu('stuattendence/classattendencereportbyday'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classattendencereportbyday" style=" font-size: 9pt !important;"><i class="fa fa-angle-double-right"></i>
                                        <?php echo 'Attendence Report ' ?></a></li>



                                <li class="<?php echo set_Submenu('stuattendence/classattendencereportbyperiod'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classattendencereportbyperiod" style=" font-size: 9pt !important;"><i class="fa fa-angle-double-right"></i>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                                <li style="display:none" class="<?php echo set_Submenu('timetable/index'); ?>"><a href="<?php echo base_url(); ?>admin/timetable"><i class="fa fa-angle-double-right"></i>
                            ...
                            if ($this->rbac->hasPrivilege('weekly_timetable', 'can_view')) {
                            ?>
                                <?php
                                if (in_array('Teacher', $keys) || in_array('Vice Principal', $keys)) {
                                ?>
                           ...
                           href="<?php //echo base_url(); 
                            ...
                            <?php if ($this->rbac->hasPrivilege('monthly_academic_report', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('monthly_academic_report/monthlyperiodreport'); ?>"><a href="<?php echo base_url(); ?>admin/monthlyacademicreport/monthlyattendancereport"><i class="fa fa-angle-double-right"></i>
            ...
            if ($this->module_lib->hasActive('live_class')) {
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('live_class'); ?>">
                        <a href="">
                            <i class="fa fa-mortar-board"></i> <span><?php echo $this->lang->line('live_class'); ?></span><i class="fa fa-angle-left pull-right"></i>
                        </a>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('live_class_attendance', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('live_class/live_class_attendance'); ?>"><a href="<?php echo base_url() ?>admin/live_class/live_class_attendance"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('live_class'); ?>
            ...
            if ($this->module_lib->hasActive('groupwise_attendance')) {
                if (($this->rbac->hasPrivilege('add_group', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('groupwise_attendance'); ?>">
                        <a href="">
                            <i class="fa fa-tty"></i> <span><?php echo 'Groupwise Attendance'; ?></span><i class="fa fa-angle-left pull-right"></i>
                        </a>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('add_group', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('groupwise_attendance/add_group'); ?>"><a href="<?php echo base_url() ?>admin/Clinical_group/view_addedgroups"><i class="fa fa-angle-double-right"></i> <?php echo 'Add Group'; ?></a></li><?php } ?>


                            <?php if ($this->rbac->hasPrivilege('mark_attendance', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('groupwise_attendance/mark_attendance'); ?>"><a href="<?php echo base_url() ?>admin/clinical_department/mark_attendance"><i class="fa fa-angle-double-right"></i> <?php echo 'Mark Attendance' ?> </a></li>
                            <?php } ?>

                            <?php if ($this->rbac->hasPrivilege('batchwise_report', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('groupwise_attendance/batchwise_report'); ?>"><a href="<?php echo base_url() ?>admin/clinical_department/batchwiseattendancereport"><i class="fa fa-angle-double-right"></i> <?php echo 'Bachwise Report' ?> </a></li>
                            <?php } ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('clinical_rotation'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('viewassign_ward', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('clinical_rotation/clinical_department'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department"><i class="fa fa-angle-double-right"></i>
                            ...
                            <?php if ($this->rbac->hasPrivilege('clinical_attendance', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('clinical_rotation/clinical_attendance'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department/clinical_attendance"><i class="fa fa-angle-double-right"></i>
                                        <?php echo $this->lang->line('clinical_attendance'); ?></a></li><?php } ?>
                            <?php if ($this->rbac->hasPrivilege('clinical_report', 'can_view')) { ?>
                                <li style="display:none" class="<?php echo set_Submenu('clinical_rotation/clinical_report'); ?>"><a href="<?php echo base_url(); ?>admin/clinical_department/attendancereport"><i class="fa fa-angle-double-right"></i> <?php echo 'clinical report'; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                ...
                                <li style="display:none" class="<?php echo set_Submenu('admin/staffevaluation/clinicalReportApprove'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/clinicalReportApprove"><i class="fa fa-angle-double-right"></i><?php echo "Clinical Report Approve"; ?></a></li>
                            <?php } ?>
                            <?php

                            if ($this->rbac->hasPrivilege('hodviewclinical_report', 'can_view')) {
                            ?>
                                <li style="display:none" class="<?php echo set_Submenu('admin/staffevaluation/hodclinicalReportview'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/hodclinicalReportview"><i class="fa fa-angle-double-right"></i><?php echo "HOD view Clinical Report"; ?></a></li>
                            <?php } ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffattendance/attendancereport'); ?>"><a href="<?php echo base_url(); ?>admin/staffattendance/attendancereport"><i class="fa fa-angle-double-right"></i>
                                        <?php echo $this->lang->line('staff_attendance_report'); ?></a></li>
                                <li class="<?php echo set_Submenu('admin/staffattendance/attendancereportbyperiod'); ?>"><a href="<?php echo base_url(); ?>admin/staffattendance/attendancereportbyperiod"><i class="fa fa-angle-double-right"></i> Attendance Report By Period</a></li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/payroll/HrReport'); ?>"><a href="<?php echo base_url(); ?>admin/payroll/HrReport"><i class="fa fa-angle-double-right"></i> <?php echo 'HR Report'; ?></a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('supervisor_leave', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staff/superviserrequest'); ?>"><a href="<?php echo base_url(); ?>admin/staff/superviserrequest"><i class="fa fa-angle-double-right"></i> <?php echo 'Supervisor'; ?></a></li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/staff/superviserrequestview'); ?>"><a href="<?php echo base_url(); ?>admin/staff/superviserrequestview"><i class="fa fa-angle-double-right"></i> <?php echo 'Approve superviser' ?></a></li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/department/department'); ?>"><a href="<?php echo base_url(); ?>admin/department/department"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('department'); ?></a>
                                </li>
            ...
            if ($this->module_lib->hasActive('staff_evaluation')) {
                ...
                ?>
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        <a href="#">
                            <i class="fa fa-sitemap"></i> <span><?php echo "Staff Evaluation" ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('classroom_teaching', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('admin/Staffevaluation'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom Teaching" ?></a></li>

                            <?php
                            }
                            if ($this->rbac->hasPrivilege('classroom_teaching_scores', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglectures'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglectures"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom teaching scores"; ?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglectures'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglectures"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom Teaching Lectures"; ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('classroom_teaching_lectures_scores', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/teachinglecturesscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglecturesscore"><i class="fa fa-angle-double-right"></i> <?php echo "Classroom teaching scores"; ?></a>
                                </li>
                            <?php
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/dentalclinicbased'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/dentalclinicbased"><i class="fa fa-angle-double-right"></i> <?php echo "Dental clinic based"; ?></a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('Dental_clinic_based_scores', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/dentalclinicbasedscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/dentalclinicbasedscore"><i class="fa fa-angle-double-right"></i> <?php echo "Dental clinic based scores"; ?></a>
                                </li>
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/patientcare'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/patientcare"><i class="fa fa-angle-double-right"></i> <?php echo "Patient Care"; ?></a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('patient_care_scores ', 'can_view')) {
                            ?>

                                <li class="<?php echo set_Submenu('admin/staffevaluation/patientcarescore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/patientcarescore"><i class="fa fa-angle-double-right"></i> <?php echo "Patient care scores"; ?></a></li>

                            <?php
                            }
                            if ($this->rbac->hasPrivilege('departmental_schedule_development', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopment'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/scheduledevelopment"><i class="fa fa-angle-double-right"></i>
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopmentscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/scheduledevelopmentscore"><i class="fa fa-angle-double-right"></i>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/researchsupervision'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/researchsupervision"><i class="fa fa-angle-double-right"></i><?php echo "Research Supervision"; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/researchsupervisionscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/researchsupervisionscore"><i class="fa fa-angle-double-right"></i> <?php echo "Research Supervision scores"; ?></a>
                                </li>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/staffReport'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/staffReport"><i class="fa fa-angle-double-right"></i><?php echo "Staff Report"; ?></a></li>
                            <?php } ?>
                            <?php
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/staffReportApprove'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/staffReportApprove"><i class="fa fa-angle-double-right"></i><?php echo "Staff Report Approve"; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/MyReport'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/MyReport"><i class="fa fa-angle-double-right"></i><?php echo "My Report"; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/staffevaluation/hodReportview'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/hodReportview"><i class="fa fa-angle-double-right"></i><?php echo "HOD view Report"; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/participationfaculty'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/participationfaculty"><i class="fa fa-angle-double-right"></i> <?php echo "Participation in faculty"; ?></a></li>
                            <?php } ?>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/staffevaluation/participationfacultyscore'); ?>"><a href="<?php echo base_url(); ?>admin/staffevaluation/participationfacultyscore"><i class="fa fa-angle-double-right"></i> <?php echo "Participation faculty scores"; ?></a>
                                </li>
                            <?php } ?>
                ...
                ?>
                    <li class="treeview <?php echo set_Topmenu('Download Center'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="<?php echo set_Submenu('content/syllabus'); ?>"><a href="<?php echo base_url(); ?>admin/content/syllabus"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('syllabus'); ?></a>
                            </li>


                            <li class="<?php echo set_Submenu('content/questionpaper'); ?>"><a href="<?php echo base_url(); ?>admin/content/questionpaper"><i class="fa fa-angle-double-right"></i> <?php echo 'Question Paper'; ?></a></li>

                            <li class="<?php echo set_Submenu('content/questionbank'); ?>"><a href="<?php echo base_url(); ?>admin/content/questionbank"><i class="fa fa-angle-double-right"></i> <?php echo 'Question Bank'; ?></a></li>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Library'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('books', 'can_add')) { ?>
                                <li class="<?php echo set_Submenu('book/index'); ?>"><a href="<?php echo base_url(); ?>admin/book"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_book'); ?></a>
                                </li>
                            ...
                            if ($this->rbac->hasPrivilege('issue_return_student', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('member/index'); ?>"><a href="<?php echo base_url(); ?>admin/member"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('issue_return'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('add_student', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('member/student'); ?>"><a href="<?php echo base_url(); ?>admin/member/student"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_student'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('add_staff_member', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('member/teacher'); ?>"><a href="<?php echo base_url(); ?>admin/member/teacher"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_staff_member'); ?></a>
                                </li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('pdf_drive', 'can_view')) { ?>
                                ...
                                ?>
                                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a href="https://www.pdfdrive.com/nursing-books.html"><i class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>

                                <?php } elseif ($centre_id == 2) {

                                ?>
                                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a href="https://www.pdfdrive.com/medical-books.html"><i class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>

                                <?php } else {

                                ?>
                                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a href="https://www.pdfdrive.com/search?q=paramedic&pagecount=&pubyear=&searchin=&em="><i class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>
                            ...
                            <?php if ($this->rbac->hasPrivilege('ebsco_host', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('library/ebsco_host'); ?>"><a href="http://search.ebscohost.com"><i class="fa fa-angle-double-right"></i><?php echo 'EBSCO HOST'; ?></a></li>
                            <?php } ?>
                            <?php if ($this->rbac->hasPrivilege('viewattendence', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('member/viewattendence'); ?>"><a href="<?php echo base_url(); ?>admin/teacher/viewattendence"><i class="fa fa-angle-double-right"></i><?php echo 'Library Attendence'; ?></a>
                                </li>
                            <?php } ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Inventory'); ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if ($this->rbac->hasPrivilege('issue_item', 'can_view')) { ?>
                                <li class="<?php echo set_Submenu('issueitem/index'); ?>"><a href="<?php echo base_url(); ?>admin/issueitem"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('issue_item'); ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('item_stock', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('Itemstock/index'); ?>"><a href="<?php echo base_url(); ?>admin/itemstock"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_item_stock'); ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('item', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('Item/index'); ?>"><a href="<?php echo base_url(); ?>admin/item"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('add_item'); ?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('itemreport/index'); ?>"><a href="<?php echo base_url(); ?>admin/itemreport"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('item_report'); ?></a>
                                </li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('itemcategory/index'); ?>"><a href="<?php echo base_url(); ?>admin/itemcategory"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('item_category'); ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('store', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('itemstore/index'); ?>"><a href="<?php echo base_url(); ?>admin/itemstore"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('item_store'); ?></a>
                                </li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('supplier', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('itemsupplier/index'); ?>"><a href="<?php echo base_url(); ?>admin/itemsupplier"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('item_supplier'); ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Hostel'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/hostelroom/studenthosteldetails'); ?>"><a href="<?php echo base_url(); ?>admin/hostelroom/studenthosteldetails"><i class="fa fa-angle-double-right"></i>
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Certificate'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('student_certificate', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('admin/certificate'); ?>"><a href="<?php echo base_url(); ?>admin/certificate/"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('student'); ?>
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/generatecertificate'); ?>"><a href="<?php echo base_url(); ?>admin/generatecertificate/"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('generate'); ?>
                                        <?php echo $this->lang->line('certificate'); ?></a></li>
                            <?php
                            }
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/studentidcard'); ?>"><a href="<?php echo base_url('admin/studentidcard/'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('student'); ?>
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('admin/generateidcard'); ?>"><a href="<?php echo base_url('admin/generateidcard/'); ?>"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('generate'); ?>
                                        <?php echo $this->lang->line('icard'); ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                ?> <?php //echo $this->lang->line('report'); 
                    ?> </a></li>-->
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('student/staff_tpreport'); ?>"><a href="<?php echo base_url(); ?>student/staff_tpreport"><i class="fa fa-angle-double-right"></i> <?php echo 'Staff T/P Report'; ?></a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('staffclini_attendance_report', 'can_view')) {
                            ?>

                                <li class="<?php echo set_Submenu('student/staff_clireport'); ?>"><a href="<?php echo base_url(); ?>student/staff_clireport"><i class="fa fa-angle-double-right"></i> <?php echo 'Staff Clinical Report'; ?></a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('student_history', 'can_view')) {
                            ?>
                            ...
                            ?>
                                ...
                                <li class="<?php echo set_Submenu('admin/users/logindetailreport'); ?>"><a href="<?php echo base_url(); ?>admin/users/logindetailreport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('student'); ?>
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                <li class="<?php echo set_Submenu('mess invoice'); ?>"><a href="<?php echo base_url(); ?>invoice/mess_invoice"><i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('mess'); ?>
                                        <?php echo $this->lang->line('invoice'); ?></a></li>
                            <?php
                            }
