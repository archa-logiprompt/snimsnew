                            ...
                            <div class="box-body">
                                ...
                                <?php echo $this->session->flashdata('msg') ?>
                                 <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" value="<?php echo set_value('to'); ?>"  name="to">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="devicetype" class="form-control">
                                        ...
                                        <?php foreach ($devicetype as $key => $value) { ?>
                                            <option value="<?php echo $value['devicetype']; ?>" <?php if (set_value('devicetype') == $value['devicetype']) { ?>selected=""<?php } ?>><?php echo $value['devicetype']; ?></option>
                                        <?php }
                                        ?>                 
                                    </select>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('complainted'); ?> <?php echo $this->lang->line('date'); ?></label>    
                                ...
                                <div class="form-group">
                                    <label for="email"><?php echo 'Asset Id'; ?></label> 
                                    <input type="number" class="form-control" value="<?php echo set_value('contact'); ?>"  name="contact">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="assigned"><?php echo 'Assigned'; ?></label>  
                                    <select name="assigned" class="form-control">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>  
                                        <?php foreach ($assignList as $key => $value) { ?>
                                            <option value="<?php echo $value['assigned']; ?>" <?php if (set_value('assigned') == $value['assigned']) { ?>selected=""<?php } ?>><?php echo $value['assigned']; ?></option>
                                        <?php }
                                        ?>                 
                                    </select>
                                    <span class="text-danger"><?php echo form_error('assigned'); ?></span>
                                ...
                                <div class="form-group">
                                    <label for="pwd"><?php echo 'Parts Change'; ?></label>
                                    <input type="text" class="form-control" value="<?php echo set_value('part'); ?>"  name="part">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <select name="part" class="form-control">
                                        ...
                                        <?php foreach ($parlist as $key => $value) { 
                                          ...
                                          ?>
                                            <option value="<?php echo $value['partname']; ?>" <?php if (set_value('part') == $value['partname']) { ?>selected=""<?php } ?>><?php echo $value['partname']; ?></option>
                                        <?php }
                                        ?>                 
                                    </select>
                                    <span class="text-danger"><?php echo form_error('part'); ?></span>
                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('complainted'); ?> <?php echo $this->lang->line('date'); ?></th>
                                        <th>Description</th>
                                        <th>Action Taken</th>
                                        <th>Assigned</th>
                                    ...
                                    if (empty($complaint_list)) {
                                        ...
                                        foreach ($complaint_list as $key => $value) {
                                            ...
                                            <tr>
                                               ...
                                               <td>  <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>uploads/front_office/complaints/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" style="color:green" data-original-title="<?php echo 'View Image'; ?>">
                                               ...
                                               <td class="mailbox-name"> <?php echo $value['to']; ?></td>
                                                ...
                                                <td class="mailbox-date pull-right" "="">
                                                    ...
                                                    <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>admin/complaint/download/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Download">
                                                            <i class="fa fa-download"></i>
                                                        </a>  <?php } ?> 
                                                    <?php if ($this->rbac->hasPrivilege('complaint', 'can_edit')) { ?>    
                                                        <a href="<?php echo base_url(); ?>admin/complaint/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Edit">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                    <?php } ?>
                                                    <?php if ($this->rbac->hasPrivilege('complaint', 'can_delete')) { ?>
                                                        <?php if ($value['image'] !== "") { ?><a href="<?php echo base_url(); ?>admin/complaint/imagedelete/<?php echo $value['id']; ?>/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo base_url(); ?>admin/complaint/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php }
                                                    }
