            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <!-- <li ><a href="<?php echo site_url('parent/parents/changeusername') ?>" ><?php echo $this->lang->line('change_username'); ?></a></li> -->


                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1-1">
                            <form action="<?php echo site_url('parent/parents/changepass') ?>"  id="passwordform" name="passwordform" method="post" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
