        ...
        <section class="container vh-100 overflow-hidden">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-4">
                    ...
                    <?php if ($otp) {
                    ?>
                        <form class="form-signin w-100 -m-auto " action="<?php echo site_url('site/temporarystudentlogin') ?>" method="post">
                            <div class="form-floating ">
                                ...
                                <input type="number" name="otp" placeholder="<?php echo 'OTP'; ?>" class="form-username form-control" id="otp"> <span class="text-danger"><?php echo form_error('otp'); ?></span>
                                <label for="floatingInput">OTP</label>
                                <input type="hidden" value="otp" name="type">
                                <input type="hidden" value="<?php echo $id ?>" name="id">

                            </div>

                            <div>
                                <div class="text-start my-3 d-flex justify-content-between mb-5">
                                    <button class="btn btn-primary px-5 w-100 py-2 z-1 position-relative " type="submit"> <?php echo "Submit" ?></button>
                    ...
                    ?>
                        <form class="form-signin w-100 -m-auto " action="<?php echo site_url('site/temporarystudentlogin') ?>" method="post">
                            ...
                            <div>
                                <div class="text-start my-3 d-flex justify-content-between mb-5">
                                    <button class="btn btn-primary px-5 w-100 py-2 z-1 position-relative " type="submit"> <?php echo "Send OTP" ?></button>
