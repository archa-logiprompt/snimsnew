    ...
    function index() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            if ($search == "search_filter") {
                ...
                $feeList = $this->studentfeemaster_model->collection_report($date_from, $date_to,$collected_by);
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            if ($search == "search_filter") {
               ...
               /* $feeList = $this->studentfeemaster_model->mess_collection_report($date_from, $date_to);
				...
				$feeList = $this->income_model->mess_collection_report($date_from, $date_to,$incomehead,$payment_mode);
