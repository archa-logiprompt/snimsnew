                                        ...
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                if (($this->rbac->hasPrivilege('notice_board', 'can_edit')) || ($notification["created_id"] == $user_id)) { ?>
                                                    ...
                                                    &nbsp; <?php } if (($this->rbac->hasPrivilege('notice_board', 'can_delete')) || ($notification["created_id"] == $user_id)) { ?>                                             <a href="<?php echo base_url() ?>admin/notification/delete/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" data-original-title="<?php echo $this->lang->line('add'); ?>">
                                                        ...
                                                        <div class="box box-solid">
                                                            <div class="box-body no-padding">
                                                                <ul class="nav nav-pills nav-stacked">
                                                                    ...
                                                                    <li><i class="fa fa-user"></i> <?php echo $this->lang->line('created_by'); ?> : <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="display: contents;"><?php
                                        echo $notification["created_by"]; ?></a></span><div class="fee_detail_popover" style="display: none"><?php echo $notification["createdby_name"]; ?></div> </li>

                                                                </ul>
                                                                <h4 class="text text-primary"> <?php echo $this->lang->line('message_to'); ?></h4>
                                                                <img src="/uploads/notice_board/<?php echo $notification['image']?>" alt="" width="80px" height="80px">
                                                                <ul class="nav nav-pills nav-stacked">
