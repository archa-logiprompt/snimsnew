...
<div class="content-wrapper">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/item"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" >
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Experiment name</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Make/Model</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Serial-Number</label><small class="req"> *</small>
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Asset-ID</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Installation-Date</label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Date of Purchase</label><small class="req"> *</small>
   ...
   <div class="form-group">
                                    ...
                                    <select  id="depart" name="dep" class="form-control" >
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php
                                    ...
                                    <span class="text-danger"><?php echo form_error('dep'); ?></span>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Working status</label><small class="req"> *</small>
                    ...
                    <div class="form-group">
                                    <label for="exampleInputEmail1">Remarks</label><small class="req"> *</small>
