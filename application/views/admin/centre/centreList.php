            ...
            if ($this->rbac->hasPrivilege('centre', 'can_add')) {
                ...
                <div class="col-md-4">          
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/centre/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="centre_code" name="centre_code" placeholder="" type="text" class="form-control"  value="<?php echo set_value('centre_code'); ?>" />
                                 ...
                                 <div class="form-group"><br>
                                    ...
                                    <input id="centre_name" name="centre_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('centre_name'); ?>" />
                                 ...
                                 <div class="form-group"><br>
                                    ...
                                    <textarea  class="form-control" name="centre_add1" id="centre_add1"> </textarea>
                                  ...
                                  <div class="form-group"><br>
                                    ...
                                    <textarea  class="form-control" name="centre_add2" id="centre_add2"> </textarea>
                                ...
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('centre'); ?> <?php echo $this->lang->line('email'); ?> </label><small class="req"> *</small>
                                     <input id="centre_email" name="centre_email" placeholder="" type="email" class="form-control"   value="<?php echo set_value('centre_email'); ?>" /> 
                                ...
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('centre'); ?> <?php echo $this->lang->line('mobile_no'); ?> </label><small class="req"> *</small>
                                     <input id="centre_phone" name="centre_phone" placeholder="" type="number" class="form-control"  value="<?php echo set_value('centre_phone'); ?>" onblur="check(); return false;" /> <span id="message"> </span>
                                    <span class="text-danger"><?php echo form_error('centre_phone'); ?></span>
                                </div>
                               
                               
                               <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('password'); ?> </label></label><small class="req"> *</small>
            ...
            ?>">            
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('centre'); ?> <?php echo $this->lang->line('list') ?></h3>
                    </div>
...
?>
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
							...
							<?php echo $this->lang->line('centre'); ?><?php echo $this->lang->line('list') ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php echo $centre['centre_email'] ?></td>
                                             ...
                                             <td class="mailbox-name">
											  <?php if($centre['centre_active'] =='active') {?>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                if ($this->rbac->hasPrivilege('centre', 'can_edit')) {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>admin/centre/edit/<?php echo $centre['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
...
function check()
{
    ...
    var mobile = document.getElementById('centre_phone');
