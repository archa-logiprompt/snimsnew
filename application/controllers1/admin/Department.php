...
class Department extends Admin_Controller {
    ...
    function department() {
        ...
        if ($this->form_validation->run()) {
            ...
            if (!empty($departmenttypeid)) {
                $data = array('department_name' => $type,'centre_id'=>$admin['centre_id'], 'is_active' => 'yes', 'id' => $departmenttypeid);
            } else {

                $data = array('department_name' => $type,'centre_id'=>$admin['centre_id'], 'is_active' => 'yes');
            }
