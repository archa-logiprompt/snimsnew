...
<div class="content-wrapper">
 ...
 <input id="measure_date" name="measure_date" placeholder="" type="text" class="form-control date"  value="<?php echo date('d-m-Y');?>" readonly="readonly"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="father_phone" name="father_phone" placeholder="" type="number" class="form-control"  value="<?php echo set_value('father_phone', $student['father_phone']); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="mother_phone" name="mother_phone" placeholder="" type="number" class="form-control"  value="<?php echo set_value('mother_phone', $student['mother_phone']); ?>" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_phone" name="guardian_phone" placeholder="" type="number" class="form-control"  value="<?php echo set_value('guardian_phone', $student['guardian_phone']); ?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="bank_account_no" name="bank_account_no" placeholder="" type="number" class="form-control"  value="<?php echo set_value('bank_account_no', $student['bank_account_no']); ?>" />
                                         ...
                                         <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="annual_income" name="annual_income" placeholder="" type="number" class="form-control"  value="<?php echo set_value('annual_income',$student['annual_income']); ?>" />
