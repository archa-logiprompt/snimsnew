                        ...
                        <form id="form1" action="<?php echo $url ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('house'); ?> <?php echo $this->lang->line('name'); ?></label> <small class="req"> *</small>
            ...
            ?>">             
                <div class="box box-primary">
                    ...
                    <div class="box-body">
						...
						<?php echo $this->lang->line('house_list'); ?></div>
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('house'); ?> <?php echo $this->lang->line('name'); ?></th>
